...
<html lang="en">
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Applicant Detail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 pr-0">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Applicant Detail</h4>
                        </div>
    ...
    $sql="SELECT * FROM `tbl_department` WHERE `hotel_id` =  $hotel_id and is_delete = 0 and is_active = 1 and depart_id != 0";
                                ...
                                <small class="text-muted p-t-30 db">Application Date</small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11 col-xlg-11 col-md-11 text-show">
                                <a type="button" target="_blank" href="<?php echo $resume_url ?>" class="btn btn-secondary"><i class="fas fa-arrow-down"></i>  Download CV</a>
                            </div>
                            <?php }?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Professional Competence</strong></label>
                                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-xlg-10 col-md-10">
                            ...
                            <a type="button" onclick="updatestatus(4)" href="javascript:void(0)" class="btn btn-info w-10 ml-3 b-show">Accept</a>
                            <a type="button" onclick="updatestatus(5)" href="javascript:void(0)" class="btn btn-info w-10 ml-3 b-show">Reject</a>
                            <?php
}
                            ?>
                            <a type="button"  onclick="d()" href="javascript:void(0)" class="btn btn-info w-10 ml-3 b-show">Delete</a>
                            <?php if($status_id != 3){ ?>
                            <a onclick="edit()" type="button" href="javascript:void(0)" class="b-show btn btn-info w-10 ml-3">Edit</a>
