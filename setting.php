                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-language"></i> Change Language</h4>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info waves-effect"  onclick="update_language()">Save</button>
                                ...
                                <div id="welcome_note" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  >
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title black_color" id="myModalLabel"><i class="fa fa-sticky-note"></i> Set welcome text<br><small>We recommend a maximum length of 300 characters.</small></h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                    ...
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="welcome_en" role="tabpanel">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <h6 class="font-weight-title black_color mb-1">Monday <small>(Default if other days empty.)</small></h6>
                                                                        <input type="text" value="<?php if(trim($mon_text) == ""){echo "I wish you a nice day.";}else{echo $mon_text;} ?>" id="mon_note_id" class="form-control mb-2" placeholder="Enter Note" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Tuesday</h6>
                                                                        <input type="text" value="<?php echo $tue_text; ?>" id="tue_note_id" class="form-control mb-2" placeholder="Enter Note" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Wednesday</h6>
                                                                        <input type="text" id="wed_note_id" value="<?php echo $wed_text; ?>" class="form-control mb-2" placeholder="Enter Note" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Thursday</h6>
                                                                        <input type="text" id="thu_note_id" value="<?php echo $thu_text; ?>" class="form-control mb-2" placeholder="Enter Note" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Friday</h6>
                                                                        <input type="text" id="fri_note_id" value="<?php echo $fri_text; ?>" class="form-control mb-2" placeholder="Enter Note" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Saturday</h6>
                                                                        <input type="text" id="sat_note_id" value="<?php echo $sat_text; ?>" class="form-control mb-2" placeholder="Enter Note" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Sunday</h6>
                                                                        <input type="text" id="sun_note_id" value="<?php echo $sun_text; ?>" class="form-control mb-2" placeholder="Enter Note" maxlength="300">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane" id="welcome_it" role="tabpanel">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <h6 class="font-weight-title black_color mb-1">Monday <small>(Default if other days empty.)</small></h6>
                                                                        <input type="text" id="mon_note_id_it" value="<?php if(trim($mon_text_it) == ""){echo "Ti auguro una buona giornata.";}else{echo $mon_text_it;} ?>" class="form-control mb-2" placeholder="Enter Note in Italian" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Tuesday</h6>
                                                                        <input type="text" id="tue_note_id_it" value="<?php echo $tue_text_it; ?>" class="form-control mb-2" placeholder="Enter Note in Italian" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Wednesday</h6>
                                                                        <input type="text" id="wed_note_id_it" value="<?php echo $wed_text_it; ?>" class="form-control mb-2" placeholder="Enter Note in Italian" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Thursday</h6>
                                                                        <input type="text" id="thu_note_id_it" value="<?php echo $thu_text_it; ?>" class="form-control mb-2" placeholder="Enter Note in Italian" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Friday</h6>
                                                                        <input type="text" id="fri_note_id_it" value="<?php echo $fri_text_it; ?>" class="form-control mb-2" placeholder="Enter Note in Italian" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Saturday</h6>
                                                                        <input type="text" id="sat_note_id_it" value="<?php echo $sat_text_it; ?>" class="form-control mb-2" placeholder="Enter Note in Italian" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Sunday</h6>
                                                                        <input type="text" id="sun_note_id_it" value="<?php echo $sun_text_it; ?>" class="form-control mb-2" placeholder="Enter Note in Italian" maxlength="300">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane" id="welcome_de" role="tabpanel">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <h6 class="font-weight-title black_color mb-1">Monday <small>(Default if other days empty.)</small></h6>
                                                                        <input type="text" id="mon_note_id_de" value="<?php if(trim($mon_text_de) == ""){echo "ich wünsche Dir einen schönen Tag.";}else{echo $mon_text_de;} ?>" class="form-control mb-2" placeholder="Enter Note in German" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Tuesday</h6>
                                                                        <input type="text" id="tue_note_id_de" value="<?php echo $tue_text_de; ?>" class="form-control mb-2" placeholder="Enter Note in German" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Wednesday</h6>
                                                                        <input type="text" id="wed_note_id_de" value="<?php echo $wed_text_de; ?>" class="form-control mb-2" placeholder="Enter Note in German" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Thursday</h6>
                                                                        <input type="text" id="thu_note_id_de" value="<?php echo $thu_text_de; ?>" class="form-control mb-2" placeholder="Enter Note in German" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Friday</h6>
                                                                        <input type="text" id="fri_note_id_de" value="<?php echo $fri_text_de; ?>" class="form-control mb-2" placeholder="Enter Note in German" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Saturday</h6>
                                                                        <input type="text" id="sat_note_id_de" value="<?php echo $sat_text_de; ?>" class="form-control mb-2" placeholder="Enter Note in German" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Sunday</h6>
                                                                        <input type="text" id="sun_note_id_de" value="<?php echo $sun_text_de; ?>" class="form-control mb-2" placeholder="Enter Note in German" maxlength="300">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info waves-effect"  onclick="update_welcome_note()">Save</button>
                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div  class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                    ...
                                                    <div class="row"> 
                                                        ...
                                                        <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                            <h4 class="pt-3 black_color" >Manage Rules</h4>
                                                            <h6>Create,edit and delete user rule</h6>
                                                        </div>
                                                    </div>
                                                </div>
