    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Edit Shift Event</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Edit Shift Event</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-6 pm-2rem">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <div class="form-group mb-0 mb-3">
                                    <input class="form-control" placeholder="Title" value="<?php echo $message; ?>" id="title-event" />
                                </div>
                                ...
                                <div class="form-group ml-1 mb-0 mt-1">
                                    <label for="message-text" class="control-label mb-0"><i class="far fa-clock"></i> <span id="hours_from_to">8</span> Hours</label>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                        ...
                        <div class="mt-3 mb-5 pb-5">
                            <input type="button" onclick="submit_event()" class="btn mt-4 w-20 btn-info" value="Save">
                        </div>
