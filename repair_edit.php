...
if(isset($_GET['id'])){
    $rpr_id=$_GET['id'];
    $sql="SELECT * FROM `tbl_repair` WHERE `rpr_id` = $rpr_id";
    ...
    $sql1="SELECT a.*,b.depart_id,b.department_name,b.icon FROM `tbl_repair_departments` as a INNER JOIN  tbl_department as b ON a.`depart_id` = b.`depart_id`  WHERE `rpr_id` =  $rpr_id";
    ...
    $sql1="SELECT a.*,b.user_id FROM `tbl_repair_recipents` as a INNER JOIN  tbl_user as b ON a.`user_id` = b.`user_id`  WHERE `rpr_id` =  $rpr_id order by 1 ASC";
    $result1 = $conn->query($sql1);
    if ($result1 && $result1->num_rows > 0) {
        while($row1 = mysqli_fetch_array($result1)) {
    ...
    if ($result1 && $result1->num_rows > 0) {
        while($row1 = mysqli_fetch_array($result1)) {
            array_push($attach_id_array,$row1['rpra_id']);
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Edit Repair</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Edit Repair</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Repair</a></li>
                                    <li class="breadcrumb-item text-success">Edit Repair</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div>
                                        ...
                                        <div class="row pt-4 small-screen-mr-16">
                                            <div class="col-lg-6 col-xlg-6 col-md-6">
                                                ...
                                                <div class="div-background mt-4 p-4">
                                                    ...
                                                    <input type="text" id="title_id" class="form-control" placeholder="Enter Title" value="<?php echo $title; ?>" >
                                                    ...
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 p-0">
                                                        ...
                                                        <div class="div-background p-4">
                                                            ...
                                                            <div class="tags-default" >
                                                                <textarea type="text" rows="6" name="comments" id="comments" class="form-control" placeholder="Write your comments..." ><?php echo $comment; ?></textarea> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 p-0">
                                                        ...
                                                        <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                                            <div>
                                                                <div class="div-background  p-4">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-10 wm-70 col-xlg-10 col-md-10">
                                                                            <h4 class="font-weight-title pt-4">Description</h4>
                                                                        </div> 
                                                                ...
                                                                <div class="div-background p-4">
                                                                    <label class="control-label"><strong>Add Comments &amp; Notes</strong></label>
                                                                    <div class="tags-default" >
                                                                        <textarea type="text" rows="2" name="comments" id="comments_it" class="form-control" placeholder="Write your comments..." ><?php echo $comment_it; ?></textarea> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                                            <div>
                                                                ...
                                                                <div class="div-background p-4">
                                                                    <label class="control-label"><strong>Add Comments &amp; Notes</strong></label>
                                                                    <div class="tags-default" >
                                                                        <textarea type="text" rows="2" name="comments" id="comments_de" class="form-control" placeholder="Write your comments..." ><?php echo $comment_de; ?></textarea> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                        <input type="button" id="create_job_id" onclick="save_repair('CREATE');" class="btn wm-30 mt-4 w-15 btn-secondary" value="Save Changes">

                                        <input type="button" id="saveastemplate_job_id" onclick="delete_repair('<?php echo $rpr_id; ?>');"  class="btn mt-4 wm-30 w-10 ml-1 btn-warning" value="Delete">

                                        <input type="button"id="template_save_id" onclick="save_repair('TEMPLATE');" class="btn mt-4 ml-1 w-20 btn-info wm-45 btn-template" value="Save as Pre-Defined">
                                        <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 wm-45 ml-1 w-20 btn-info btn-delete" value="Delete Pre-Defined">
                                        ...
                                        <input type="button" id="saveastemplate_job_id" onclick="save_repair('COMPLETED');"  class="btn wm-43 mt-4 w-20 ml-1  btn-success" value="Repair Completed">
        ...
        <script>
            ...
            function save_repair(create_as){
                ...
                var rpr_id = <?php echo json_encode($rpr_id);?>;
                ...
                if(title_.trim() != "" || title_it_.trim() != "" || title_de_.trim() != ""){
                    ...
                    $.ajax({
                        ...
                        method:'POST',
                        data:{module_name_:"repair",title_:title_,title_it_:title_it_,title_de_:title_de_,tag_:tag_,description_:description_,description_it_:description_it_,description_de_:description_de_,comment_:comment_,comment_it_:comment_it_,comment_de_:comment_de_,recipents_:recipents_,dep_array_id:dep_array_id,save_as:save_as,rpr_id:rpr_id,visibility_status_:visibility_status_},
                        success:function(response){
                            console.log(response);
                            if(response == "1"){
                                Swal.fire({
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            method:'POST',
                            data:{ tablename:"tbl_repair", idname:"rpr_id", id:id_, statusid:1,statusname: "is_delete"},
                            success:function(response){
                                console.log(response);
                                if(response == "Updated"){
                                    Swal.fire({
        ...
        <script>
            ...
            function delete_attachment(id,id2){
                $.ajax({
                    ...
                    method:'POST',
                    data:{ source:"repair", id:id, id2:id2},
                    success:function(response){
                        console.log(response);
                        if(response == "success"){
