...
<html lang="en">
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Employee Detail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 pr-0">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Employee Detail</h4>
                        </div>
                    ...
                    <div class="print-container mrm-15px">
                        <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20">
                                                            <div  id="div_last_name_c" class="form-group ">
                                                                <input onkeyup="error_handle_c('last_name')" type="text" class="form-control" id="last_name_m"  placeholder="Last Name*" > 
                            ...
                            <div class="col-lg-7 col-xlg-7 col-md-7">
                                <h5 class="font-weight-title mr-3 edit-show">Select Title: </h5>
                                ...
                                <input   type="text" id="first_name" value="<?php  echo $name; ?>" class="form-control  edit-show"  placeholder="First Name">
                                <input   type="text" id="last_name" value="<?php  echo $surname; ?>" class="form-control w-30 wm-100 edit-show"  placeholder="Last Name"><br class="edit-show">
                                <small class="text-muted">Email address</small>
                                <br>
                                <h4 class="text-show"><?php echo $email; ?></h4> 
                                <input type="text" id="email" class="form-control w-30 wm-100 edit-show" value="<?php  echo $email; ?>" placeholder="Email address">
                                <small class="text-muted p-t-30 db">Phone</small>
                                <h4 class="text-show"><?php if($phone !=""){ echo $phone;} else{ echo "N/A";} ?></h4>
                                <input type="text" id="phone" class="form-control w-30 wm-100 edit-show"  value="<?php  echo $phone; ?>" placeholder="Phone">

                                <small class="text-muted p-t-30 db">Tax Number</small>
                                <h4 class="text-show"><?php if($tax_number != "") {echo $tax_number;}else{echo "N/A";} ?></h4>
                                <input type="text" id="taxnumber" class="form-control w-30 wm-100 edit-show"  value="<?php  echo $tax_number; ?>" placeholder="Tax Number">

                                <small class="text-muted p-t-30 db">Date Of Birth</small>
                                <h4 class="text-show"><?php if($dob != "") {echo $dob;} else{echo "N/A";} ?></h4>
                                <input type="date" id="dob" class="form-control w-30 wm-100 edit-show" value="<?php  echo $dob; ?>"   placeholder="Date Of Birth">
                                <small class="text-muted p-t-30 db">Place Of Birth</small>
                                <h4 class="text-show"><?php if($dob_place !="") {echo $dob_place;} else{echo "N/A";} ?></h4>
                                <input id="dob_place"  value="<?php  echo $dob_place; ?>" type="text" class="form-control w-30 wm-100 edit-show"  placeholder="Place Of Birth">
                                ...
                                <textarea id="message" type="date" class="form-control  edit-show"  placeholder="Message"><?php
                                ...
                                <small class="text-muted p-t-30 db">Work Start Date</small>
                                ...
                                <small class="text-muted p-t-30 db">Work End Date</small>
    ...
    echo " Currently Working";}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11 col-xlg-11 col-md-11 text-show">
                                <a type="button" href="<?php echo $resume_url ?>" class="btn btn-secondary"><i class="fas fa-arrow-down"></i>  Download CV</a>
                            </div>
                            <?php }?>
                            <div class="col-lg-11 col-xlg-11 col-md-11 edit-show">
                                <small class="text-muted p-t-30 db">Upload CV</small>
                                <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-xlg-5 col-md-5">
                                <div class="form-group">
                                    <label class="control-label"><strong>Add Comments</strong></label>
                                    <textarea type="text" name="comments" id="comments" rows="3" class="form-control" placeholder="Comments"><?php echo $comments ;?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-5 col-xlg-5 col-md-5">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Social Competence</strong></label>
                                    <br>
                                    <?php 
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Methodical Competence</strong></label>
                                    <br>
                                    <?php 
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Personal Competence</strong></label>
                                    <br>
                                    <?php 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Profractional Competence</strong></label>
                                    <br>
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>General Competence</strong></label>
                                    <br>
                                    <?php 
    ...
    if ($result && $result->num_rows > 0) {
        while($row = mysqli_fetch_array($result)) {
                            ?>
                            <a type="button" href="working_time.php?id=<?php echo $row[0]; ?>" class="btn btn-info wm-38 w-10 ml-3 b-show">Working Time</a>
                            <?php
        ...
        if($Edit_users_teams_departments == 1 || $usert_id ==1){
                            ?>
                            <a type="button"  onclick="open_model()" href="javascript:void(0)" class="btn wm-30 btn-info w-10 ml-3 b-show" data- >Create User</a>
                            <?php
        }
    }
                            ?>
                            ...
                            ?>
                            <a type="button"  onclick="d()" href="javascript:void(0)" class="btn btn-info wm-20 w-10 ml-3 b-show">Delete</a>
                            <?php if ($status_id != 7){?>
                            <a onclick="edit()" type="button" href="javascript:void(0)" class="b-show btn mtm-10 mlm-0 wm-20 btn-info w-10 ml-3">Edit</a>
                            <a onclick="cancel()" type="button" href="javascript:void(0)" class="btn wm-20 btn-info w-10 ml-3 
                                                                                                 b-cancle">Cancel</a>
                            <?php 
}
                            ?>
