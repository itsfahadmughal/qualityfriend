                ...
                <div class="login-box card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal"  method="POST" id="loginform">
                            ...
                            <div class="form-group ">
                                <div class="col-xs-12">
                                    <input class="form-control" name="email" aria-labe="Email" type="email" required="" placeholder="Email"> </div>
                            </div>

                            <div class="form-group">
                                <div class="col-xs-12">
                                    <div class="input-group" id="show_hide_password">
                                        <input type="password" required name="password" class="form-control" id="signin-password" placeholder="Password" autocomplete="off">
            ...
            function check_email(event){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        if(response == "1"){
                            Swal.fire({
                                title: 'Password Reset & New Password sent to your email...',
                                type: 'success',
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if($row['is_active']==1){
                ...
                if($hotel_language == 'EN'){
                    ...
                    echo '<script>window.location.href = "it/dashboard.php";</script>';
                }
            }else{
?>
<script> 
