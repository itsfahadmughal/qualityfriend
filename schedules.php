    ...
    <body class="skin-default-dark fixed-layout">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                        ...
                        <form>
                            <div class="form-group mb-2">
                                <select class="form-control" id="pre_defined_shifts" onchange="pre_defined_selected();">
                                    <option value="0">Select Pre-Defined Shift</option>
                                    <?php
                            ...
                            <div class="form-group mb-2">
                                ...
                                <label for="message-text" class="control-label ml-1 mtm-10">Break <small>(min)</small></label>
                                <input type="number" style="width:80px;" class="form-control mtm-10 display-inline w-30" min="0" max="240" id="break_mint" />

                            </div>
                            <div class="form-group mb-2 ml-1">
                                <label for="message-text" class="control-label mr-2"><i class="far fa-clock"></i> <span id="hours_from_to">8</span> Hours</label>

                                <label class="custom-control custom-checkbox display-inline ml-5 mm-0">
                                    <button onclick="redirect_to_off_time();" type="button" class="btn w-100 btn-secondary">Add Off Time</button>
                                </label>
                                <label class="custom-control custom-checkbox display-inline">
                                    <button onclick="redirect_to_blocked_day();" type="button" class="btn w-100 btn-success">Add Holiday</button>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="message-text" class="control-label ml-1">Apply to</label>
                                <div class="display_flex_div">
                                    <div>
                                        <span id="day_<?php echo date('D', strtotime($array_week_dates[0])); ?>" onclick="setDayWeek('<?php echo $array_week_dates[0]; ?>','day_<?php echo date('D', strtotime($array_week_dates[0])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[0])); ?></span>
                                    </div>
                                    <div>
                                        <span id="day_<?php echo date('D', strtotime($array_week_dates[1])); ?>" onclick="setDayWeek('<?php echo $array_week_dates[1]; ?>','day_<?php echo date('D', strtotime($array_week_dates[1])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[1])); ?></span>
                                    </div>
                                    <div>
                                        <span id="day_<?php echo date('D', strtotime($array_week_dates[2])); ?>" onclick="setDayWeek('<?php echo $array_week_dates[2]; ?>','day_<?php echo date('D', strtotime($array_week_dates[2])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[2])); ?></span>
                                    </div>
                                    <div>
                                        <span id="day_<?php echo date('D', strtotime($array_week_dates[3])); ?>" onclick="setDayWeek('<?php echo $array_week_dates[3]; ?>','day_<?php echo date('D', strtotime($array_week_dates[3])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[3])); ?></span>
                                    </div>
                                    <div>
                                        <span id="day_<?php echo date('D', strtotime($array_week_dates[4])); ?>" onclick="setDayWeek('<?php echo $array_week_dates[4]; ?>','day_<?php echo date('D', strtotime($array_week_dates[4])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[4])); ?></span>
                                    </div>
                                    <div>
                                        <span id="day_<?php echo date('D', strtotime($array_week_dates[5])); ?>" onclick="setDayWeek('<?php echo $array_week_dates[5]; ?>','day_<?php echo date('D', strtotime($array_week_dates[5])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[5])); ?></span>
                                    </div>
                                    <div>
                                        <span id="day_<?php echo date('D', strtotime($array_week_dates[6])); ?>" onclick="setDayWeek('<?php echo $array_week_dates[6]; ?>','day_<?php echo date('D', strtotime($array_week_dates[6])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[6])); ?></span>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="message-text" class="control-label ml-1">Shift Repetition (Optional)</label>
                                <input type="date" class="form-control display-inline w-30 wm-43" id="repeat_until">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Shifts Notes" id="message-text"></textarea>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button onclick="save_shift();" type="button" class="btn btn-success waves-effect waves-light">Save</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="responsive-modal-schedule-event" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left">Create Event</h3>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <label for="message-text" class="control-label ml-2"><i class="far fa-clock"></i> <span id="hours_from_to_event">8</span> Hours</label>
                            </div>

                            <div class="form-group">
                                <label for="message-text" class="control-label ml-1"><b>Select Multiple Day Event</b></label>
                                <div class="display_flex_div">
                                    <div>
                                        <span id="event_day_<?php echo date('D', strtotime($array_week_dates[0])); ?>" onclick="setDayWeekEvent('<?php echo $array_week_dates[0]; ?>','event_day_<?php echo date('D', strtotime($array_week_dates[0])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[0])); ?></span>
                                    </div>
                                    <div>
                                        <span id="event_day_<?php echo date('D', strtotime($array_week_dates[1])); ?>" onclick="setDayWeekEvent('<?php echo $array_week_dates[1]; ?>','event_day_<?php echo date('D', strtotime($array_week_dates[1])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[1])); ?></span>
                                    </div>
                                    <div>
                                        <span id="event_day_<?php echo date('D', strtotime($array_week_dates[2])); ?>" onclick="setDayWeekEvent('<?php echo $array_week_dates[2]; ?>','event_day_<?php echo date('D', strtotime($array_week_dates[2])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[2])); ?></span>
                                    </div>
                                    <div>
                                        <span id="event_day_<?php echo date('D', strtotime($array_week_dates[3])); ?>" onclick="setDayWeekEvent('<?php echo $array_week_dates[3]; ?>','event_day_<?php echo date('D', strtotime($array_week_dates[3])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[3])); ?></span>
                                    </div>
                                    <div>
                                        <span id="event_day_<?php echo date('D', strtotime($array_week_dates[4])); ?>" onclick="setDayWeekEvent('<?php echo $array_week_dates[4]; ?>','event_day_<?php echo date('D', strtotime($array_week_dates[4])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[4])); ?></span>
                                    </div>
                                    <div>
                                        <span id="event_day_<?php echo date('D', strtotime($array_week_dates[5])); ?>" onclick="setDayWeekEvent('<?php echo $array_week_dates[5]; ?>','event_day_<?php echo date('D', strtotime($array_week_dates[5])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[5])); ?></span>
                                    </div>
                                    <div>
                                        <span id="event_day_<?php echo date('D', strtotime($array_week_dates[6])); ?>" onclick="setDayWeekEvent('<?php echo $array_week_dates[6]; ?>','event_day_<?php echo date('D', strtotime($array_week_dates[6])); ?>');" class="month_name_style"><?php echo date('D', strtotime($array_week_dates[6])); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Description (Optional)" id="message-text-event"></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal_event();" data-dismiss="modal">Cancel</button>
                        <button onclick="save_event();" type="button" class="btn btn-primary waves-effect waves-light">Save</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="responsive-modal-delete-shift" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left">Delete Shifts</h3>
                        ...
                        <form>
                            <div class="form-group">
                                <select class="form-control" id="delete_shift_select" onchange="hide_show_until_date_delete();">
                                    <option value="1">Delete Only This Shift</option>
                                    <option value="2">Delete All Shifts On the Following Same Weekdays</option>
                                    <option value="3">Delete All Shifts Till Certain Date</option>
                                </select>
                            </div>
                            <div class="form-group" id="delete_shift_date_form" style="display:none;">
                                <label for="message-text" class="control-label ml-1"><b>Delete Until</b></label>
                                <input type="date" class="form-control" id="delete_shift_date" />
                            </div>
                            <div class="form-group">
                                <select class="form-control" id="delete_shift_select_apply_users">
                                    <option value="1">Only for Assigned User</option>
                                    <option value="2">Apply for All Users</option>
                                </select>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal_delete_shift();" data-dismiss="modal">Cancel</button>
                        <button onclick="delete_schedule();" type="button" class="btn btn-danger waves-effect waves-light">Delete</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="page-wrapper">
                    ...
                    <div class="container-fluid pb-0 mobile-container-padding">
                        ...
                        <div class="row page-titles heading_style">
                            ...
                            <div class="col-lg-1 align-self-center text-right">
                                <button onclick="backwardDate();" class="btn w-100 btn-info d-lg-block "><i class="ti-angle-double-left"></i> Backward</button>
                            </div>
                            ...
                            <div class="col-lg-1 align-self-center text-right mtm-10">
                                <button onclick="forwardDate();" class="btn w-100 btn-info d-lg-block ">Forward <i class="ti-angle-double-right"></i></button>
                            </div>
                            <div class="col-lg-1 align-self-center text-right mtm-10">
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="selectpicker" onchange="get_selected_val();" id="depart_select" multiple data-style="form-control btn-secondary mt-1">
                                ...
                                if ($result && $result->num_rows > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                ?>
                                <option value="<?php echo $row[0]; ?>" <?php if(in_array($row[0], $view_departments_array)){echo 'selected';} ?>><?php if($row[1] != ""){ echo $row[1]; }else if($row[2] != ""){ echo $row[2]; }else{ echo $row[3]; } ?></option>
                                <?php
                                    }
                                }
                                ?>
                        ...
                        <div class="col-lg-10 align-self-center mobile_text_left mtm-10 text-right">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn">
                                    <a class="dropdown-item" href="javascript:void()" onclick="print_schedule();"><i class="fas fa-print"></i> Print</a>
                                    <a class="dropdown-item" href="schedule_settings.php"><i class="mdi mdi-settings"></i> Settings</a>
                                    <a class="dropdown-item" href="pre_defined_shifts.php"><i class="fas fa-calendar-check"></i> Pre-Defined Shifts</a>
                                </div>
                            </div>
                            ...
                            <button type="button" onclick="notify_changes('<?php echo $s_date; ?>','<?php echo $e_date; ?>');" id="publish_changes_btn" class="mlm-04 schedule_buttons_font_ btn btn-success ml-3"><i class="far fa-paper-plane"></i> Publish Changes</button>

                            <button type="button" class="mlm-04 schedule_buttons_font_ btn btn-secondary ml-3 right-side-toggle">Pre-Defined Shifts</button>
                ...
                <div class="col-lg-12 mt-3 mb-4">
                    ...
                    <table id="schedule-week-view">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="empty_w padding-event-8"><a href="#">Events</a></td>
                            ...
                            <tr>
                                <td colspan="8" class="depart_w">
                                    <h6 class="mb-0"><?php echo $row['department_name']; ?></h6>
                                </td>
                            </tr>
                            <?php
                                    }
                            ...
                            <tr>
                                ...
                                ?>
                                <h5 class="font-0-8 text-success"><b>Full Holiday</b></h5>
                                <?php
                                            }else{
                                ?>
                                <span <?php if($d1 != 1){ ?> class="cursor-pointer insert_schedule_symbol_leave" onclick="insert_schedule('<?php echo $full_name; ?>','<?php echo $row['user_id']; ?>','<?php echo $array_week_dates[0]; ?>','<?php echo date('D', strtotime($array_week_dates[0])); ?>');" <?php } ?> >
                                    <h5 class="font-0-8 text-success"><b>PARTIAL HOLIDAY</b></h5>
                                    <?php
                                                if($view_filter_selected == "" || $view_filter_selected == "all"){
                                ...
                                ?>
                                <h5 class="font-0-8 text-danger"><b><?php echo $row_leave_day['category'].' LEAVE FULL'; ?></b></h5>
                                <?php
                                                }else{
                                ?>
                                <span <?php if($d1 != 1){ ?> class="cursor-pointer insert_schedule_symbol_leave" onclick="insert_schedule('<?php echo $full_name; ?>','<?php echo $row['user_id']; ?>','<?php echo $array_week_dates[0]; ?>','<?php echo date('D', strtotime($array_week_dates[0])); ?>');" <?php } ?> >
                                    <h5 class="font-0-8 text-danger"><b><?php echo $row_leave_day['category'].' LEAVE PARTIAL'; ?></b></h5>
                                    <?php
                                                    if($view_filter_selected == "" || $view_filter_selected == "all"){
                                                        $inner_sql = "SELECT * FROM `tbl_shifts` WHERE `assign_to` = $userid_inner AND `date` = '$array_week_dates[0]' AND is_active = 1 AND is_delete = 0 AND hotel_id = $hotel_id ORDER BY start_time ASC";
                                                    }else if($view_filter_selected == "upcomming"){
                ...
                <div class="right-sidebar">
                    <div class="slimscrollright">
                        <div class="rpanel-title"> <b>Pre-Defined Shifts</b> <span><i class="ti-close right-side-toggle"></i></span> </div>
        ...
        <script>
            ...
            function save_shift(){
                ...
                if(user_id == "" || from_time == "" || to_time == "" || hourDiff == "" || selected_dates_array.length === 0){
                    alert("Select All Fields Except Shift Notes.");
                }else{
            ...
            function notify_changes(s1,s2){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        if(response == "1"){
                            Swal.fire({
                                title: 'Shifts Changes Notify to Users.',
                                type: 'success',
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: 'Ok'
                            }).then((result) => {
                            ...
                            alert("Changes Already Notified.");
                        }
                    },
                    error: function(xhr, status, error) {
                        console.log(error);
                ...
                if(copied_pre_id != 0){
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                Swal.fire({
                                    title: 'Pre Defined Shift Pasted!',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Ok'
                                }).then((result) => {
                    ...
                    var x = document.getElementById("snackbar");
                    x.className = "show";
                    x.innerHTML="Nothing Copied.";
                    setTimeout(function(){ x.className = x.className.replace("show", ""); }, 1000);
                }

                console.log(user_id_,selected_date_,x);
            }
            ...
            function copy_pre_shift(id_pre){
                ...
                var x = document.getElementById("snackbar");
                x.className = "show";
                x.innerHTML="Pre Defined Shift Copied.";
                setTimeout(function(){ x.className = x.className.replace("show", ""); }, 1000);
            }
