...
if(isset($_SESSION['language'])){
    ...
    if($_SESSION['language'] == 'DE'){
        $script = "<script>
window.location = '".$baseurl."de/".$final."';</script>";
        echo $script;
...
<header class="topbar">
                        ...
                        <ul>
                            <li>
                                <div class="drop-title bg-primary text-white">
                                    <h4 class="m-b-0 m-t-5"><?php echo $result_not->num_rows; ?> New</h4>
                            ...
                            <li>
                                <a class="nav-link text-center m-b-5" href="dashboard.php"> <strong>Check all notifications</strong> <i class="fa fa-angle-right"></i> </a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    if($chat_flag == 1){
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="drop-title text-white bg-danger">
                                    <h4 class="m-b-0 m-t-5"><?php echo $lenth_all_msg; ?> New</h4>
        ...
        for ($x = 0; $x < $lenth_all_msg; $x++) {
                            ...
                            <li>
                                <a class="nav-link text-center link m-b-5" href="chat.php"> <b>See all messages</b> <i class="fa fa-angle-right"></i> </a>
                            </li>
                        </ul>
                    </div>
                </li>
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY" style="border-bottom:10px solid #00BCEB!important;">
                        ...
                        <a class="dropdown-item" href="user_profile.php"><i class="ti-user m-r-5 m-l-5"></i> My Profile</a>
                        <?php if($Send_Receive_messages == 1 || $usert_id == 1){
    if($chat_flag == 1){
                        ?>
                        <a class="dropdown-item" href="chat.php"><i class="ti-email m-r-5 m-l-5"></i> Inbox</a>
                        <?php } } ?>

                        <form  id="my_form"  method="POST">
                            <span class="dropdown-item"><i class="ti-unlink m-r-5 m-l-5"></i>
                                <input class="btn p-0 w-100" style="text-align:left;" type="submit" name="logout" value="Logout"/>
                            </span>
                        </form>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
                        <!-- Dropdown header -->
                        <div class="px-3 py-3">
                            <h6 class="" style="font-weight:bold;margin:0px;font-size: 1.0625rem;font-family: inherit;">Choose Language</h6>
                        </div>
                        <!-- List group -->
