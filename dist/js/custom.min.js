$(function() {
    ...
    if(localStorage.getItem("themeColor") != null){
        ...
        var checkbox=localStorage.getItem("themeColorCheck");
        o(color);
    ...
    var e = function() {
        (window.innerWidth > 0 ? window.innerWidth : this.screen.width) < 1170 ? ($("body").addClass("mini-sidebar"), $(".navbar-brand span").hide()) : ($("body").removeClass("mini-sidebar"), $(".navbar-brand span").show());
...
function o(e) {
    ...
    var temp = e.replace("skin-", "");
    localStorage.setItem("themeColorCheck", "."+temp+"-theme");

    var i, o;
    return $.each(a, function(e) {
        $("body").removeClass(a[e])
    }), $("body").addClass(e), i = "skin", o = e, "undefined" != typeof Storage ? localStorage.setItem(i, o) : window.alert("Please use a modern browser to properly view this template!"), !1
}(i = void("undefined" != typeof Storage || window.alert("Please use a modern browser to properly view this template!"))) && $.inArray(i, a) && o(i)
