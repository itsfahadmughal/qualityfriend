            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Handovers</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pr-4 mobile-container-padding">
                        ...
                        ?>
                        <div class="col-lg-12-custom pr-0">
                            <div  class="list-background-active text-center padding-top-8" onclick="redirect_url('handover.php');">
                    ...
                    <div class="row pl-3 pr-3">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3">
                            ...
                            <a href="handover_create.php" class="btn btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Create Handover</a>
                            <?php } ?>
                        </div>
                        <?php
                        ...
                        <div class="col-12">
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                if($is_completed == 0){
                                                ?>
                                                <tr>    
                                                    <td class="text-center"><b><?php echo $title; ?></b><br><div class="label pl-4 pr-4 label-table btn-info cursor-pointer" onclick="redirect_url('handover_detail.php?id=<?php echo $row[0]; ?>');">Handover</div></td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="delete_handover('<?php echo $row[0]; ?>');">Delete</a>
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="duplicate_handover('<?php echo $row[0]; ?>');">Duplicate</a>
                                                                <a class="dropdown-item" href="handover_detail.php?id=<?php echo $row[0]; ?>">View</a>
                                                                <a class="dropdown-item" href="handover_edit.php?id=<?php echo $row[0]; ?>">Edit</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <?php } ?>
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                            <h1 class="text-center pt-5 pb-5">Handovers Not Found</h1>
                        </div>
                        <?php
                        }
                        ?>
