...
<html lang="en">
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Recycle bin</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mb-0 mobile-container-padding">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Recycle bin</h4>
                        </div>
                                        ...
                                        <table id="myTable" style="display:inline-table;" class="tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="stack"
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist" class="border text-center" ><b>Type</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border text-center" ><b> Date &amp; Time</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border text-center" ><b>Restore</b></th>
                                                </tr>
                                            </thead>
    ...
    for($i=0;$i<sizeof($data);$i++){
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                            <h1 class="text-center pt-5 pb-5">Recycle bin is Empty</h1>
                        </div>
                        <?php
}
                        ?>
        ...
        <script>
            ...
            function restore(id, table_name, id_name){
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: "You wan't to restore this!",
                    type: 'warning',
