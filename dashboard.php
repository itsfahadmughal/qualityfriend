                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-12 plm-3 pl-0 mt-1 pr-3">
                            <select class="form-control" style="background-color:#00BCEB;color:white;" onchange="change_data();" id="modules_list">
                                ...
                                <?php  if($handover_flag == 1){ ?> <option value="tbl_handover">Handovers</option> <?php } ?>
                                <?php  if($handbook_flag == 1){ ?> <option value="tbl_handbook">Handbooks</option> <?php } ?>
                                <?php  if($checklist_flag == 1){ ?> <option value="tbl_todolist">Todo/Checklist</option> <?php } ?>
                                <?php  if($notices_flag == 1){ ?> <option value="tbl_note">Notices</option> <?php } ?>
                                <?php  if($repairs_flag == 1){ ?> <option value="tbl_repair">Repairs</option> <?php } ?>
                                <?php  if($housekeeping_flag == 1){ ?> <option value="tbl_housekeeping">Housekeeping</option> <?php } ?>
                                <?php  if($time_schedule_flag == 1){ ?> <option value="tbl_shifts">Time Schedule</option> <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-1 pr-0">
                            <button id="del_btn" hidden onclick="delete_all()" type="button" class="btn mt-2 btn-danger mb-3 pl-3 pr-3">Delete</button>
                        </div>
                    </div>
                    ...
                    <div class="row" id="load_alerts">
                                    ...
                                    <div class="table-responsive">
                                        <table class=" tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="stack"
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist" class="border text-center" ><b>Alert Title &amp; Type</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border mobile_display_none text-center" ><b> Creator</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border mobile_display_none text-center" ><b> Involved</b></th>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="5" class="border mobile_display_none text-center" ><b> Date</b></th>
                                                </tr>
                                            </thead>
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                if(!$result_sub4 && !$result_sub3){ 
                                                    ...
                                                    <td class="text-center dashboard_action_border">
                                                        <div class="btn-group">
                                                            <span id="thisstatus" class="dropdown-toggle label label-table label-danger pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Action</span>

                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" href="javascript:void(0);" onclick="delete_alert('<?php echo $row[0]; ?>')">Delete</a>



                                                                <?php if($row['id_table_name'] == "tbl_handover"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_handover','status_id','<?php if($status == "Completed"){echo "6";}else{echo "8";} ?>','hdo_id')"><?php if($status == "Completed"){echo "Completed";}else{echo "Mark as Complete";} ?></a> <?php }else 

                                                            if($row['id_table_name'] == "tbl_repair"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_repair','status_id','<?php if($status == "Completed"){echo "6";}else{echo "8";} ?>','rpr_id')"><?php if($status == "Completed"){echo "Completed";}else{echo "Mark as Complete";} ?></a> <?php }else

                                                                if($row['id_table_name'] == "tbl_todolist"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_todolist','status_id','<?php if($status == "Completed"){echo "6";}else{echo "8";} ?>','tdl_id')"><?php if($status == "Completed"){echo "Completed";}else{echo "Mark as Complete";} ?></a> <?php }else

                                                                    if($row['id_table_name'] == "tbl_shifts"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_shifts','is_completed','<?php if($status == "Completed"){echo "0";}else{echo "1";} ?>','sfs_id')">

                                                                <?php if($status == "Completed"){echo "Completed";}else{echo "Mark as Complete";} ?></a> <?php } ?>
                        ...
                        ?>
                        <div class="col-lg-12 col-xlg-12 col-md-12 mt-5 pt-5">
                            <h1 class="text-center pt-5 pb-5 text-success"><i class="mdi mdi-bell-sleep bell_size text-info"></i> No Alerts Found</h1>
                        </div>
                        <?php
                        }
                        ?>
