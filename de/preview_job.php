    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Vorschau Job</p>
            </div>
        </div>
        <!-- ============================================================== -->
                                    ...
                                    <div class="col-lg-9 col-xlg-9 col-md-9 ">
                                        <div class="row " >
                                            ...
                                            <div class="col-md-6  mt-2">
                                                <label class="label_f text-black" >Vorname*</label>
                                                <div id="div_first_name" class="form-group ">
                                                    ...
                                                    <small id="error_msg_first_name" class="form-control-feedback display_none">Vorname ist erforderlich</small> 
                                                </div>
                                            </div>

                                            <div class="col-md-6  mt-2">
                                                <label class="text-black" >Nachname*</label>
                                            ...
                                            <div class="col-md-6 ">
                                                <label class="text-black" >Geburtsdatum</label>
                                            ...
                                            <div class="col-lg-6 col-xlg-6 col-md-6 ">
                                                <label class="text-black" >Abteilung auswählen*</label>
                                            ...
                                            <div class="col-md-6" >
                                                ...
                                                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                                    <div class="form-control" data-trigger="fileinput">
                                                        <i class="glyphicon glyphicon-file fileinput-exists"></i>
                                                        <span class="fileinput-filename">Bild hochladen</span>
                                                    </div>
                                                    <span class="input-group-append btn btn-default btn-file"> 
                                                        <span class="fileinput-new">Bild auswählen</span>
                                                        <span class="fileinput-exists">Veränderung</span>
                                            ...
                                            <div class="col-md-12" >
                                                <input type="submit" onclick="addapplicant();" class="wm-100 btn w-20 btn-secondary" value="Los geht's!">
                                            </div>
