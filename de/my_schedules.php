    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Mein Plan</p>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <span class="text-dark"><b>Nachricht an Mitarbeiter (optional)</b></span>
                                <textarea class="form-control" placeholder="Message" id="message-text"></textarea>
                            </div>
                            <div class="form-group">
                                <span>Sie werden benachrichtigt, wenn ein anderer Kollege Ihre Schicht übernimmt und diese von einem Vorgesetzten genehmigt wurde. Bis dahin ist es immer noch Ihre Schicht.</span>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal();" data-dismiss="modal">Stornieren</button>
                        <button onclick="offer_shift_save();" type="button" class="btn btn-success waves-effect waves-light">Angebot auf</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="responsive-modal-trade" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left text-dark">Handelswechsel</h3>
                        <button type="button" class="close" data-dismiss="modal" onclick="dismiss_modal_trade();" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="form-group mb-3">
                                <span class="text-dark"><b>Handelswechsel</b></span>
                                <div class="row">
                                    <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal_trade();" data-dismiss="modal">Stornieren</button>
                        <button onclick="trade_shift_save();" type="button" class="btn btn-info waves-effect waves-light">Handelswechsel</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="page-wrapper">
                ...
                <div class="col-lg-12 mt-3 mb-4">
                    ...
                    <table id="schedule-week-view">
                        <thead>
                            <tr>
                                <th class="empty_w"><h4 class="text-dark">Mitarbeiter</h4></th>
                                <th class="days_w">
                        ...
                        <tbody>
                            <tr>
                                <td class="empty_w">Veranstaltungen</td>
                                <td>
                                    <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-left background-shadow-div2">
                                        ...
                                        ?>
                                        <button class="btn btn-success font-0-8 slot-btn-p w-100 mb-2" disabled>Vollendet</button>
                                        <?php
                                                    }
                                                }else{
                                                    if($button_visibility == "COMPLETE_ONLY" || $button_visibility == "VISIBLE_ALL"){
                                        ?>
                                        <button class="btn btn-dark font-0-8 slot-btn-p w-100 mb-2" onclick="change_status_complete(<?php echo $row_inner['sfs_id']; ?>,'<?php echo $row_inner['title']; ?>');">Als abgeschlossen markieren</button>
                                        <?php 
                                                    }
                                        ...
                                        ?>
                                        <button class="btn btn-secondary font-0-8 slot-btn-p w-100" onclick="take_back('<?php echo $row_inner['sfs_id']; ?>');">Zurücknehmen</button>
                                        <?php 
                                                        }
                                                    }else{
                                        ...
                                        ?>
                                        <button class="btn btn-primary font-0-8 slot-btn-p w-100" onclick="cancel_trade('<?php echo $row_inner['sfs_id']; ?>');">Handel abbrechen</button>
                                        <?php
                                                            }
                                                        }else{
                                                            if($button_visibility == "OFFER_UP_ONLY" || $button_visibility == "VISIBLE_ALL"){
                                        ...
                                        <button class="btn btn-secondary font-0-8 slot-btn-p w-100" onclick="offer_up_shift('<?php echo $row_inner['sfs_id']; ?>');">Biete Hochschicht an</button>
                                        <?php }     if($button_visibility == "TRADE_ONLY" || $button_visibility == "VISIBLE_ALL"){ ?>
                                        <button class="btn btn-primary font-0-8 slot-btn-p w-100 mt-2" onclick="trade_shift('<?php echo $row_inner['sfs_id']; ?>');">Handeln</button>
                                        <?php } } } } ?>
   ...
   ?>
        ...
        <script>
            ...
            function offer_shift_save(){
                ...
                Swal.fire({
                    title: 'Bist du dir sicher?',
                    text: "Sie wollen Schicht anbieten!",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
            ...
            function take_back(shift_){
                Swal.fire({
                    title: 'Bist du dir sicher?',
                    text: "Sie möchten die Schicht zurücknehmen!",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                            ...
                            success:function(response){
                                ...
                                if(response == "success"){
                                    ...
                                    Swal.fire({
                                        type: 'warning',
                                        title: 'Hoppla...',
                                        text: 'Die Schicht ist bereits abgeschlossen, Sie können sie nicht zurücknehmen.',
                                        footer: ''
                                    });
                                }else{
                                    Swal.fire({
            ...
            function trade_shift_save(){
                ...
                if(offer_to_shift != ""){
                    ...
                    alert("Schicht nicht für Handel ausgewählt.");
                }
            }
            ...
            function cancel_trade(id){
                Swal.fire({
                    title: 'Bist du dir sicher?',
                    text: "Sie möchten den Handel stornieren!",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                            ...
                            success:function(response){
                                ...
                                if(response == "success"){
                                    ...
                                    Swal.fire({
                                        type: 'warning',
                                        title: 'Hoppla...',
                                        text: 'Schicht bereits abgeschlossen, Sie können nicht stornieren.',
                                        footer: ''
                                    });
                                }else{
                                    Swal.fire({
