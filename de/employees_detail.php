...
<html lang="en">
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Mitarbeiterdetails</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 pr-0">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Mitarbeiterdetails</h4>
                        </div>
                    ...
                    <div class="print-container mrm-15px">
                        <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="div_first_name_c" class="form-group ">
                                                                ...
                                                                <input onkeyup="error_handle_c('first_name')" type="text" class="form-control" id="first_name_m" placeholder="Vorname*"> 
                                                        ...
                                                        <div class="col-md-12 m-b-20">
                                                            <div  id="div_last_name_c" class="form-group ">
                                                                ...
                                                                <input onkeyup="error_handle_c('last_name')" type="text" class="form-control" id="last_name_m"  placeholder="Nachname*" > 
                                                        ...
                                                        <div class="col-md-12 m-b-20">
                                                            <div  id="div_email_c" class="form-group ">
                                                                <input type="email" class="form-control" id="email_m"  placeholder="Email*"> 
                            ...
                            <div class="col-lg-7 col-xlg-7 col-md-7">
                                <h5 class="font-weight-title mr-3 edit-show">Titel auswählen: </h5>
                                ...
                                <div class="custom-control custom-radio inline-div b-cancle">
                                    ...
                                    <label class="custom-control-label" for="customRadio2">Frau.</label>
                                </div><br class="edit-show">
                                <small class="text-muted">Name</small>
                                <br>
                                <h4 class="text-show"><?php echo $title.". ".$name." ".$surname; ?></h4> 
                                <input   type="text" id="first_name" value="<?php  echo $name; ?>" class="form-control w-30 wm-100 edit-show"  placeholder="Vorname">
                                <input   type="text" id="last_name" value="<?php  echo $surname; ?>" class="form-control w-30 wm-100 edit-show"  placeholder="Nachname"><br class="edit-show">
                                <small class="text-muted">E-Mail-Addresse</small>
                                <br>
                                <h4 class="text-show"><?php echo $email; ?></h4> 
                                <input type="text" id="email" class="form-control w-30 wm-100 edit-show" value="<?php  echo $email; ?>" placeholder="E-Mail-Addresse">
                                <small class="text-muted p-t-30 db">Telefon</small>
                                <h4 class="text-show"><?php if($phone !=""){ echo $phone;} else{ echo "N/A";} ?></h4>
                                <input type="text" id="phone" class="form-control w-30 wm-100 edit-show"  value="<?php  echo $phone; ?>" placeholder="Telefon">

                                <small class="text-muted p-t-30 db">Steuernummer</small>
                                <h4 class="text-show"><?php if($tax_number != "") {echo $tax_number;}else{echo "N/A";} ?></h4>
                                <input type="text" id="taxnumber" class="form-control w-30 wm-100 edit-show"  value="<?php  echo $tax_number; ?>" placeholder="Steuernummer">

                                <small class="text-muted p-t-30 db">Geburtsdatum</small>
                                <h4 class="text-show"><?php if($dob != "") {echo $dob;} else{echo "N/A";} ?></h4>
                                <input type="date" id="dob" class="form-control w-30 wm-100 edit-show" value="<?php  echo $dob; ?>"   placeholder="Geburtsdatum">
                                <small class="text-muted p-t-30 db">Geburtsort</small>
                                <h4 class="text-show"><?php if($dob_place !="") {echo $dob_place;} else{echo "N/A";} ?></h4>
                                <input id="dob_place"  value="<?php  echo $dob_place; ?>" type="text" class="form-control w-30 wm-100 edit-show"  placeholder="Geburtsort">
                                <small class="text-muted p-t-30 db">Requested Department</small>
                                <br>
                                ...
                                <small class="text-muted p-t-30 db">Nachricht</small>
                                <textarea id="message" type="date" class="form-control  edit-show"  placeholder="Nachricht"><?php
                                ...
                                <small class="text-muted p-t-30 db">Startdatum der Arbeit</small>
                                <input type="date" id="start_working_time" class="form-control w-30 wm-100 edit-show" value="<?php  echo $start_working_time; ?>"   placeholder="Arbeitsbeginn">
                                <h4 class="text-show"><?php echo $start_working_time; ?></h4>
                                <small class="text-muted p-t-30 db">Enddatum der Arbeit</small>
                                <h4><?php if($status_id == 4){
    echo "Derzeit in Arbeit";}
                                    else {
                            ...
                            <div class="col-lg-3 col-xlg-3 col-md-3 text-right text-show">
                                ...
                                <a type="button" onclick="window.print()" href="javascript:void(0)" 
                                   class="btn btn-secondary">
                                    <i class="mdi mdi-printer"></i>  Drucken</a>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11 col-xlg-11 col-md-11 text-show">
                                <a type="button" href="<?php echo '.'.$resume_url ?>" class="btn btn-secondary"><i class="fas fa-arrow-down"></i>  Lebenslauf herunterladen</a>
                            </div>
                            <?php }?>
                            <div class="col-lg-11 col-xlg-11 col-md-11 edit-show">
                                <small class="text-muted p-t-30 db">Lebenslauf hochladen</small>
                                <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-xlg-5 col-md-5">
                                <div class="form-group">
                                    <label class="control-label"><strong>Füge Kommentare hinzu</strong></label>
                                    <textarea type="text" name="comments" id="comments" rows="3" class="form-control" placeholder="Bemerkungen"><?php echo $comments ;?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-5 col-xlg-5 col-md-5">
                                <div class="form-group">
                                    ...
                                    <div class="tags-default" >
                                        <input type="text" name="tags" id="tags" class="form-control" data-role="tagsinput" placeholder="Tags" value="<?php echo $tags; ?>" > 
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Sozialkompetenz</strong></label>
                                    <br>
                                    <?php 
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                ...
                                <div class="div">
                                    <label class="control-label"><strong>
                                        Methodische Kompetenz</strong></label>
                                    <br>
                                    <?php 
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Persönliche Kompetenz</strong></label>
                                    <br>
                                    <?php 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Fachliche Kompetenz</strong></label>
                                    <br>
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Allgemeine Kompetenz</strong></label>
                                    <br>
                                    <?php 
                    ...
                    <div class="row mbm-20">
                        ...
                        <div class="col-lg-10 col-xlg-10 col-md-10">
                            ...
                            <?php if ($status_id != 7){?>
                            <input type="submit" onclick="save()"  value="Speichern" class="btn btn-secondary wm-30 w-10">
                            <?php 
    ...
    if ($result && $result->num_rows > 0) {
        while($row = mysqli_fetch_array($result)) {
                            ?>
                            <a type="button" href="working_time.php?id=<?php echo $row[0]; ?>" class="btn wm-30 btn-info w-10 ml-3 b-show">Arbeitszeit</a>
                            <?php
        ...
        if($Edit_users_teams_departments == 1 || $usert_id ==1){
                            ?>
                            <a type="button"  onclick="open_model()" href="javascript:void(0)" class="btn wm-38 btn-info w-10 ml-3 b-show" data- >Benutzer Erstellen</a>
                            <?php
        }
    }
                            ?>
                            ...
                            ?>
                            <a type="button"  onclick="d()" href="javascript:void(0)" class="btn mtm-10 mlm-0 wm-30 btn-info w-10 ml-3 b-show">Löschen</a>
                            <?php if ($status_id != 7){?>
                            <a onclick="edit()" type="button" href="javascript:void(0)" class="b-show mtm-10 wm-30 btn btn-info w-10 ml-3">Bearbeiten</a>
                            <a onclick="cancel()" type="button" href="javascript:void(0)" class="btn wm-30 btn-info w-10 ml-3 
                                                                                                 b-cancle">Abbrechen</a>
                            <?php 
}
                            ?>
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        if(response == "rating_updated"){
                            Swal.fire({
                                title: 'Ihre Arbeit wurde gespeichert',
                                type: 'success',
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: 'In Ordnung'
                            }).then((result) => {
        ...
        <script>
            $(document).ready(function() {
                ...
                drEvent.on('dropify.beforeClear', function(event, element) {
                    return confirm("Möchten Sie wirklich löschen \"" + element.file.name + "\" ?");
                });
