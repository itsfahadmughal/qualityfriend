    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">ToDo/Checklisten-Detail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">ToDo/Checklisten-Detail</h5>
                        </div>
                    ...
                    <div class="">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Checkliste</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                        ...
                        <div id="add-inspection-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Inspektion</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                        <div class="row div-white-background pt-3 pl-4 pb-3 pr-4" >
                                            <div class="col-lg-12 col-xlg-12 col-md-12">
                                                ...
                                                <small class="text-muted p-t-30 db">Sichtbarkeitsstatus</small>
                                                <h4 class="text-show"><?php if($visibility_status !=""){ echo $visibility_status;} else{ echo "N/A";} ?></h4>
                                                <small class="text-muted p-t-30 db">Anfangsdatum</small>
                                                ...
                                                <small class="text-muted p-t-30 db">Kommentare</small>
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php echo $comment_array[$x]; ?> <span class="fs-11"> kommentiert von <b><?php echo $username; ?></b> (<?php echo $entrytime; ?>)</span>
                                                </h4>
                            ...
                            if(sizeof($comments_arr) != 0){
                                for($i=0;$i<sizeof($comments_arr);$i++){    
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php echo $comments_arr[$i]; ?><span class="fs-11">&nbsp; kommentiert von <b><?php echo $comment_user_arr[$i]; ?></b> (<?php echo $entrytime_arr[$i]; ?>)    <?php if($Create_edit_todo_checklist == 1 || $usert_id == 1){ ?> <a href="javascript:void(0);" onclick="delete_comment('<?php echo $comments_id_arr[$i]; ?>')"><i class="fas fa-trash-alt red-color text-right"></i></a> <?php } ?> </span></h4>   
                                                <?php
                                }
                            }
                                                ?>
                                                ...
                                                <h4 class="text-show"><?php    for ($x = 0; $x < sizeof($attach_url_array); $x++) { ?>
                                                    <a data-toggle="tooltip" data-original-title="Klicken Sie hier, um den Anhang anzuzeigen" href="<?php echo $attach_url_array[$x]; ?>" target="_blank"><?php if($x!=sizeof($attach_url_array)-1){echo "Anhang-".($x+1).", ";}else{echo "Anhang-".($x+1) ;} ?> </a> <?php } ?></h4>
                                                <?php
                                                                                         }
                                                ?>
                                            </div>
                                            <div class="col-lg-12 col-xlg-12 col-md-12">      
                                                <button id="rb" data-toggle="modal" onclick="todo_model()"  type="button" class="btn mt-4 btn-secondary"><i class=" ti-menu-alt"></i><span id="mchecklist">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;Checklist's
                                                    </span></button>
                                                <?php  if( $flag_check == 1)  { ?>
                                                <button id="todo"
                                                ...
                                                ?> "><?php if($status_id==6){echo 'Abgeschlossen markieren';}else{echo '<i class="fa fa-check"></i> &nbsp; Erledigt';}?>
                                                ...
                                                <button <?php if($is_complete==1){echo 'disabled';} ?>  
                                                        ...
                                                        && $status_id==6
                                                        ){echo 'Abgeschlossen markieren';}else{echo '<i class="fa fa-check"></i>&nbsp; Erledigt';}?>
                                                </button>
                                                ...
                                                ?>
                                                <button disabled
                                                        onclick="" type="button" class="btn mt-4 <?php if($status_id==6){echo 'btn-info';}else{echo 'btn-success';} ?>"><?php if($status_id==6){echo 'Nicht Abgeschlossen';}else{echo '<i class="fa fa-check"></i>&nbsp; Erledigt';}?>
                                                </button>               

                                                <?php }?>


                                                <button data-toggle="modal" data-target="#add-comments-contact" type="button" class="btn mw-40 ml-3 w-20 wm-80 ml-0 mt-4 btn-warning"><i class="mdi mdi-plus-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;Füge Kommentare hinzu</button>
        ...
        <script>
            ...
            function rbc() {
                ...
                if(size == 0  ){
                    ...
                    element.innerText = "Keine zusätzliche Checkliste";
                }else {
                    var checked =  $('input[name=lineup2]:checked').length;
                    var total=  $('input[name=lineup2]').length;
                    var diff = total - checked ;
                    ...
                    if(diff == 0 ){
                        ...
                        element.innerText = "Checkliste ist abgeschlossen";
                        element.disabled = true;
                        element.style.display = "none";

                        var element1 = document.getElementById("mchecklist");
                        element1.innerText = "    Checklist's Abgeschlossen";
                        ...
                        element.innerText = "Markieren Sie alle Checklisten als erledigt";
            ...
            function rcc() {
                ...
                if(size == 0  ){
                    ...
                    if(diff == 0 ){
                        ...
                        element1.innerText = "    Tour's Abgeschlossen";
            ...
            function rdc() {
                ...
                if(size == 0  ){
                    ...
                    if(diff == 0 ){
                        ...
                        element1.innerText = "    Inspektionen Abgeschlossen";
                        var element2 = document.getElementById("rd");
                        element2.classList.add("btn-success");
                        element2.classList.remove("btn-secondary");
                    }else{ 
                        var element1 = document.getElementById("minspection");
                        element1.innerText = "  Inspektionen";
                        var element2 = document.getElementById("rd");
                        element2.classList.add("btn-secondary");
                        element2.classList.remove("btn-success");
                    }
            ...
            function inpection_model() {
                ...
                if(size == 0 ){
                    Swal.fire({
                        title: 'Für diese Aufgabe/Checkliste wurde keine Inspektion gefunden',
                        type: 'basic',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'Ok'
                    });
            ...
            function todo_model() {
                ...
                if(size == 0  ){
                    Swal.fire({
                        title: 'Keine Checkliste für diese Aufgabe/Checkliste gefunden',
                        type: 'basic',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'Ok'
                    });
            ...
            function tour_model() {
                ...
                if(size == 0 ){
                    Swal.fire({
                        title: 'Keine Tour für diese Aufgaben/Checkliste gefunden',
                        type: 'basic',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'Ok'
                    });
