...
if($result1){
    ...
    $last_id = $id;
    $alert_msg = $message." Schicht aktualisiert.";
    ...
    echo '1';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','$message Schicht aktualisiert','$hotel_id','$last_edit_time')";
