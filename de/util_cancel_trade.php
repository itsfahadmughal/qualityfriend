...
if($result_update1){
    ...
    $alert_msg = $msg." (Schichthandel abgebrochen)";
    ...
    echo 'success';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','Schicht abgesagt','$hotel_id','$last_edit_time')";
