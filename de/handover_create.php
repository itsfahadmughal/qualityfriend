...
<html lang="en">
    ...
    <head>
        ...
        <title>Übergabe erstellen</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Übergabe erstellen</p>
            </div>
        </div>
        <!-- ============================================================== -->
...
<h4 class="text-themecolor font-weight-title font-size-title">Übergabe erstellen</h4>
</div>
-->

                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Übergabe erstellen</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Übergaben</a></li>
                                    <li class="breadcrumb-item text-success">Übergabe erstellen</li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    <div class="row pt-4 small-screen-mr-16">
                                        <div class="col-lg-6 col-xlg-6 col-md-6">
                                            ...
                                            <div class="div-background mt-4 p-4">
                                                ...
                                                <input type="text" id="title_id" required class="form-control" placeholder="Titel eingeben">
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                            <input type="button" id="create_job_id" onclick="save_handover('CREATE');" class="btn mt-4 w-20 btn-secondary" value="Erstellen">
                                            <input type="button" id="saveasdraft_job_id" onclick="save_handover('DRAFT');"  class="btn mt-4 w-20 ml-3 wm-43  btn-outline-info" value="Als Entwurf speichern">
                                            <input type="button" id="template_save_id" onclick="save_handover('TEMPLATE');" class="btn mt-4 ml-3 w-20 wm-43 btn-outline-info btn-template" value="Als Vorlage speichern">
                                            <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 ml-3 wm-43 w-20 btn-outline-info btn-delete" value="Vorlage löschen">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                Swal.fire({
                                    title: 'Übergabevorlage erstellt',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'In Ordnung'
                                }).then((result) => {
