    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Stastiken</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Stastiken</h4>
                        </div>
                    </div>
                ...
                <div class="row pl-4 pr-4">
                        ...
                        <select id="template" onchange="depart_changed();" class="select2 form-control custom-select">
                            ...
                            if ($result && $result->num_rows > 0) {
                                while ($row = mysqli_fetch_array($result)) {
                                    ?>
                            <option <?php if($depart == $row[0]){echo 'selected';}else{echo '';} ?> value='<?php echo $row[0]; ?>'><?php if($row[3] != ""){ echo $row[3]; }else if($row[1] != ""){ echo $row[1]; }else{ echo $row[2]; } ?></option>
                            <?php
                                }
                            }
                            ?>
                    ...
                    <div class="col-lg-3 align-self-center text-right mtm-10">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" id="week_sort_btn" onclick="change_sort('week');" class="btn btn-<?php if($view_selected == 'week'){echo 'secondary';}else{echo 'light';} ?>">Woche</button>
                            <button type="button" id="day_sort_btn" onclick="change_sort('month');" class="btn btn-<?php if($view_selected == 'month'){echo 'secondary';}else if($view_selected == ""){ echo 'secondary'; }else{echo 'light';} ?>">Monat</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 mt-4">
                    ...
                    <div class="row pm-2rem">
                        ...
                        <div class="col-lg-10 border_style_engage">
                            <div class="text-center w-24 wm-50 pt-4 pb-4 display-inline">
                                ...
                                <h4 class="mt-2 mb-0 text-success schedule_buttons_font_"><b>Zuverlässigste </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The employee with the best weekly shift coverage. This employee has the least 'no shows' and is the most punctual for given time period."></i></h4>
                            ...
                            <div class="text-center w-25 wm-50 pt-3 pb-3 display-inline">
                                ...
                                <h4 class="mt-2 mb-0 text-danger schedule_buttons_font_"><b>Am eifrigsten </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The employee who has bid on the most shifts in the Shift Pool for the given time period."></i></h4>
                                <span><?php echo $row['fullname']; ?></span>
                                <?php } }else{ ?>
                                <div class="w-100">
                            ...
                            <div class="text-center w-25 wm-50 pt-3 pb-3 display-inline">
                                ...
                                <h4 class="mt-2 mb-0 text-warning schedule_buttons_font_"><b>Die meisten Krankheitstage </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The employee with the most Sick flags on a location's schedule for the given time period."></i></h4>
                                <span><?php echo $row['fullname']; ?></span>
                                <?php } }else{ ?>
                                <div class="w-100">
                            ...
                            <div class="text-center w-25 wm-50 pt-3 pb-3 display-inline">
                                ...
                                <h4 class="mt-2 mb-0 text-dark schedule_buttons_font_"><b>Die meisten ausgefallenen Schichten </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The employee who has dropped the most shifts in the given time period."></i></h4>
                                <span><?php echo $row['fullname']; ?></span>
                                <?php } }else{ ?>
                                <div class="w-100">
                        ...
                        <div class="col-lg-2 pl-0 prm-0px">
                            <div class="mt-3 border_style_engage p-3">
                                <h4 class="mt-2 mb-0 text-dark"><b>Durchschn. Schichtpunktzahl </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The average Score collected from Shift Feedback surverys."></i></h4>
                                ...
                                <small>
                                    ...
                                    0.8 vorherige</small>
                                <br><br>
                                <a href="my_schedules.php">Schichten anzeigen</a>

                            </div>

                            <div class="mt-5 border_style_engage p-3">
                                <h4 class="mt-2 text-dark"><b>Durchschn. Amtszeit </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The average time collected from Shift Feedback surverys."></i></h4>

                                <i class="far fa-calendar-alt emoji-size"></i>
                                <h1 class="display-inline pl-2 text-success"><?php
                                    echo rand(280,320);
                                    ?> </h1>
                                <h3 class="display-inline text-success">Tage</h3>
                        ...
                        <div class="col-lg-4 mb-3 prlm-0px">
                            <div class="mt-3 border_style_engage h-100">
                                <h4 class="mt-2 mb-0 p-3 text-dark"><b>Am engagiertesten </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="These are your most engaged employees, determined by several factors including punctuality, shift bids, and dropped shifts."></i></h4>
                                ...
                                <div class="pt-2 pb-2 border-top-engaged row ml-0 mr-0">
                                    ...
                                    <div class="col-lg-6 text-right mt-2"><span class="text-success">Hoch engagiert</span></div>
                                </div>
                        ...
                        <div class="col-lg-4 pr-0 mb-3 plm-0">
                            <div class="mt-3 border_style_engage h-100">
                                <h4 class="mt-2 mb-0 p-3 text-dark"><b>Engagement Rate </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="These are your least enganged employees, determined by several factors including punctuality, shift bids, and dropped shifts."></i></h4>
                    ...
                    <div class="row mt-4 mb-5 pm-2rem mtm-0 mbm-0">
                        ...
                        <div class="col-lg-10 border_style_engage">
                            <div class="text-center w-24 wm-50 pt-4 pb-4 display-inline">
                                <h4 class="mt-2 text-dark"><b>Keine Aufführungen </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The number of occurences where an employee was scheduled for a shift and did not show up."></i></h4>
                                <h1><?php
                                    if($depart == 0){
                            ...
                            <div class="text-center w-25 wm-50 pt-3 pb-3 display-inline">
                                <h4 class="mt-2 text-warning"><b>Krankheit </b><i class="far fa-question-circle" data-toggle="tooltip" data-original-title="The number of shifts in the given time period where the `Sick` shift flag was applied."></i></h4>
                                <h1><?php
                                    if($depart == 0){
