...
<html lang="en">
    <head>
        ...
        <title>Reparaturen Entwürfe</title>
        <!-- Footable CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Reparaturen Entwürfe</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Reparaturen Entwürfe</h4>
                        </div>
                         ...
                         <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Entwürfe Reparaturen</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0">
                                    <h4 class="card-title inline-div mm-0">Reparaturen Lista</h4>
                                    <div class="table-responsive">
                                        <table style="display:inline-table;" id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="25">
                                            ...
                                            <tbody>
                                                <?php 
                                                $sql="SELECT * FROM `tbl_repair` WHERE `hotel_id` = $hotel_id and is_delete = 0 and saved_status = 'DRAFT'";
                                                ...
                                                <tr id="<?php echo $i; ?>">
                                                    ...
                                                    <td class="font-size-subheading text-center"><a href="repair_edit.php?id=<?php echo $row['rpr_id']; ?>"><i class="fas fa-pencil-alt"></i></a></td>
                                                </tr>
