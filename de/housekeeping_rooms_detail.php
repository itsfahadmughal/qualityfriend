...
<html lang="en">
    <head>
        ...
        <title>Housekeeping Detail</title>
        <!-- Footable CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Housekeeping Room Detail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class=" row page-titles mobile-container-padding heading_style">
                        <div class="col-md-4 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Housekeeping Detail</h4>
                        </div>
                        ...
                        <div class="col-md-4 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Housekeeping Detail</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="color_change" class="row heading_style pt-2 pb-2 <?php echo $room_is; ?> white_text">
                        ...
                        <div class="col-lg-4  col-sm-4"  >
                            <select  onchange="update_room_status('room_status')" id="room_status" class="form-control custom-select" style="width: 100%">
                                ...
                                <option value="Dirty" >Schmutzig</option>
                                <option value="Cleaning_in_progress">Säuberung im Gange</option>
                                <option value="Clean" >Sauber</option>
                                <option value="Inspection_in_progress" >Inspektion läuft</option>
                                <option value="Inspected" >Inspiziert</option>
                                <option value="No_cleaning_desired" >Keine Reinigung erwünscht</option>
                            </select>
                        </div>
                        <div class="col-lg-2  col-sm-2 " >
                            <div class="checkbox checkbox-success mt-2">
                                ...
                                <label class="font-weight-title pl-2 mb-2">Bitte nicht stören</label>
                            </div>
                        </div>
    ...
    echo $guest_name_array[0]; } else {echo "N/A";} ?></h6>
                            ...
                            <div class="row room_detail_box p-3 mt-1 mbm-20" >
                                ...
                                <div class="col-lg-12 black_text div_v_a mt-2" >
                                    <h6>Keine Geburtstage innerhalb dieses Aufenthaltes</h6>
