                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-5 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Profil Einstellungen</h4>
                        </div>
                    ...
                    <div class="row" >
                        <div class="col-lg-8 col-xlg-8 col-md-8">
                            <div class="card">
                                ...
                                <ul class="nav nav-tabs profile-tab" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings" role="tab">Einstellungen</a> </li>
                                </ul>
                                <!-- Tab panes -->
                                    ...
                                    <div class="tab-pane active" id="home" role="tabpanel">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-xs-6"> <strong>Benutzertyp</strong>
                                                    <br>
                                            ...
                                            <hr>
                                            <strong>Abteilung: </strong><p class="display-inline"><?php
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal form-material" onsubmit="event.preventDefault();">
                                                <div class="form-group">
                                                    <label class="col-md-12">Altes Passwort</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Passwort" name="old_password" id="old_password" class="form-control form-control-line">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="example-email" class="col-md-12">Neues Passwort</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Neues Passwort" class="form-control form-control-line" name="new_password" id="new_password">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="example-email" class="col-md-12">Bestätigen Neues Passwort</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Bestätigen Neues Passwort" class="form-control form-control-line" name="confirm_new_password" id="confirm_new_password">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <button class="btn btn-success" onclick="update_password();">
                                                            Passwort erneuern</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="col-lg-4 col-xlg-4 col-md-4">
                            ...
                            <button class="btn btn-success mt-4" onclick="update_profile_pic();">Bild ändern</button>
                        </div>
                    </div>
                    ...
                    if(confirm_new_pass == new_pass){
                        $.ajax({
                            ...
                            success:function(response){
                                if(response == "1"){
                                    Swal.fire({
                                        title: 'Ihr neues Passwort wurde aktualisiert (Prüfen Sie die E-Mail auf das neue Passwort).',
                                        type: 'success',
                                    ...
                                    Swal.fire({
                                        type: 'error',
                                        title: 'Oops...',
                                        text: 'Altes Passwort nicht gefunden!',
                                        footer: ''
                                    });
                                }else{
                                    Swal.fire({
                        ...
                        alert("Neues Passwort stimmt nicht überein. Versuchen Sie es erneut!");
                    }
                }
            }
