...
<html lang="en">
    <head>
        ...
        <title>Übergaben Entwürfe</title>
        <!-- Footable CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Übergaben Entwürfe</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Übergaben Entwürfe</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Übergaben Entwürfe</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title mm-0 inline-div">Übergaben Liste</h4>
                                    <div class="table-responsive">
                                        <table style="display:inline-table;" id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="25">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Titel</th>
                                                    <th>Beschreibung</th>
                                                    <th class="mobile_display_none">Visibility Status</th>
                                                    <th style="text-align:center;">Edit</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
                                                $sql="SELECT * FROM `tbl_handover` WHERE `hotel_id` = $hotel_id and is_delete = 0 and saved_status = 'DRAFT'";
                                                ...
                                                <tr id="<?php echo $i; ?>">
                                                    ...
                                                    <td class="mobile_display_none"><?php echo $row['visibility_status']; ?></td>
                                                    <td class="font-size-subheading text-center"><a href="handover_edit.php?id=<?php echo $row['hdo_id']; ?>"><i class="fas fa-pencil-alt"></i></a></td>
                                                </tr>
                                        ...
                                        <div id="snackbar">Einige schreiben eine Nachricht..</div>
                                    </div>
                                </div>
                            </div>
                        </div>
