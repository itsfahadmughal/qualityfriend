...
<html lang="en">
    ...
    <head>
        ...
        <title>Stellenanzeige erstellen</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Stellenanzeige erstellen</p>
            </div>
        </div>
        <!-- ============================================================== -->
                    ...
                    <div class="mobile-container-padding">
                        <div class="row page-titles mb-3 heading_style">
                            <div class="col-md-5 align-self-center">
                                <h5 class="text-themecolor font-weight-title font-size-title mb-0">Stellenanzeige erstellen</h5>
                            </div>
                            <div class="col-md-7 align-self-center text-right">
                                <div class="d-flex justify-content-end align-items-center">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Recruiting</a></li>
                                        <li class="breadcrumb-item text-success">Stellenanzeige erstellen</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="tab-pane active" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    ...
                                                    <input type="text" id="title_id" class="form-control" placeholder="Titel">
                                                    <div class="row pt-4">
                                                        ...
                                                        <div class="col-lg-6 col-xlg-6 col-md-6">
                                                            <h4 class="font-weight-title">Erstelt am</h4>
                                                    ...
                                                    <input type="button" id="saveasdraft_job_id" onclick="save_job('DRAFT');" class="btn mt-4 w-20 btn-secondary" value="Als Entwurf speichern">
                                                    <input type="submit" id="create_job_id" onclick="save_job('CREATE');" class="btn mt-4 ml-3 w-20 btn-info" value="Erstellen">

                                                </div>
                                                <div class="col-lg-3 col-xlg-3 col-md-3 pt-4"> 
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="card-title">Bild für Stellenanzeige hinzufügen <small>(Höhe:400-500 pixel, Breite:1200-1500 pixel)</small></h4>
