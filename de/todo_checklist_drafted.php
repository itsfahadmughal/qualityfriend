...
<html lang="en">
    <head>
        ...
        <title>Aufgaben-/Checklisten-Entwürfe</title>
        <!-- Footable CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Aufgaben-/Checklisten-Entwürfe</p>
            </div>
        </div>
        <!-- ============================================================== -->
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">
                                Aufgaben-/Checklisten-Entwürfe</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Entwürfe Todo/Checklisten</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title inline-div">Aufgaben-/Checklistenliste</h4>
                                        ...
                                        <table style="display:inline-table;" id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="25">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Titel</th>
                                                    <th>Beschreibung</th>
                                                    <th class="mobile_display_none">Geburtstermin</th>
