            ...
            <div class="login-register login_background" style="background-image:url(../assets/images/background/login-register.jpg);">
                <div class="login-box card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="POST" onsubmit="check_email(event);" id="recoverform">
                            <div class="form-group ">
                                <div class="col-xs-12">
            ...
            function check_email(event){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        if(response == "1"){
                            Swal.fire({
                                title: 'Passwort zurücksetzen & Neues Passwort an Ihre E-Mail gesendet...',
                                type: 'success',
                            ...
                            Swal.fire({
                                title: 'Ihre E-Mail existiert nicht.',
                                type: 'error',
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: 'Ok'
                            }).then((result) => {
...
<script> 
    ...
    Swal.fire({
        title: 'Ungültige E-Mail oder Passwort',
        type: 'error',
        confirmButtonColor: '#3085d6',
        confirmButtonText: 'Ok'
    }).then((result) => {
