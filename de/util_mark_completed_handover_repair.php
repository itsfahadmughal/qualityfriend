...
if($source == "handover"){
    ...
    if(isset($row_sub33['title_de'])){
        if($row_sub33['title_de'] != ""){
        ...
        if($result_update){
            ...
            if ($result_get_recipent && $result_get_recipent->num_rows > 0) {
                while($row_get_recipent = mysqli_fetch_array($result_get_recipent)) {
                    ...
                    $aleart_msg = $title." Vom Administrator als abgeschlossen markiert";
            ...
            $title_send = "Handover Abgeschlossen";
            $body_send =  $title." Vom Administrator abgeschlossen "; ;
