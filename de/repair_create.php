...
<html lang="en">
    ...
    <head>
        ...
        <title>Reparatur erstellen</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Reparatur erstellen</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Reparatur erstellen</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Reparaturen</a></li>
                                    <li class="breadcrumb-item text-success">Reparatur erstellen</li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                            <input type="button" id="create_job_id" onclick="save_repair('CREATE');" class="btn mt-4 wm-30 w-10 mw-25 btn-secondary" value="Erstellen">
                                            <input type="button" id="saveasdraft_job_id" onclick="save_repair('DRAFT');"  class="btn wm-45 mt-4 mw-25 w-20 ml-1  btn-outline-info" value="Als Entwurf speichern">
                                            <input type="button"id="template_save_id" onclick="save_repair('TEMPLATE');" class="btn wm-45 mw-25 mt-4 ml-1 w-20 btn-info btn-template" value="Als Vorlage speichern">
                                            <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 wm-43 ml-1 w-20 btn-info btn-delete" value="Vordefiniert löschen">

                                            <input type="button" id="saveastemplate_job_id" onclick="save_repair('CREATE');"  class="btn wm-80 mw-40 mt-4 w-30 ml-1  btn-danger" value="Als nicht erledigte Reparatur speichern">

                                            <input type="button" id="saveastemplate_job_id" onclick="save_repair('COMPLETED');"  class="btn mw-25 mt-4 w-15 ml-1 wm-43  btn-success" value="Reparatur erledigt">
                                        </div>
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                Swal.fire({
                                    title: 'Reparieren als vordefiniert gespeichert',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'In Ordnung'
                                }).then((result) => {
