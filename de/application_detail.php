...
if(isset($_GET['id'])){
    ...
    $sql="SELECT a.*,b.department_name,c.status FROM `tbl_applicants_employee` AS a INNER JOIN tbl_department as b on a.`depart_id_app` = b.depart_id
...
<html lang="en">
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Bewerberdetail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 pr-0">
                    ...
                    <div class="row page-titles">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title"> Bewerberdetail</h4>
                        </div>
                    ...
                    <div class="print-container">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-xlg-7 col-md-7">
                                ...
                                <input   type="text" id="first_name" value="<?php  echo $name; ?>" class="form-control w-30 edit-show"  placeholder="Vorname">
                                <input   type="text" id="last_name" value="<?php  echo $surname; ?>" class="form-control w-30 edit-show"  placeholder="Nachname"><br class="edit-show">
                                <small class="text-muted">E-Mail-Addresse</small>
                                <br>
                                <h4 class="text-show"><?php echo $email; ?></h4> 
                                <input type="text" id="email" class="form-control w-30 edit-show" value="<?php  echo $email; ?>" placeholder="E-Mail-Addresse">
                                <small class="text-muted p-t-30 db">Telefon</small>
                                <h4 class="text-show"><?php echo $phone ?></h4>
                                <input type="text" id="phone" class="form-control w-30 edit-show"  value="<?php  echo $phone; ?>" placeholder="Telefon">
                                <small class="text-muted p-t-30 db">Angeforderte Abteilung</small>
                                <br>
    ...
    $sql="SELECT * FROM `tbl_department` WHERE `hotel_id` =  $hotel_id and is_delete = 0 and is_active = 1 and depart_id != 0";
                                ...
                                <textarea id="message" type="date" class="form-control  edit-show"  placeholder="Nachricht"><?php echo $message; ?></textarea>
                                ...
                                <small class="text-muted p-t-30 db">Antragsdatum</small>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-11 col-xlg-11 col-md-11 text-show">
                                <a type="button" target="_blank" href="<?php echo '.'.$resume_url ?>" class="btn btn-secondary"><i class="fas fa-arrow-down"></i>Lebenslauf Herunterladen</a>
                            </div>
                            <?php }?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Methodische Kompetenz</strong></label>
                                    <br>
                                    <?php 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-xlg-2 col-md-2">
                                <!-- Rating -->
                                <div class="div">
                                    <label class="control-label"><strong>Professionelle Kompetenz</strong></label>
                                    <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-xlg-10 col-md-10">
                            <?php if($status_id != 3){ ?>
                            <input type="submit" onclick="save()"  value="Speichern" class="btn btn-secondary w-10">
                            <a type="button" onclick="updatestatus(4)" href="javascript:void(0)" class="btn btn-info w-10 ml-3 b-show">Akzeptieren</a>
                            <a type="button" onclick="updatestatus(5)" href="javascript:void(0)" class="btn btn-info w-10 ml-3 b-show">Ablehnen</a>
                            <?php
}
                            ?>
                            <a type="button"  onclick="d()" href="javascript:void(0)" class="btn btn-info w-10 ml-3 b-show">Löschen</a>
                            <?php if($status_id != 3){ ?>
                            <a onclick="edit()" type="button" href="javascript:void(0)" class="b-show btn btn-info w-10 ml-3">Bearbeiten</a>
                            <a onclick="cancel()" type="button" href="javascript:void(0)" class="btn btn-info w-10 ml-3 
