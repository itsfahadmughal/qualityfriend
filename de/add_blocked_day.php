    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Urlaub</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Urlaub</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6 pm-2rem ptm-0">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-6">
                                <label class="control-label"><strong>Aus</strong></label>
                            ...
                            <div class="col-lg-6">
                                <label class="control-label"><strong>Zu</strong></label>
                                <div class="input-group">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-12">
                                <label class="control-label"><strong>Feiertagstyp</strong></label>
                                <select onchange="to_offtime_date();" id="select2" class="form-control custom-select">
                                    <option value="FULL">Volle Tage</option>
                                    <option value="PARTIAL" <?php if(trim($hourdiff) < 8 && trim($hourdiff) != 0){ echo 'selected'; } ?> >Teilzeit Tag</option>
                                </select>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-5">
                                ...
                                <label for="message-text" class="control-label mr-2"><i class="far fa-clock"></i> <span id="hours_from_to"><?php if(trim($hourdiff) != 0){ echo $hourdiff;}else{echo '8';} ?></span> Std</label>
                            </div>
                        ...
                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" id="submit_off_time" onclick="submit_offtime()" class="btn mt-4 w-20 btn-info" value="Speichern">
                        </div>
