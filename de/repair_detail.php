    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Reparatur Detail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Reparatur Detail</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Reparaturen</a></li>
                                    <li class="breadcrumb-item text-success">Reparatur Detail</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            if(sizeof($comments_arr) != 0){
                                for($i=0;$i<sizeof($comments_arr);$i++){    
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php echo $comments_arr[$i]; ?><span class="fs-11">&nbsp; kommentiert von <b><?php echo $comment_user_arr[$i]; ?></b> (<?php echo $entrytime_arr[$i]; ?>)    <?php if($Create_edit_repairs == 1 || $usert_id == 1){ ?> <a href="javascript:void(0);" onclick="delete_comment('<?php echo $comments_id_arr[$i]; ?>')"><i class="fas fa-trash-alt red-color text-right"></i></a> <?php } ?> </span></h4>   
                                                <?php
                                }
                            }
                                                ?>
                                                ...
                                                <input type="button" id="create_job_id" onclick="change_status('activate','<?php echo $active_status ?>');" class="btn wm-45 mt-4 mw-40 w-20 btn-secondary" value="Markieren als <?php if($active_status==1){echo 'inaktiv';}else{echo 'Aktiv';} ?>">

                                                <button id="saveasdraft_job_id" onclick="change_status_new('repair','<?php echo $rpr_id; ?>');"  class="btn mt-4 wm-70 ml-0 mw-40 w-25 ml-3  btn-outline-<?php if($completed_status == 6){echo 'info';}else{ echo 'success';} ?>" <?php if($completed_status != 6){echo 'disabled';} ?> ><?php if($completed_status == 6){echo 'Als abgeschlossen markieren';}else{echo '<i class="fa fa-check"></i> Als abgeschlossen markiert';} ?></button>

                                                <?php }else  if($flag  == 1  || $flag_department == 1 ) { ?>

                                                <button id="saveasdraft_job_id" onclick="change_status_new('repair','<?php echo $rpr_id; ?>');"  class="btn mt-4 wm-70 ml-0 mw-40 w-25 btn-outline-<?php if($is_completed == 0 && $completed_status == 6){echo 'info';}else{ echo 'success';} ?>" <?php if($is_completed == 0 && $completed_status == 6){echo '';}else{echo 'disabled';} ?> ><?php if($is_completed == 0 && $completed_status == 6){echo 'Als abgeschlossen markieren';}else{echo '<i class="fa fa-check"></i>Als abgeschlossen markiert';} ?></button>
