    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Mitarbeiter</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        ...
                        <div class="col-md-3 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Mitarbeiter</h5>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Mitarbeiter</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title">Mitarbeiterliste</h4>
                                    <h6 class="card-subtitle"></h6>
                                    <button type="button" class="btn btn-secondary m-t-10 mb-2 float-right" data-toggle="modal" data-target="#add-contact">Mitarbeiter hinzufügen</button>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_first_name_c" class="form-group ">
                                                                        <input type="text" onkeyup="error_handle_c('first_name')" class="form-control" id="first_name_m" placeholder="Vorname*"> 
                                                                        <small id="error_msg_first_name_c" class="form-control-feedback display_none">Vorname ist erforderlich</small>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    <div  id="div_last_name_c" class="form-group ">
                                                                        <input type="text" onkeyup="error_handle_c('last_name')" class="form-control" id="last_name_m"  placeholder="Nachname*" > 
                                                                        <small id="error_msg_last_name_c" class="form-control-feedback display_none">Nachname ist erforderlich</small>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    ...
                                                                    <div  id="div_email_c" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_email_c" class="form-control-feedback display_none">E-Mail ist erforderlich</small>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_department_c" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_department_c" class="form-control-feedback display_none"> Abteilung ist erforderlich</small> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_role_c" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_role_c" class="form-control-feedback display_none"> Rolle ist erforderlich</small> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="form-group">
                                                            <h4 class="display-inline">Titel auswählen: </h4>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    ...
                                                                    <div  id="div_first_name" class="form-group ">
                                                                        <input onkeyup="error_handle('first_name')" type="text" class="form-control form-control-danger" id="first_name" placeholder="Vorname">
                                                                        <small id="error_msg_first_name" class="form-control-feedback display_none">Vorname ist erforderlich</small> </div>

                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_last_name" class="form-group ">
                                                                    <input onkeyup="error_handle('last_name')" type="text" class="form-control form-control-danger" id="last_name"  placeholder="Nachname*"> 
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_email" class="form-group ">
                                                                    ...
                                                                    <small id="error_msg_email" class="form-control-feedback display_none">E-Mail ist erforderlich</small></div>
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <div id="div_phane_name" class="form-group ">
                                                                    ...
                                                                    <input onkeyup="error_handle('phone')" type="text" id="phone" class="form-control form-control-danger" placeholder="Telefon"> 
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_department" class="form-group ">
                                                                    ...
                                                                    <small id="error_msg_department" class="form-control-feedback display_none"> Abteilung ist erforderlich</small> </div>
                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <div  id="div_date_of_birth" class="form-group ">
                                                                    ...
                                                                    <input onchange="error_handle('dob')" onkeyup="error_handle('dob')" id="dob" type="date" class="form-control form-control-danger" placeholder="Geburtsdatum"> 

                                                                    <small id="error_msg_date_of_birth" class="form-control-feedback display_none">DOB ist erforderlich</small> </div>

                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div  id="div_place_of_birth" class="form-group ">

                                                                    <input onkeyup="error_handle('pob')" type="text" id="dob_place" class="form-control form-control-danger" placeholder="Geburtsort"> 

                                                                    <small id="error_msg_place_of_birth" class="form-control-feedback display_none">Geburtsort ist erforderlich</small> </div>
                                                            </div>


                                                            <div class="col-md-12 m-b-20">
                                                                <div  id="div_tax" class="form-group ">
                                                                    <input onkeyup="error_handle('tax')" type="text" class="form-control form-control-danger" id="tax_number" placeholder="Steuernummer"> 
                                                                    <small id="error_msg_tax" class="form-control-feedback display_none">Steuernummer ist erforderlich</small> </div>


                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div  id="div_date_of_joining" class="form-group ">
                                                                    <small  class="text-muted">Beitrittsdatum</small>
                                                                    <input onchange="error_handle('doj')" type="date" id="start_working_time" class="form-control" placeholder="Date of joining"> 
                                                                    <small id="error_date_of_joining" class="form-control-feedback display_none">Das Beitrittsdatum ist erforderlich</small> </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-info waves-effect"  onclick="addapplicant()">Speichern</button>
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Abbrechen</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
