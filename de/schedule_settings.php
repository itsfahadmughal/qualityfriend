...
<html lang="en">
    ...
    <head>
        ...
        <title>Einstellungen Dienstplan</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Einstellungen Dienstplan</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Einstellungen Dienstplan</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-4 pm-2rem">
                        <span class="cursor-pointer" onclick="history.back();"><i class="fas fa-chevron-left pr-1"></i> Dienstpläne</span>

                        <div class="mt-4">
                            <h3>Einstellungen Visualisierung</h3>
                        </div>
                        ...
                        <div class="mt-3">
                            <label class="control-label"><strong>Sichtbarkeit Typ</strong></label>
                            <select id="select2" onchange="type_changed();" class="form-control custom-select">
                                <option value="SELF">Einzelner Mitarbeiter</option>
                        ...
                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" id="save_schedule_visible" onclick="save_schedule_visible();" class="btn mt-4 w-20 btn-secondary" value="Speichern">
                        </div>
                    ...
                    <div class="col-lg-4 pm-2rem">
                        <div class="mt-5 mtm-0">
                            <h3>Einstellungen Mitarbeiterbuttons</h3>
                        </div>
                        <div class="mt-3">
                            <label class="control-label"><strong>Mitarbeiter</strong></label>
                        ...
                        <div class="mt-3">
                            ...
                            <select id="2select2" class="form-control custom-select">
                                <option value="VISIBLE_ALL">Alle Schaltflächen sichtbar</option>
                                <option value="START_END_BTN_ONLY">Start &amp; Nur End-Taste</option>
                                <option value="COMPLETE_ONLY">Nur Erledigt sichtbar</option>
                                <option value="OFFER_UP_ONLY">Schicht tauschen sichtbar</option>
                                <option value="TRADE_ONLY">Schicht übernehmen sichtbar</option>
                                <option value="NOT_VISIBLE_ALL">Keine Schaltflächen sichtbar</option>
                            </select>
                        </div>

                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" id="save_control" onclick="save_control_buttons();" class="btn mt-4 w-20 btn-secondary" value="Speichern">
                        </div>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
        ...
        <script>
            ...
            function save_schedule_visible(){
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Ja, speichern Sie es!'
                }).then((result) => {
                    if (result.value) {
                        $.ajax({
