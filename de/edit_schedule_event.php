...
<html lang="en">
    ...
    <head>
        ...
        <title>Schichtereignis bearbeiten</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Schichtereignis bearbeiten</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Schichtereignis bearbeiten</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-6 pm-2rem">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <div class="form-group mb-0 mb-3">
                                    <input class="form-control" placeholder="Titel" value="<?php echo $message; ?>" id="title-event" />
                                </div>
                        ...
                        <div class="mt-3 mb-5 pb-5">
                            <input type="button" onclick="submit_event()" class="btn mt-4 w-20 btn-info" value="Speichern">
                        </div>
