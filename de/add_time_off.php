...
<html lang="en">
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Auszeit</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Auszeit</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-4 pm-2rem ptm-0">
                        ...
                        <div class="mt-4">
                            <label class="control-label"><strong>Kategorie</strong></label>
                            <select id="select1" class="form-control custom-select">
                                <option value="PAID">Urlaub</option>
                                <option value="PAID_SICK">Krankheit</option>
        ...
        while($row = mysqli_fetch_array($result)) {
            if($row[0] == $user_selected){
                ...
                echo '<option value='.$row[0].'>'.$row[2].' '.$row[3].'</option>';
                        ...
                        <?php } ?>
                        <div class="mt-3">
                            <label class="control-label"><strong>Dauer</strong></label>
                            <select onchange="to_offtime_date();" id="select2" class="form-control custom-select">
                                <option value="FULL" >Ganzer Tag</option>
                                <option value="PARTIAL" <?php if($hours_selected < 8){echo 'selected';} ?> >Teilzeit Tag</option>
                            </select>
                        </div>
                        ...
                        <div id="amount" class="mt-3">
                            <label class="control-label"><strong>Anzahl</strong></label>
                        ...
                        <div class="mt-3">
                            ...
                            <span class="mt-1">Bitte begründen Sie Ihren Urlaubsantrag.</span>
                        </div>

                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" id="submit_off_time" onclick="submit_offtime()" class="btn mt-4 w-20 btn-info" value="Einreichen">
                        </div>
                    ...
                    <div class="col-lg-4 p-5 ptm-0">
                        ...
                        <div class="border-timeoff p-4">
                            <span><i class="far fa-clock mr-2 f-timeoff"></i> <strong> Unbezahlte Freizeit</strong></span><br><br>
                            <span class="ml-4"><?php
    ...
    }?> Stunden genehmigt(YTD)</span><br><br>
                            <span><i class="mdi mdi-cash mr-2 f-timeoff"></i> <strong> Bezahlter Urlaub</strong></span><br><br>
                            <span class="ml-4"><?php
    ...
    if ($result_paid && $result_paid->num_rows > 0) {
        while($row = mysqli_fetch_array($result_paid)) {
            if($row['th'] == null){echo '0';}else{echo $row['th'];}
                            ...
                            <span><i class="fas fa-notes-medical mr-2 f-timeoff"></i> <strong> Bezahlte Krankheitstage</strong></span><br><br>
                            <span class="ml-4"><?php
            ...
            function to_offtime_date(){
                ...
                if(to_d >= from_d){
                    ...
                    while (date <= myDate_to) {
                        ...
                        var temp = "<div class='p-2'><span><i class='icon-calender'></i> <span class='mr-5 pr-5' id='amount_date_"+(n_global_amount+1)+"'>"+dates[n_global_amount]+"</span> <input type='number' value='1' min='1' id='hours_"+(n_global_amount+1)+"' class='w-10' /> Stunden</span></div>";
                    ...
                    alert("Bis heute immer größer sein.");
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                alert("Freizeit bereits angefordert, versuchen Sie es mit anderen Daten!");
                            }else{
