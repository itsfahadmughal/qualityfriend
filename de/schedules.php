...
$days_translated = array("Mon" => "Mo", "Tue" => "Di", "Wed" => "Mi", "Thu" => "Do", "Fri" => "Fr", "Sat" => "Sa", "Sun" => "So");
$month_translated = array("Jan" => "Jän", "Feb" => "Feb", "Mar" => "März", "Apr" => "Apr", "May" => "Mai", "Jun" => "Juni", "Jul" => "Juli", "Aug" => "Aug", "Sep" => "Sept", "Oct" => "Okt", "Nov" => "Nov", "Dec" => "Dez");
...
<html lang="en">
    ...
    <head>
        ...
        <title>Dienstplan erstellen</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Dienstplan erstellen</p>
            </div>
        </div>
                        ...
                        <form>
                            <div class="form-group mb-2">
                                <select class="form-control" id="pre_defined_shifts" onchange="pre_defined_selected();">
                                    <option value="0">Wählen Vordefiniert Schicht</option>
                                    <?php
                            ...
                            <div class="form-group mb-2">
                                ...
                                <label for="message-text" class="control-label ml-1 mtm-10">Pause <small>(min)</small></label>
                            ...
                            <div class="form-group mb-2 ml-1">
                                <label for="message-text" class="control-label mr-2"><i class="far fa-clock"></i> <span id="hours_from_to">8</span> Std</label>

                                <label class="custom-control custom-checkbox display-inline ml-5 mm-0 plm-0">
                                    <button onclick="redirect_to_off_time();" type="button" class="btn schedule_buttons_font_ w-100 btn-secondary">Auszeit hinzufügen</button>
                                </label>
                                <label class="custom-control custom-checkbox display-inline">
                                    <button onclick="redirect_to_blocked_day();" type="button" class="btn schedule_buttons_font_ w-100 btn-success">Urlaub hinzufügen</button>
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="message-text" class="control-label ml-1">Anwenden auf</label>
                            ...
                            <div class="form-group">
                                <label for="message-text" class="control-label ml-1">Schicht Wiederholung (Optional)</label>
                                <input type="date" class="form-control display-inline w-30 wm-38" id="repeat_until">
                            </div>
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Anmerkungen zur Schicht" id="message-text"></textarea>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal();" data-dismiss="modal">Zurück</button>
                        <button onclick="save_shift();" type="button" class="btn btn-success waves-effect waves-light">Speichern</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="responsive-modal-schedule-event" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left">Ereignis erstellen</h3>
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="Titel" id="title-event" />
                            </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <label for="message-text" class="control-label ml-2"><i class="far fa-clock"></i> <span id="hours_from_to_event">8</span> Std</label>
                            </div>

                            <div class="form-group">
                                <label for="message-text" class="control-label ml-1"><b>Wählen Sie Mehrtägiges Ereignis</b></label>
                                <div class="display_flex_div">
                                    <div>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" placeholder="Beschreibung (optional)" id="message-text-event"></textarea>
                            </div>
                        </form>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal_event();" data-dismiss="modal">Zurück</button>
                        <button onclick="save_event();" type="button" class="btn btn-primary waves-effect waves-light">Speichern</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="responsive-modal-delete-shift" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left">Schicht Löschen</h3>
                        ...
                        <form>
                            <div class="form-group">
                                <select class="form-control" id="delete_shift_select" onchange="hide_show_until_date_delete();">
                                    <option value="1">Nur diese Schicht löschen</option>
                                    <option value="2">Löschen Sie alle Schichten an den folgenden gleichen Wochentagen</option>
                                    <option value="3">Alle Schichten bis zu einem bestimmten Datum löschen</option>
                                </select>
                            </div>
                            <div class="form-group" id="delete_shift_date_form" style="display:none;">
                                <label for="message-text" class="control-label ml-1"><b>Löschen bis</b></label>
                                <input type="date" class="form-control" id="delete_shift_date" />
                            </div>
                            <div class="form-group">
                                <select class="form-control" id="delete_shift_select_apply_users">
                                    <option value="1">Nur ausgewählten User</option>
                                    <option value="2">Alle User</option>
                                </select>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal_delete_shift();" data-dismiss="modal">Zurück</button>
                        <button onclick="delete_schedule();" type="button" class="btn btn-danger waves-effect waves-light">Löschen</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="page-wrapper">
                    ...
                    <div class="container-fluid pb-0 mobile-container-padding">
                        ...
                        <div class="row page-titles heading_style">
                            ...
                            <div class="col-lg-1 align-self-center text-right">
                                <button onclick="backwardDate();" class="btn w-100 btn-info d-lg-block "><i class="ti-angle-double-left"></i> Rückwärts</button>
                            </div>
                            ...
                            <div class="col-lg-1 align-self-center text-right mtm-10">
                                <button onclick="forwardDate();" class="btn w-100 btn-info d-lg-block ">Nach vorne <i class="ti-angle-double-right"></i></button>
                            </div>
                            <div class="col-lg-1 align-self-center text-right mtm-10">
                                <button onclick="todayDate();" class="btn w-100 btn-secondary d-lg-block ">Heute</button>
                            </div>

                            <div class="col-lg-3 align-self-center text-right mtm-10 mobile_text_center">
                                <span id="all_filter" onclick="show_schedule_filter('all');" class="ml-3 mr-3 <?php if($view_filter_selected == "all" || $view_filter_selected == ""){ echo 'active_filter_schedule'; }else{echo '';} ?> cursor-pointer"><b>Alle</b></span>
                                <span id="upcomming_filter" onclick="show_schedule_filter('upcomming');" class="ml-3 mr-3 <?php if($view_filter_selected == "upcomming"){ echo 'active_filter_schedule'; }else{echo '';} ?> cursor-pointer"><b>Bevorstehende</b></span>
                                <span id="done_filter" onclick="show_schedule_filter('done');" class="ml-3 mr-3 <?php if($view_filter_selected == "done"){ echo 'active_filter_schedule'; }else{echo '';} ?> cursor-pointer"><b>Erledigt</b></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="selectpicker" onchange="get_selected_val();" id="depart_select" multiple data-style="form-control btn-secondary mt-1">
                                ...
                                if ($result && $result->num_rows > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                ?>
                                <option value="<?php echo $row[0]; ?>" <?php if(in_array($row[0], $view_departments_array)){echo 'selected';} ?>><?php if($row[3] != ""){ echo $row[3]; }else if($row[1] != ""){ echo $row[1]; }else{ echo $row[2]; } ?></option>
                                <?php
                                    }
                                }
                                ?>
                        ...
                        <div class="col-lg-10 align-self-center mobile_text_left mtm-10 text-right">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu animated lightSpeedIn">
                                    <a class="dropdown-item" href="javascript:void()" onclick="print_schedule();"><i class="fas fa-print"></i> Drucken</a>
                                    <a class="dropdown-item" href="schedule_settings.php"><i class="mdi mdi-settings"></i> Einstellungen</a>
                                    <a class="dropdown-item" href="pre_defined_shifts.php"><i class="fas fa-calendar-check"></i> Schichtvorlagen</a>
                                </div>
                            </div>
                            ...
                            <button type="button" onclick="notify_changes('<?php echo $s_date; ?>','<?php echo $e_date; ?>');" id="publish_changes_btn" class="mlm-04 schedule_buttons_font_ btn btn-success ml-3"><i class="far fa-paper-plane"></i> Veröffentlichen</button>

                            <button type="button" class="mlm-04 schedule_buttons_font_ btn btn-secondary ml-3 right-side-toggle">Schichtvorlagen</button>
                ...
                <div class="col-lg-12 mt-3 mb-4">
                    ...
                    <table id="schedule-week-view">
                            ...
                            <tr>
                                ...
                                <th class="days_w">
                                    ...
                                    if($view_departments == ""){
                                        ...
                                        if($view_filter_selected == "" || $view_filter_selected == "all"){
                                            $inner_sql2 = "SELECT * FROM `tbl_shifts` WHERE `date` = '$array_week_dates[2]' AND is_active = 1 AND is_delete = 0 AND hotel_id = $hotel_id";  
                                        }else if($view_filter_selected == "upcomming"){
                                            $inner_sql2 = "SELECT * FROM `tbl_shifts` WHERE `date` = '$array_week_dates[2]' AND is_active = 1 AND is_delete = 0 AND hotel_id = $hotel_id AND is_completed = 0";  
                                        }else if($view_filter_selected == "done"){
                                            $inner_sql2 = "SELECT * FROM `tbl_shifts` WHERE `date` = '$array_week_dates[2]' AND is_active = 1 AND is_delete = 0 AND hotel_id = $hotel_id  AND is_completed = 1";  
                                        }

                                    }else{

                                        if($view_filter_selected == "" || $view_filter_selected == "all"){
                                            $inner_sql2 = "SELECT a.* FROM `tbl_shifts`as a INNER JOIN tbl_user as b on a.assign_to = b.user_id WHERE a.`date` = '$array_week_dates[2]' AND a.is_active = 1 AND a.is_delete = 0 AND a.hotel_id = $hotel_id AND b.depart_id IN ($view_departments)";
                                        }else if($view_filter_selected == "upcomming"){
                                            $inner_sql2 = "SELECT a.* FROM `tbl_shifts`as a INNER JOIN tbl_user as b on a.assign_to = b.user_id WHERE a.`date` = '$array_week_dates[2]' AND a.is_active = 1 AND a.is_delete = 0 AND a.hotel_id = $hotel_id AND b.depart_id IN ($view_departments) AND a.is_completed = 0"; 
                                        }else if($view_filter_selected == "done"){
                                            $inner_sql2 = "SELECT a.* FROM `tbl_shifts`as a INNER JOIN tbl_user as b on a.assign_to = b.user_id WHERE a.`date` = '$array_week_dates[2]' AND a.is_active = 1 AND a.is_delete = 0 AND a.hotel_id = $hotel_id AND b.depart_id IN ($view_departments) AND a.is_completed = 1"; 
                                        }
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="empty_w padding-event-8"><a href="#">Veranstaltungen</a></td>
                            ...
                            <tr>
                                <td colspan="8" class="depart_w">
                                    <h6 class="mb-0"><?php  if($row['department_name_de'] != ""){
                            ...
                            <tr>
                                ...
                                ?>
                                <h5 class="font-0-8 text-success"><b>Voller Urlaub</b></h5>
                                <?php
                                            }else{
                                ?>
                                <span <?php if($d1 != 1){ ?> class="cursor-pointer insert_schedule_symbol_leave" onclick="insert_schedule('<?php echo $full_name; ?>','<?php echo $row['user_id']; ?>','<?php echo $array_week_dates[0]; ?>','<?php echo date('D', strtotime($array_week_dates[0])); ?>');" <?php } ?> >
                                    <h5 class="font-0-8 text-success"><b>Teilurlaub</b></h5>
                                    <?php
                                                if($view_filter_selected == "" || $view_filter_selected == "all"){
                                    ...
                                    <div class="text-left background-shadow-div <?php if($row_inner['is_completed'] == 1){echo 'bg-completed';} ?>">
                                        ...
                                        <h4 style="display:flex;justify-content: space-between;font-size: 0.8rem;" class="mb-0"><b><?php echo $row_inner['start_time'] . ' - ' . $row_inner['end_time']; ?></b> 
                                            <span class="custom_design_label_persons font-0-7">
                                                <?php 
                                ...
                                ?>
                                <h5 class="font-0-8 text-danger"><b><?php if($row_leave_day['category'] == "PAID"){echo "Urlaub Voll";}elseif($row_leave_day['category'] == "UNPAID"){echo "Unbezahlter Urlaub Voll";}elseif($row_leave_day['category'] == "PAID_SICK"){echo "Krankheit Voll";} ?></b></h5>
                                <?php
                                                }else{
                                ?>
                                <span <?php if($d1 != 1){ ?> class="cursor-pointer insert_schedule_symbol_leave" onclick="insert_schedule('<?php echo $full_name; ?>','<?php echo $row['user_id']; ?>','<?php echo $array_week_dates[0]; ?>','<?php echo date('D', strtotime($array_week_dates[0])); ?>');" <?php } ?> >
                                    <h5 class="font-0-8 text-danger"><b><?php if($row_leave_day['category'] == "PAID"){echo "Urlaub Teilweise";}elseif($row_leave_day['category'] == "UNPAID"){echo "Unbezahlter Urlaub Teilweise";}elseif($row_leave_day['category'] == "PAID_SICK"){echo "Krankheit Teilweise";} ?></b></h5>
                                    <?php
                                                    if($view_filter_selected == "" || $view_filter_selected == "all"){
                                                        $inner_sql = "SELECT * FROM `tbl_shifts` WHERE `assign_to` = $userid_inner AND `date` = '$array_week_dates[0]' AND is_active = 1 AND is_delete = 0 AND hotel_id = $hotel_id ORDER BY start_time ASC";
                                                    }else if($view_filter_selected == "upcomming"){
                ...
                <div class="right-sidebar">
                    <div class="slimscrollright">
                        <div class="rpanel-title"> <b>Schichtvorlagen</b> <span><i class="ti-close right-side-toggle"></i></span> </div>
        ...
        <script>
            ...
            function save_shift(){
                ...
                if(user_id == "" || from_time == "" || to_time == "" || hourDiff == "" || selected_dates_array.length === 0){
                    alert("Wählen Sie Alle Felder außer Schichtnotizen aus.");
                }else{
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            if(response == "1"){
                                ...
                                alert("Schichten nicht gespeichert.");
                            }
                        },
                        error: function(xhr, status, error) {
                            console.log(error);
            ...
            function save_event(){
                ...
                if(from_time == "" || to_time == "" || hourDiff == "" || title == "" || selected_dates_array_event.length === 0){
                    alert("Wählen Sie Alle Felder aus.");
                }else{
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            if(response == "1"){
                                ...
                                alert("Ereignis nicht gespeichert.");
                            }
                        },
                        error: function(xhr, status, error) {
                            console.log(error);
            ...
            function notify_changes(s1,s2){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        if(response == "1"){
                            Swal.fire({
                                title: 'Schichtänderungen Benutzer benachrichtigen.',
                                type: 'success',
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: 'Ok'
                            }).then((result) => {
                            ...
                            alert("Bereits mitgeteilte Änderungen.");
                        }
                    },
                    error: function(xhr, status, error) {
                        console.log(error);
                ...
                if(copied_pre_id != 0){
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                Swal.fire({
                                    title: 'Schichtvorlagen Eingefügt!',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Ok'
                                }).then((result) => {
            ...
            function copy_pre_shift(id_pre){
                ...
                var x = document.getElementById("snackbar");
                x.className = "show";
                x.innerHTML="Schichtvorlagen Kopiert.";
                setTimeout(function(){ x.className = x.className.replace("show", ""); }, 1000);
            }
