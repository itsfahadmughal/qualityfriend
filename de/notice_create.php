    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Notiz erstellen</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Notiz erstellen</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Notizen</a></li>
                                    <li class="breadcrumb-item text-success">Notiz erstellen</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                            ...
                                            <div class="row mm-0">
                                                    ...
                                                    <div class="row div-background p-4">
                                                        ...
                                                        <div class="col-lg-3 col-xlg-3 col-md-3 pr-0 pt-2"> 
                                                            <div class="checkbox checkbox-success m-b-10">
                                                                ...
                                                                <label class="font-weight-title pl-1">Alle Empfänger</label>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-12 col-xlg-12 col-md-12 p-0">
                                                    ...
                                                    <div class="div-background p-4">
                                                        ...
                                                        <div class="tags-default" >
                                                            <textarea type="text" rows="6" name="comments" id="comments" class="form-control" placeholder="Schreiben Sie Ihre Kommentare..." ></textarea> 
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                            <input type="button" id="create_job_id" onclick="save_notice('CREATE');" class="btn mt-4 w-20 btn-secondary" value="Erstelle">
                                            <input type="button" id="saveasdraft_job_id" onclick="save_notice('DRAFT');"  class="btn mt-4 wm-45 w-25 ml-3  btn-outline-info" value="Als Entwurf speichern">
                                            <input type="button"id="template_save_id" onclick="save_notice('TEMPLATE');" class="btn mt-4 wm-45 ml-3 w-25 btn-outline-info btn-template" value="Als Vorlage speichern">
                                            <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 ml-3 w-20 wm-38 btn-outline-info btn-delete" value="Löschen Vorlage">
                                        </div>
        ...
        <script>
            ...
            function save_notice(create_as){
                ...
                //                console.log("Data : ",dep_array_id,save_as,language_,title_,description_,comments_,tag_,recipents_);
                if(title_.trim() != ""){

                    $.ajax({
                        url:'util_handover_notice_repair_create.php',
                        method:'POST',
                        data:{ module_name_:'notice',language_:language_,title_:title_,tag_:tag_,description_:description_,dep_array_id:dep_array_id,save_as:save_as,comment_:comments_,recipents_:recipents_,visibility_status_:visibility_status_},
                        success:function(response){
                            console.log(response);
                            if(response == "1"){
                                Swal.fire({
                                    title: 'Hinweis erstellt',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'In Ordnung'
                                }).then((result) => {
                                ...
                                Swal.fire({
                                    title: 'Hinweis vorlage erstellt',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'In Ordnung'
                                }).then((result) => {
                                    if (result.value) {
                                        location.replace("notice_create.php");
                                    }
                                });
                            }else{
                                Swal.fire({
