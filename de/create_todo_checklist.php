...
<html lang="en">
    ...
    <head>
        ...
        <title>Todo/Checklist erstellen</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Todo/Checklist erstellen</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Todo/Checklist erstellen</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Todo/Checklisten</a></li>
                                    <li class="breadcrumb-item text-success">Todo/Checklist erstellen</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="modal-body">
                                        <from id ="reset1">
                                            ...
                                            <div class="row pt-2">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea  type="text" rows="13" name="output_deepl" id="output_deepl" class="form-control" placeholder="Ausgabe" ></textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Checkliste hinzufügen</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                ...
                                <div id="add-inspection-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <!--                                                    Add Template Category-->
                                                <h4 class="modal-title" id="myModalLabel">Inspektion hinzufügen</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                ...
                                <div id="add-comments-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <!--                                                    Add Template Category-->
                                                <h4 class="modal-title" id="myModalLabel">Kommentar Hinzufugen</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    <div class="row pt-4">
                                        <div class="col-lg-3 col-xlg-3 col-md-3"> 
                                            <input type="text" id="title_id" class="form-control" placeholder="Titel eingeben">
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-xlg-3 col-md-3 mtm-10"> 
                                            <select id="language_id" disabled class="select2 form-control custom-select">
                                                ...
                                                <option value="3" selected>German</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-3 col-xlg-3 col-md-3 mtm-10"> 
                                    ...
                                    <div class="row pt-4">
                                        ...
                                        <div class="col-lg-3 col-xlg-3 col-md-3"> 
                                            <div class="checkbox checkbox-success">
                                                ...
                                                <input  checked id="active_id" type="checkbox" class="checkbox-size-20">
                                    ...
                                    <div class ="row" >
                                        <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                            ...
                                            <div class="custom-control custom-radio inline-div b-cancle mr-3">
                                                <input  type="radio" value="NON_PUBLIC" id="not_public" name="select_one" class="custom-control-input btn-info" checked>
                                                <label class="custom-control-label" for="not_public">   nicht öffentlich</label>
                                            </div>
                                    ...
                                    <div class ="row" >
                                        <div class="col-lg-12 col-xlg-12 col-md-12"> 
                                            <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                ...
                                                <label class="custom-control-label" for="one_recipient">
                                                    Ein Empfänger</label>
                                            </div>
                                            <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                    ...
                                    <div class="row div-daily">
                                        ...
                                        <div class="col-lg-3 col-xlg-3 col-md-3">
                                            <select  id="duration" class="select2 form-control custom-select">
                                                ...
                                                <option selected value="2">WÖCHENTLICH</option>
                                                <option value="3">MONATLICH</option>
                                                <option value="4">VIERTELJÄHRLICH</option>
                                                <option value="5">HALBJÄHRLICH</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12  text-right">
                                            ...
                                            <button data-toggle="modal" data-target="#add-tour-contact" type="button" class="btn mt-4 btn-secondary"><i class=" fas fa-share-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Tour hinzufügen</button>
                                            <button data-toggle="modal" data-target="#add-inspection-contact" type="button" class="btn mt-4 btn-secondary"><i class="fa fa-check"></i>&nbsp;&nbsp;&nbsp;&nbsp;Inspektion hinzufügen</button>
                                        </div>
                                    </div> 
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 text-right">
                                            <button data-toggle="modal" data-target="#add-comments-contact"  type="button" class="btn mt-4 btn-info"><i class="mdi mdi-plus-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;Kommentar hinzufügen</button>
                                            <button onclick="save_todolist('DRAFT')" type="button" class="btn mt-4 btn-success">Als Entwurf speichern</button>
                                            <button type="button" onclick="d()" class="btn mt-4 btn-delete btn-danger">Vorlage löschen</button>
                                            <button onclick="save_todolist('TEMPLATE')" type="button" class="btn mt-4 btn-warning btn-template">Als Vorlage speichern</button>
                                            <button onclick="cancel()" type="button" class="btn mt-4 btn-danger">Löschen</button>
                                            <button type="button" onclick="save_todolist('CREATE')" class="btn mt-4 btn-secondary">Erstellen</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
