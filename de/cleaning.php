                ...
                <div class="container-fluid" id="mcontainer">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Tagespläne</h4>
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Tagespläne</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Datum zuweisen</h4>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="extrajob_add()" data-dismiss="modal">Speichern</button>
                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Stornieren</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
                        ...
                        <div  id="permanently_div" class="col-lg-12  col-md-12  display_none">
                            <div class="row div-white-background p-3 mb-3" >
                                <div  id="" class="col-lg-4  col-md-4  pt-2">
                                    <h4>Möchten Sie der Reinigungskraft dauerhaft einen Raum zuweisen??</h4>
                                </div>
                                <div id="" class="col-lg-3  col-md-3  pt-2">
                                    <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                        ...
                                        <label class="custom-control-label" for="yes">Ja.</label>
                                    </div>
                                    <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                        <input value="One_Day" type="radio"  id="for_toay" name="permanently" class="custom-control-input btn-info"  >
                                        <label class="custom-control-label" for="for_toay">Nur für heute</label>
                                    </div>
                                </div>
                        ...
                        <div  id="rooms_and_extra_job" class="col-lg-6  col-md-6 pl-4 mtm-10 plm-10px">
                                    ...
                                    <div class="row">
                                        <div  id="" class="col-lg-4  col-md-4 wm-50">
                                            <div class="row">
                                                ...
                                                <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                    <small>Dieser Reinigungskraft zugewiesen</small>
                                                </div>
                                            </div>
                                        ...
                                        <div  id="" class="col-lg-4  col-md-4 wm-50">
                                            <div class="row">
                                                ...
                                                <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                    <small>Anderer Reinigungskraft zugewiesen</small>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div  id="" class="col-lg-8  col-md-8">
                                            <div class="row div-white-background pointer room_text_center pt-2 pb-2 ml-1 mr-1 mt-2">
                                                <div  class="col-lg-12">
                                                    <span><b>Etage <?php echo $unique_floor_number[$x]; ?></b></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div  id="" class="col-lg-2  col-md-2">
                            ...
                            <div class="row div-background pt-3 pb-4 mt-3" >
                                <div  id="job_list" class="col-lg-12  col-md-12">
                                    <h3>Zusatzaufgaben der Reinigungskraft zuweisen</h3>
                                </div>
