    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Handbuchdetail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Handbuch Detail</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Handbücher</a></li>
                                    <li class="breadcrumb-item text-success">Handbuch Detail</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            for ($x = 0; $x < sizeof($dep_array); $x++) {
                                                ...
                                                <h4 class="text-show"><?php    for ($x = 0; $x < sizeof($attach_url_array); $x++) { ?>
                                                    <a data-toggle="tooltip" data-original-title="
                                                                                                  Klicken Sie hier, um den Anhang anzuzeigen" href="<?php echo $attach_url_array[$x]; ?>" target="_blank"><?php if($x!=sizeof($attach_url_array)-1){echo "Anhang-".($x+1).", ";}else{echo "Anhang-".($x+1) ;} ?> </a> <?php } ?></h4>
                                                <?php
                                                                                         }
                                                ?>
                                            </div>
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                        <?php if($is_active == 1){ ?>
                                        <button  onclick="changeStatus('0')" type="button" class="btn mt-4 btn-secondary">Als inaktiviert markieren</button>
                                        <?php } else {?>
                                        <button onclick="changeStatus('1')" type="button" class="btn mt-4 btn-secondary">Als aktiv markieren</button>
                                        <?php }?>
                                    </div>
                                    <?php } ?>
                                </div>
