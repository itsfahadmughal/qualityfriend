    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Notizen</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Notizen</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Erstellte Notizen</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pr-4 mobile-container-padding">
                        ...
                        ?>
                        <div class="col-lg-12-custom pr-0">
                            <div  class="list-background-active icon text-center padding-top-8" onclick="redirect_url('notices.php');">
                    ...
                    <div class="row pl-3 pr-3">
                        ...
                        <div class="col-lg-2 wm-48 col-md-3 mt-2 mb-3">
                            <?php if($Create_edit_notices == 1 || $usert_id == 1){ ?>
                            <a href="notice_create.php" class="btn  w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Notiz erstellen</a>
                            <?php } ?>
                        </div>
                        ...
                        if($Create_edit_notices == 1 || $usert_id == 1){
                            $sql="SELECT * FROM `tbl_note` WHERE `is_delete` = 0 AND `hotel_id` = $hotel_id AND saved_status = 'CREATE' ORDER BY 1 DESC";
                        } else{
                        ...
                        <div class="col-12">
                                        ...
                                        <table id="myTable" class="tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="stack"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border text-center"><b> Autor</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border text-center"><b> Beteiligt</b></th>
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                $sql_sub="select firstname from tbl_user where user_id = $row[16]";
                                $result_sub = $conn->query($sql_sub);
                                $row_sub = mysqli_fetch_array($result_sub);

                                $sql_sub1="select b.department_name from tbl_note_departments as a INNER JOIN tbl_department as b on a.depart_id=b.depart_id where a.nte_id = $row[0] Limit 1";
                                $result_sub1 = $conn->query($sql_sub1);


                                $sql_sub2="select b.firstname from tbl_note_recipents as a INNER JOIN tbl_user as b on a.user_id=b.user_id where a.nte_id = $row[0] Limit 2";
                                ...
                                if($row['title_de'] != ""){
                                    ...
                                    $title = "";
                                                ...
                                                ?>
                                                <tr>    
                                                    <td class="text-center"><b><?php echo $title; ?></b><br><div class="label pl-4 pr-4 label-table btn-info cursor-pointer" onclick="redirect_url('notice_detail.php?id=<?php echo $row[0]; ?>');">Notiz</div></td>
                                ...
                                if($result_sub2 && $result_sub2->num_rows > 0){
                                    while($row_sub2 = mysqli_fetch_array($result_sub2)) {
                                                    ...
                                                    <td class="text-center"><div class="label p-2 label-table label-success">Notiz <?php echo $row['saved_status']; ?></div></td>
                                                    <?php if($Create_edit_notices == 1 || $usert_id == 1){ ?>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="delete_notice('<?php echo $row[0]; ?>');">Löschen</a>
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="duplicate_notice('<?php echo $row[0]; ?>');">Duplikat</a>
                                                                <a class="dropdown-item" href="notice_detail.php?id=<?php echo $row[0]; ?>">Aussicht</a>
                                                                <a class="dropdown-item" href="notices_edit.php?id=<?php echo $row[0]; ?>">Bearbeiten</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <?php } ?>
                                                    <td class="text-center"><b><?php echo date("d.m.Y", strtotime(substr($row[15],0,10))); ?></b><br><span class="label-light-gray"><?php echo substr($row[15],10); ?></span></td>
                                                </tr>
                                                <?php
                            }
                                                ?>
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                            <h1 class="text-center pt-5 pb-5">Keine Notizen gefunden</h1>
                        </div>
                        <?php
                        }
                        ?>
