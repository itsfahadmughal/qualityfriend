...
SELECT '$date', '$assign_to', `title`, `title_it`, `title_de`, `start_time`, `end_time`, `total_hours`, 0, 0, 1, 0, `hotel_id`, '$entry_time', '$entryby_id', '$entryby_ip', '$last_edit_time', '$last_editby_id', '$last_editby_ip', `shift_break` FROM tbl_shifts_pre_defined
WHERE sfspd_id='$shift_id' and hotel_id = $hotel_id";
...
if($result){
    ...
    $alert_msg = "Neue Schicht erstellt";
    ...
    echo '1';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','Neue Schicht erstellt','$hotel_id','$entry_time')";
