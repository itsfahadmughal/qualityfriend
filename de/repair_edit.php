...
<html lang="en">
    ...
    <head>
        ...
        <title>Reparatur bearbeiten</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Reparatur bearbeiten</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Reparatur bearbeiten</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Reparaturen</a></li>
                                    <li class="breadcrumb-item text-success">Reparatur bearbeiten</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div>
                                            ...
                                            <div class="col-lg-6 col-xlg-6 col-md-6">
                                                ...
                                                <div class="row pl-2 pr-2">
                                                    <select id="template" class="select2 form-control custom-select">
                                                        <option value="0">Reparatur Vorlage auswählen</option>
                                                        <?php 
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                                            <div>
                                                                <div class="div-background   p-4">
                                                                    <h4 class="font-weight-title">Reparatur</h4>
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                        <input type="button" id="create_job_id" onclick="save_repair('CREATE');" class="btn mt-4 wm-48 mw-25 w-20 btn-secondary" value="Änderungen speichern">

                                        <input type="button" id="saveastemplate_job_id" onclick="delete_repair('<?php echo $rpr_id; ?>');"  class="btn mt-4 mw-25 w-10 ml-1 wm-30 btn-warning" value="Löschen">

                                        <input type="button"id="template_save_id" onclick="save_repair('TEMPLATE');" class="btn mt-4 ml-1 mw-25 w-20 btn-info btn-template wm-45" value="Als Vorlage speichern">
                                        <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 wm-43 ml-1 mw-25 w-20 btn-info btn-delete" value="Vordefiniert löschen">

                                        <input type="button" id="saveastemplate_job_id" onclick="save_repair('CREATE');"  class="btn wm-80 mt-4 mw-40 w-30 ml-1  btn-danger" value="Als nicht erledigte Reparatur speichern">

                                        <input type="button" id="saveastemplate_job_id" onclick="save_repair('COMPLETED');"  class="btn wm-45 mt-4 mw-25 w-15 ml-1  btn-success" value="Reparatur erledigt">
