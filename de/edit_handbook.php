...
<html lang="en">
    <head>
        ...
        <title>Handbuch bearbeiten</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Handbuch bearbeiten</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Handbuch bearbeiten</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Handbücher</a></li>
                                    <li class="breadcrumb-item text-success">Handbuch bearbeiten</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                            ...
                                            <div class="col-lg-6 col-xlg-6 col-md-6 ">
                                                ...
                                                <div class="div-background mt-4   p-4">
                                                    ...
                                                    <div id="delete_<?php echo $attach_id_array[$i]; ?>">
                                                        <a data-toggle="tooltip" data-original-title="Klicken Sie hier, um den Anhang anzuzeigen" href="<?php echo $attach_url_array[$i]; ?>" target="_blank"><?php echo 'Anhang-'.($i+1); ?></a><a style="color:#f62d51;" data-toggle="tooltip" data-original-title="
                                                            Anhang entfernen" href="javascript:void(0);" onclick="delete_attachment(<?php echo $attach_id_array[$i]; ?>,<?php echo $hdb_id; ?>);"> Entfernen</a>
                                                    </div>
                                                    <?php } ?>
                                                </div>
                                                        ...
                                                        <div class="row div-background p-4">
                                                            <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                                <label class="control-label"><strong>
                                                                    Abteilung zuweisen</strong></label>
                                                                <div  class="row pl-2 pr-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-xlg-12 col-md-12 ">
                                                            <div>
                                                                ...
                                                                <div class="div-background   p-4">
                                                                    <h4 class="font-weight-title">Titel</h4>
                                                                    <input type="text" id="title_id_en" class="form-control" placeholder="Titel Eingeben" value ="<?php echo $title; ?>">
                                                                    <div class="row">
                                                                        <div class="col-lg-10 wm-70 col-xlg-10 col-md-10">
                                                                            <h4 class="font-weight-title pt-4">Beschreibung</h4>
                                                                        </div> 
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                        <input type="button" id="" onclick="save_handbook('CREATE');" class="btn mt-4 w-25 wm-48 btn-secondary" value="Änderungen speichern">
                                        <input type="button" id="" onclick="save_handbook('DRAFT');"  class="btn mt-4 w-25 ml-1 wm-45  btn-outline-info" value="Als Entwurf speichern">
                                        <input type="button" id="" onclick="d(<?php echo $hdb_id; ?>)"  class="btn mt-4 w-10 ml-1 wm-30  btn-outline-info" value="Löschen">
                                        <input type="button" id="" onclick="duplicate(<?php echo $hdb_id; ?>)"   class="btn mt-4 wm-30 w-10 ml-1  btn-outline-info" value="Duplikat">

                                        <input type="button" id="" onclick="save_handbook('TEMPLATE');" class="btn mt-4 ml-1 w-25 wm-45 btn-outline-info btn-template" value="Als Vorlage speichern">

                                        <input type="button" id="" onclick="delete_template()"  class="btn mt-4 ml-1 w-25 wm-43 btn-outline-info btn-delete" value="Vorlage löschen">
                                    </div>
