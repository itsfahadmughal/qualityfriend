...
if($result){
    echo 'success';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','Der Zeitplanadministrator hat die Sichtbarkeitseinstellungen der Umschalttasten geändert','$hotel_id','$last_edit_time')";
