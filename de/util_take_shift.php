...
if($slug == 3){
    ...
    $alert_msg = $msg." Die Schicht, die der Arbeiter übernommen hat, nehmen Sie trotzdem zurück.";
    ...
    $alert_msg = $msg." Vom Administrator Ihnen zugewiesene Schicht.";
    $alert_msg2 = $msg." Ihre Schicht wurde vom Administrator einem neuen Mitarbeiter zugewiesen.";
