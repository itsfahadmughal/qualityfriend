...
<html lang="en">
    <head>
        ...
        <title>Abgeschlossene Zusatzaufgaben</title>
        <!-- Footable CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Abgeschlossene Zusatzaufgaben</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">
                                Abgeschlossene Zusatzaufgaben</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Abgeschlossene Zusatzaufgaben</li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="row pl-3 pr-3">
                    ...
                    <div class="col-12">
                            ...
                            <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                <div class="table-responsive">
                                    <table id="myTable" class=" tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="stack"
                                        ...
                                        <thead>
                                            <tr>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist" class="border text-center"><b>Nebenjob</b></th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col
                                                    data-tablesaw-priority="3" class="border text-center"><b> Abgeschlossener Benutzer</b></th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border text-center"><b>status</b></th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border text-center"><b>Zeit </b></th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border text-center"><b>Datum zuweisen</b></th>
                                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="5" class="border text-center"><b>Abschlussdatum</b></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                        while($row = mysqli_fetch_array($result)) {
                            ...
                            $row_sub = mysqli_fetch_array($result_sub);
                                            ...
                                            ?>
                                            <tr>    
                                                <td class="text-center"><b><?php echo $job_title; ?></b><br><div class="label pl-4 pr-4 label-table btn-info cursor-pointer" onclick="redirect_url('handover_detail.php?id=<?php echo $row[0]; ?>');">Haushaltsführung</div></td>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                        <h1 class="text-center pt-5 pb-5">Keine Zusatzaufgaben gefunden</h1>
                    </div>
                    <?php
                    }
                    ?>
