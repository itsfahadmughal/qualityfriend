...
if($result){
    ...
    $last_id = $id;
    $alert_msg = $title." Veranstaltung aktualisiert.";
    ...
    echo '1';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','$title Veranstaltung aktualisiert','$hotel_id','$last_edit_time')";
