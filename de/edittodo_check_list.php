...
<html lang="en">
    ...
    <head>
        ...
        <title>Aufgaben/Checkliste bearbeiten</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Aufgaben-/Checkliste bearbeiten</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Aufgaben/Checkliste bearbeiten</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Todo/Checklisten</a></li>
                                    <li class="breadcrumb-item text-success">Aufgaben/Checkliste bearbeiten</li>
                                </ol>
                            </div>
                        </div>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="myModalLabel">
                                                        Checkliste hinzufügen</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="row pl-3 pt-4 mm-0 plm-0">
                                                    <div class="col-lg-10 col-xlg-10 col-md-10">
                                                        <input type="text" class="form-control" id="add_check_list_item" placeholder="Text eingeben"> 
                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <!--                                                    <button type="button" onclick="check_list_saved()" class="btn btn-info waves-effect"   data-dismiss="modal">Speichern</button>-->
                                    ...
                                    <div id="add-tour-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <!--                                                    Add Template Category-->
                                                    <h4 class="modal-title" id="myModalLabel">Tour hinzufügen</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="row pl-3 pt-4 mm-0 plm-0">
                                                    <div class="col-lg-10 col-xlg-10 col-md-10">
                                                        <input type="text" class="form-control" id="add_tour_list_item" placeholder="Text eingeben"> 
                                                    </div>
                                                    <div class ="col-lg-2 col-xlg-2 col-md-2 font-size-title"style="text-align: center; display: flex; justify-content: center;align-items: center;" >
                                                ...
                                                <div class="modal-footer">
                                                    <!--                                                    <button type="button" onclick="tour_list_saved()" class="btn btn-info waves-effect"   data-dismiss="modal">Speichern</button>-->
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Abbrechen</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <!--                                                    Add Template Category-->
                                                    <h4 class="modal-title" id="myModalLabel">
                                                        Inspektion hinzufügen</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="row pl-3 pt-4 mm-0 plm-0">
                                                    <div class="col-lg-10 col-xlg-10 col-md-10">
                                                        <input type="text" class="form-control" id="add_inpection_list_item" placeholder="Text Eingeben"> 
                                                    </div>
                                                    <div class ="col-lg-2 col-xlg-2 col-md-2 font-size-title"style="text-align: center; display: flex; justify-content: center;align-items: center;" >
                                    ...
                                    <div id="add-comments-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <!--                                                    Add Template Category-->
                                                    <h4 class="modal-title" id="myModalLabel"> Kommentare hinzufugen</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div id="refrash3" class="modal-body">
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="row">
                                                            <div class="col-lg-10 col-xlg-10 col-md-10">
                                                                <input type="text" class="form-control" id="add_comments_list_item" placeholder="Text eingeben"> 
                                                            </div>
                                                            <div class ="col-lg-2 col-xlg-2 col-md-2 font-size-title"style="text-align: center; display: flex; justify-content: center;align-items: center;" >
                                                ...
                                                <div class="modal-footer">
                                                    <!--                                                    <button type="button" class="btn btn-info waves-effect"   data-dismiss="modal">Speichern</button>-->
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Loschen</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
                                    ...
                                    <div class="tab-pane active" id="english" role="tabpanel">
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-lg-8 col-xlg-8 col-md-8"> 
                                                <input type="text"; value="<?php  echo $title_de ?>" id="title_id_de" class="form-control" placeholder="Titel eingeben">
                                            </div>
    ...
    $sql="SELECT * FROM `tbl_todolist` WHERE `hotel_id` = $hotel_id and is_delete = 0 and saved_status = 'TEMPLATE'";
                                        ...
                                        <div class="row pt-4">
                                            ...
                                            <div class="col-lg-3 col-xlg-3 col-md-3"> 
                                                <div class="checkbox checkbox-success">
                                                    ...
                                                    <label class="font-weight-title pl-2 mb-1">Aktiv</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class ="row" >
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                ...
                                                <div class="custom-control custom-radio inline-div b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="not_public">
                                                        nicht öffentlich</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div b-cancle">
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <h4 class="font-weight-title">Empfänger wählen</h4>
                                            </div>
                                        </div>
                                        <div class="row ">
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <h4 class="font-weight-title">Zuweisung</h4>
                                            </div>
                                        </div>
                                        <div class ="row" >
                                            <div class="col-lg-12 col-xlg-12 col-md-12"> 
                                                <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="one_recipient">Ein Empfänger</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="all_recipients">Alle Empfänger</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="together">Alle</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pt-4">
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <h4 class="font-weight-title">Fälligkeit</h4>
                                            </div>
                                        </div>
                                        <div class ="row" >
                                            ...
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <div class="custom-control custom-radio inline-div mr-3">
                                                    ...
                                                    <label class="custom-control-label" for="customRadio10">auswählen</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div">
                                                    ...
                                                    <label class="custom-control-label" for="customRadio20">Keine</label>
                                                </div>
                                            </div>  
                                        </div>
                                        <div class="row hided-div  mt-3">
                                            ...
                                            <div class="col-lg-3 col-xlg-3 col-md-3">
                                                <div class="input-group">
                                                    <input type="text" style="border:1px solid #00BCEB" id="start_date_id" class="form-control" placeholder="" value="<?php echo $due_date;?>">
                                        ...
                                        <div class="row   div-daily ">
                                            ...
                                            <div class="col-lg-3 col-xlg-3 col-md-3">
                                                <select  id="duration" class="select2 form-control custom-select">
                                                    <option   value="1" <?php if($repeat_status == 'DAILY'){echo "selected";} ?>>TÄGLICH</option>
                                                    <option   value="2" <?php if($repeat_status == 'WEEKLY'){echo "selected";} ?>>WÖCHENTLICH</option>
                                                    <option   value="3" <?php if($repeat_status == 'MONTHLY'){echo "selected";} ?>>MONATLICH</option>
                                                    <option   value="4" <?php if($repeat_status == 'QUARTERLY'){echo "selected";} ?>>VIERTELJÄHRLICH</option>
                                                    <option  value="5" <?php if($repeat_status == 'HALF_YEARLY'){echo "selected";} ?>>HALBJÄHRLICH</option>
                                                    <option   value="6" <?php if($repeat_status == 'YEARLY'){echo "selected";} ?>>JÄHRLICH</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-3 col-xlg-3 col-md-3 mtm-10">
                                                <div class="input-group">
                                                    <input type="text" style="border:1px solid #00BCEB" id="end_date_id" class="form-control" placeholder="" value="<?php echo $repeat_until; ?>">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text" style="background-color:#00BCEB;border:1px solid #00BCEB" ><i class="icon-calender" style="background-color:white"></i></span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row div-white-background ml-1 mr-1  div-day">
                                            <div class="col-lg-12 col-xlg-12 col-md-12   p-4"> 
                                                ...
                                                <div class="custom-control custom-radio inline-div mr-3">
                                                    ...
                                                    <label class="custom-control-label" for="wednesday">Mittwoch</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div mr-3">
                                                    ...
                                                    <label class="custom-control-label" for="thursday">Donnerstag</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div mr-3">
                                                    <input  type="radio" value="FRIDAY" id="friday" name="days" class="custom-control-input btn-info"  <?php if($day =="FRIDAY"){echo "checked"; } ?>>
                                                    <label class="custom-control-label" for="friday">Freitag</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div mr-3">
                                                    ...
                                                    <label class="custom-control-label" for="saturday">Samstag</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div mr-3">
                                                    <input  type="radio" value="SUNDAY" id="sunday" name="days" class="custom-control-input btn-info" <?php if($day =="SUNDAY"){echo "checked"; } ?>>
                                                    <label class="custom-control-label" for="sunday">Sonntag</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pt-4 ">
                                        ...
                                        <div id="delete_<?php echo $attach_id_array[$i]; ?>">
                                            <a data-toggle="tooltip" data-original-title="
                                                                                          Klicken Sie hier, um den Anhang anzuzeigen" href="<?php echo $attach_url_array[$i]; ?>" target="_blank"><?php echo 'Anhang-'.($i+1); ?></a><a style="color:#f62d51;" data-toggle="tooltip" data-original-title="Entfernen Attachment" href="javascript:void(0);" onclick="delete_attachment(<?php echo $attach_id_array[$i]; 
                                                ?>,<?php echo $tdl_id; ?>);"> Entfernen</a>
                                        </div>
                                        <?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12  text-right">
                                            <button data-toggle="modal" data-target="#add-contact" type="button" class="btn mt-4 btn-secondary"><i class=" ti-menu-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Checkliste hinzufügen</button>
                                            <button data-toggle="modal" data-target="#add-tour-contact" type="button" class="btn mt-4 btn-secondary"><i class=" fas fa-share-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                                                Tour hinzufügen</button>
                                            <button data-toggle="modal" data-target="#add-inspection-contact" type="button" class="btn mt-4 btn-secondary"><i class="fa fa-check"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                                                Inspektionen hinzufügen</button>
                                        </div>
                                    </div> 
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 text-right">
                                            <button data-toggle="modal" data-target="#add-comments-contact"  type="button" class="btn mt-4 btn-info"><i class="mdi mdi-plus-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                                                Kommentar hinzufügen</button>
                                            <button onclick="save_todolist('DRAFT')" type="button" class="btn mt-4 btn-success">
                                                Als Entwurf speichern</button>
                                            <button type="button" onclick="d()" class="btn mt-4 btn-delete btn-danger">
                                                Vorlage löschen</button>
                                            <button onclick="save_todolist('TEMPLATE')" type="button" class="btn mt-4 btn-warning btn-template">
                                                Als Vorlage speichern</button>
                                            <button onclick="cancel()" type="button" class="btn mt-4 btn-danger">Abbrechen</button>
                                            <button type="button" onclick="save_todolist('CREATE')" class="btn mt-4 btn-secondary">Änderungen speichern</button>
                                        </div>
                                    </div>
