                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-9 text-right">
                            <label class="btn btn-dark">
                                ...
                                <label class="mb-0" for="md_checkbox_22">&nbsp;Schichtpool für Benutzer aktivieren</label>
                            </label>
                        </div>
                        <?php } ?>
                    </div>
                            ...
                            <div class="card-body pm-0">
                                <div class="vtabs customvtab">
                                    <ul class="nav nav-tabs tabs-vertical" role="tablist">
                                        <?php  if ($Create_view_schedules == 1 || $usert_id == 1) { ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link active" data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-pool"></i></span> <span class="hidden-xs-down">Shift Pool Anfrage</span> </a> </li>
                                        <?php } ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link <?php  if ($Create_view_schedules == 1 || $usert_id == 1) { }else{echo 'active';}?>" data-toggle="tab" href="#profile3" role="tab"><span class="hidden-sm-up"><i class="fas fa-hand-holding"></i></span> <span class="hidden-xs-down">Shifts anzunehmen</span></a> </li>
                                        <?php  if ($Create_view_schedules == 1 || $usert_id == 1) { ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link" data-toggle="tab" href="#messages3" role="tab"><span class="hidden-sm-up"><i class="fas fa-dollar-sign"></i></span> <span class="hidden-xs-down">Anfrage zum Shifttausch</span></a> </li>
                                        <?php } ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link" data-toggle="tab" href="#mytrade3" role="tab"><span class="hidden-sm-up"><i class="far fa-money-bill-alt"></i></span> <span class="hidden-xs-down">Mein Tausch</span></a> </li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content w-100 pm-1rem">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        while ($row = mysqli_fetch_array($result_up_for)) {
                                                                ...
                                                                <tr class="">
                                                                    ...
                                                                    <td><?php if($row['department_name_de'] != ""){ echo $row['department_name_de']; }else if($row['department_name_it'] != ""){ echo $row['department_name_it'];  }else{ echo $row['department_name']; } ?></td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                                                        <button <?php if($row['is_approved_by_admin'] == 1){ echo 'disabled'; } ?> onclick="take_shift(<?php echo $row['offer_to']; ?>,'admin',<?php echo $row['shift_offered']; ?>,<?php echo $row['sftou_id']; ?>)" class="btn w-100 btn-success d-lg-block "><?php if($row['is_approved_by_admin'] == 1){ echo 'Akzeptiert'; }else{echo 'Akzeptieren';} ?></button>
                                                                    </td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        while ($row = mysqli_fetch_array($result_up_for)) {
                                                                ...
                                                                <tr class="">
                                                                    ...
                                                                    <td><?php if($row['department_name_de'] != ""){ echo $row['department_name_de']; }else if($row['department_name_it'] != ""){ echo $row['department_name_it'];  }else{ echo $row['department_name']; } ?></td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                                                        <button <?php if($row['is_approved_by_employee'] == 1){ echo 'disabled'; } ?> onclick="take_shift(<?php echo $row['offer_to']; ?>,'user',<?php echo $row['shift_offered']; ?>,<?php echo $row['sftou_id']; ?>)" class="btn w-100 btn-secondary d-lg-block "><?php if($row['is_approved_by_admin'] == 1){ echo 'Vom Administrator zugewiesen'; }else if($row['is_approved_by_employee'] == 1){ echo 'Schicht genommen'; }else{echo 'Nehmen Sie Schicht';} ?></button>
                                                                    </td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                        ...
                                        <div class="tab-pane" id="messages3" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 pm-0">
                                                    <h3><b>Anfrage zum Shifttausch</b></h3>
                                                    <?php
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="demo-foo-addrow" class="shift_pool_tables wm-100 table table-bordered m-t-30 table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                                            <thead>
                                                                <tr>
                                                                    <th class="">Angebot von</th>
                                                                    <th class="">Schicht angeboten</th>
                                                                    <th class="">Angeboten</th>
                                                                    <th class="">Angeboten mit</th>
                                                                    <th class="text-center">Aktion</th>
                                                                    <th class="text-center ">Löschen</th>
                                                                </tr>
                                                            </thead>
        ...
        <script>
            ...
            function take_shift(offer_to,slug,shift_id,id){
                ...
                Swal.fire({
                    ...
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: 'Ja, jetzt akzeptieren!',
                    cancelButtonText: 'stornieren!'
                }).then((result) => {
                    if (result.value) {
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if(response == "success"){
                                    ...
                                    Swal.fire({
                                        title: 'Schicht angenommen und zugewiesen.',
                                        type: 'success',
                                        confirmButtonColor: '#3085d6',
                                        confirmButtonText: 'Ok'
                                    }).then((result) => {
                                    ...
                                    Swal.fire({
                                        type: 'warning',
                                        title: 'Hoppla...',
                                        text: 'Schicht bereits abgeschlossen!',
                                        footer: ''
                                    });
                                }else{
                                    Swal.fire({
