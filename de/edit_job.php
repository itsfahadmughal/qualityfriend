...
<html lang="en">
    ...
    <head>
        ...
        <title>Stellenanzeige bearbeiten</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Stellenanzeige bearbeiten</p>
            </div>
        </div>
        <!-- ============================================================== -->
...
<h4 class="text-themecolor font-weight-title font-size-title">Stellenanzeige bearbeiten</h4>
</div>
...
-->
                    ...
                    <div class="row page-titles mb-3 heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Stellenanzeige bearbeiten</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Recruiting</a></li>
                                    <li class="breadcrumb-item text-success">Stellenanzeige bearbeiten</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="myModalLabel"><i class="fas fa-phone"></i> Whatsapp Nr. anlegen</h4>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <div class="col-md-12 m-b-20">
                                                    <h4 class="font-weight-title">Geben Sie Ihre WhatsApp-Nummer ein:</h4>
                                                    <input type="tel" name="phone" id="wp_num_id" value="<?php echo $wp_num; ?>" placeholder="123">
                                                </div>
                                            </div>
                                        </div>
                                    </from>
                                ...
                                <form id="create_job_form" action="dashboard.php">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="english" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    <h4 class="font-weight-title">Job Titel</h4>
                                                    <input id="title_id" type="text" value="<?php echo $title; ?>" class="form-control" placeholder="Geben Sie den Titel ein">
                                                    <div class="row pt-4">
                                                        <div class="col-lg-6 col-xlg-6 col-md-6">
                                                            <h4 class="font-weight-title">Abteilung auswählen*</h4>
                                                        ...
                                                        <div class="col-lg-6 col-xlg-6 col-md-6">
                                                            <h4 class="font-weight-title">Erstellt am</h4>
                                                    ...
                                                    <div class="row pt-4 ">
                                                        <div class="col-lg-10 col-xlg-10 col-md-10">
                                                            <h4 class="font-weight-title ">Stellenbeschreibung</h4>
                                                        </div> 
                                                    ...
                                                    <h4 class="font-weight-title pt-4">Arbeitsort hinzufügen</h4>
                                                    <input id="location_id" type="text" value="<?php echo $location; ?>" class="form-control" placeholder="Location">

                                                      <h4 class="font-weight-title mt-3">Auto message Bewerber</h4>
                                                    <div class="card">
                                                        <div class="card-body p-0">
                                                ...
                                                <div class="col-lg-3 col-xlg-3 col-md-3 pt-4"> 
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="card-title">Bild für Stellenanzeige hinzufügen</h4>
                                                    ...
                                                    <div class="checkbox checkbox-success pl-4">
                                                        ...
                                                        <label for="checkbox35" class="font-weight-title font-22 pl-1">CV erforderlich</label>
                                                    </div>
                                                    ...
                                                    <div class="checkbox checkbox-success pl-4">
                                                        ...
                                                        <label for="checkbox35" style="display:inline;" class="font-weight-title font-22 pl-1"><small>(wenn Du Bewerbungen direkt über Dein Whatsapp-Konto erhalten möchtest)</small></label>
                                                    </div>
                                                    <div class="checkbox checkbox-success pl-4">
                                        ...
                                        <div class="tab-pane" id="italian" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    <h4 class="font-weight-title">Job Titel</h4>
                                                    <input id="title_it_id" type="text" value="<?php echo $title_it; ?>" class="form-control" placeholder="Titel">
                                                    ...
                                                    <h4 class="font-weight-title pt-4">Arbeitsort hinzufügen</h4>
                                                    <input id="location_it_id" type="text" value="<?php echo $location_it; ?>" class="form-control" placeholder="Location">
                                                </div>
                                        ...
                                        <div class="tab-pane" id="german" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    <h4 class="font-weight-title">Job Titel</h4>
                                                    <input id="title_de_id" type="text" value="<?php echo $title_de; ?>" class="form-control" placeholder="Geben Sie den Titel ein">
                                                    ...
                                                    <h4 class="font-weight-title pt-4">Arbeitsort hinzufügen</h4>
                                                    <input id="location_de_id" type="text" value="<?php echo $location_de; ?>" class="form-control" placeholder="Location">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                            <input type="button" onclick="save_job('DRAFT');" class="btn mt-4 w-20 btn-secondary" value="Als Entwurf speichern">
                                            <input type="submit" onclick="save_job('CREATE');" class="btn mt-4 ml-3 w-20 btn-info" value="Änderungen speichern">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function save_job(create_as){
                ...
                if(title_.trim() != "" || title_it_.trim() != "" || title_de_.trim() != ""){
                    if(department_ == 0){
                        Swal.fire({
                            title: 'Abteilung ist erforderlich',
                            type: 'basic',
