...
<html lang="en">
    ...
    <head>
        ...
        <title>Handbuch erstellen</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Handbuch erstellen</p>
            </div>
        </div>
        <!-- ============================================================== -->
...
<h4 class="text-themecolor font-weight-title font-size-title">Handbuch erstellen</h4>
</div>
<div class="col-md-7">    
</div>
<div class="col-md-2">
...
-->
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Handbuch erstellen</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Handbücher</a></li>
                                    <li class="breadcrumb-item text-success">Handbuch erstellen</li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel">Add Template Category</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_name_en_sub_cat" class="form-group ">
                                                                        ...
                                                                        <input onkeyup="error_handle_sub('name')" type="text" class="form-control" id="sub_cat_name"  placeholder="Name eingeben" required> 

                                                                        <small id="error_msg_name_en_sub_cat" class="form-control-feedback display_none">Kategoriename ist erforderlich</small>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-10"  id="refrash1">
                                                                            ...
                                                                            <div id="div_category" class="form-group ">
                                                                                ...
                                                                                <small id="error_msg_category" class="form-control-feedback display_none"> Kategorie ist erforderlich</small> 
                                                                            </div>
                                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_name_it_sub_cat" class="form-group ">
                                                                        <input  onkeyup="error_handle_sub('name')" type="text" class="form-control" id="sub_cat_name_it"  placeholder="Name eingeben">

                                                                        <small id="error_msg_name_it_sub_cat" class="form-control-feedback display_none">
                                                                            Kategoriename ist erforderlich</small>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_name_de_sub_cat" class="form-group ">
                                                                        <input onkeyup="error_handle_sub('name')" type="text" class="form-control" id="sub_cat_name_de" placeholder="Name eingeben"> 

                                                                        <small id="error_msg_name_de_sub_cat" class="form-control-feedback display_none">Kategoriename ist erforderlich</small>
                                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info waves-effect"  onclick="save_sub_cat()">Speichern</button>
                                                <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Abbrechen</button>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
                                ...
                                <div id="add-contact2" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_name_en" class="form-group ">
                                                                        ...
                                                                        <input onkeyup="error_handle('name_en')" type="text" class="form-control" id="cat_name" placeholder="Name eingeben"> 
                                                                        <small id="error_msg_name_en" class="form-control-feedback display_none">Kategoriename ist erforderlich</small>
                                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    ...
                                                                    <div  id="div_name_it" class="form-group ">
                                                                        <input onkeyup="error_handle('name_it')" type="text" class="form-control" id="cat_name_it" placeholder="Name eingeben">
                                                                        <small id="error_msg_name_it" class="form-control-feedback display_none">Kategoriename ist erforderlich</small> </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_name_de" class="form-group ">
                                                                        ...
                                                                        <input onkeyup="error_handle('name_de')" type="text" class="form-control" id="cat_name_de" placeholder="Name eingeben"> 
                                                                        <small id="error_msg_name_de" class="form-control-feedback display_none">Kategoriename ist erforderlich
                                                                        </small>
                                                                    </div>
                                                                </div>
                                                            </div> 
                                            ...
                                            <div class="modal-footer">
                                                <a type="submit" class="btn btn-info waves-effect"  onclick="save_catagory()"  data-toggle="modal"   href="">Speichern</a>
                                                <a class="btn btn-default waves-effect" data-toggle="modal"  data-target="#add-contact" href="" data-dismiss="modal">Abbrechen</a>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    <div class="row pt-4 small-screen-mr-16">
                                        <div class="col-lg-6 col-xlg-6 col-md-6 ">
                                            ...
                                            <div class="div-background  mt-4 p-4">
                                                ...
                                                <input  type="text" id="title_id" class="form-control" placeholder="Titel Eingeben" required>
                                                <div class="row pt-4 ">
                                            ...
                                            <h4 class="mt-4"><i class="ti-link"></i> Anhang</h4>
                                        ...
                                        <div class="col-lg-6 col-xlg-6 col-md-6 pl-5 plm-10px mtm-10">
                                            <div class="row mm-0">
                                                <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                    ...
                                                    <div class ="row">
                                                        <div class="col-lg-12 col-xlg-12 col-md-12"> 
                                                            <h4 class="font-weight-title">Wählen Sie eine aus</h4>
                                                        </div>
                                                    ...
                                                    <div class="row div-background p-4">
                                                        <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                            <label class="control-label"><strong>Abteilung auswählen</strong></label>
                                                            <select class="select2 m-b-10 select2-multipleselect2 form-control custom-select" style="width: 100%"  id="department_id" name="empname">
                                                                <option >Abteilung zuweisen</option>
                                                                <?php 
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                            <input type="button" id="" onclick="save_handbook('CREATE');" class="btn mt-4 w-20 wm-30 btn-secondary" value="Erstellen">
                                            <input type="button" id="" onclick="save_handbook('DRAFT');"  class="btn mt-4 w-20 ml-3 wm-45  btn-outline-info" value="Als Entwurf speichern">
                                            <input type="button" id="" onclick="save_handbook('TEMPLATE');" class="btn mt-4 ml-3 w-20 wm-45  btn-outline-info btn-template" value="Als Vorlage speichern">
                                            <input type="button" id="" onclick="d()" class="btn mt-4 ml-3 w-20 btn-outline-info wm-43 btn-delete" value="Vorlage löschen">
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function save_handbook(create_as){
                ...
                if(title_.trim() != ""){
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                Swal.fire({
                                    title: 'Handbuchvorlage erstellt',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'In Ordnung'
                                }).then((result) => {
                    ...
                    Swal.fire({
                        title: 'Titel zum Senden erforderlich',
                        type: 'basic',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'In Ordnung'
                    });
