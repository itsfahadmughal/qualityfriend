    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Notiz bearbeiten</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Notiz bearbeiten</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Notizen</a></li>
                                    <li class="breadcrumb-item text-success">Notiz bearbeiten</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                        <input type="button" id="create_job_id" onclick="save_notice('CREATE');" class="btn mt-4 wm-48 w-25 btn-secondary" value="Änderungen speichern">
                                        <input type="button" id="saveasdraft_job_id" onclick="save_notice('DRAFT');"  class="btn wm-48 mt-4 w-25 ml-1  btn-outline-info" value="Als Entwurf speichern">
                                        <input type="button" id="delete_notice_id" onclick="delete_notice('<?php echo $nte_id; ?>');"  class="btn mt-4 w-10 ml-1 wm-30  btn-outline-info" value="Löschen">
                                        <input type="button" id="save_duplicate_id" onclick="duplicate_notice('<?php echo $nte_id; ?>');"  class="btn mt-4 w-10 ml-1 wm-30  btn-outline-info" value="Duplikat" >
                                        <input type="button"id="template_save_id" onclick="save_notice('TEMPLATE');" class="btn mt-4 ml-1 w-25 btn-outline-info btn-template wm-48" value="Als Vorlage speichern">
                                        <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 wm-38 ml-1 w-20 btn-outline-info btn-delete" value="Vorlage löschen">
                                    </div>
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                Swal.fire({
                                    title: 'Hinweisvorlage gespeichert.',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'In Ordnung'
                                }).then((result) => {
