                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Einstellungen</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pl-3 pr-3">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a  onclick="set_floor('Etage hinzufügen','<?php echo ""; ?>','<?php echo "" ?>')" data-toggle="modal"  data-target="#add-floor" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp; Etage hinzufügen</a>
                        </div>

                        <div class="col-lg-3 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a  onclick="set_room_category('Zimmerkategorie hinzufügen','','','','','0','0','0','0','NONE','','NONE','')" data-toggle="modal"  data-target="#add-category" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp;Zimmerkategorie hinzufügen</a>
                        </div>



                        <div class="col-lg-2 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a onclick="set_room('Räume hinzufügen','','','','','0','0','','','')"  data-toggle="modal"  data-target="#add-room" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp;Räume hinzufügen</a>
                        </div>

                        <div class="col-lg-3 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a onclick="set_extra_jobs('Zusatzaufgaben der Reinigungskraft anlegen','','0','')" data-toggle="modal"  data-target="#add-extra" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp; Zusatzaufgaben der Reinigungskraft anlegen</a>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="title_extra_jobs">Zusatzaufgaben der Reinigungskraft anlege</h4>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 m-b-20 mt-2">
                                                    <div  id="" class="form-group ">
                                                        <input onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="extra_job"  placeholder="Zusätzliche Jobs reinigen" required> 
                                                        <input hidden type="text" class="form-control" id="edit_extra_id">
                                                        <small id="error_msg_name_en_sub_cat" class="form-control-feedback display_none"></small>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 m-b-20 mt-2" >
                                                    <label class="control-label"><strong>Zeit zum Reinigen</strong></label>
                                                    <div id="div_exta" class="form-group mt-2">
                                                        <select onchange="error_handle_sub('cat')" id="clean_extra" class="form-control custom-select">
                                                            <option value="0">Wählen Sie Zeit</option>
                                                            <?php 
    $sql="SELECT * FROM `tb_time_interval`";
                               ...
                               if ($result && $result->num_rows > 0) {
                                   while($row = mysqli_fetch_array($result)) {
                                       ...
                                       $sc  = $row[1]." Minuten";
                                                        ...
                                                        <small id="error_msg_category" class="form-control-feedback display_none"></small> 
                                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_extra_job()">Speichern</button>
                                        <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Stornieren</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
                        ...
                        <div id="add-task" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Aufgabe hinzufügen</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <div class="modal-body">
                                        <from class="form-horizontal" onsubmit="event.preventDefault();">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 m-b-20 mt-2">
                                                    <div  id="" class="form-group ">
                                                        <input onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="task"  placeholder="Aufgabe" required> 
                                                        <small id="error_msg_name_en_sub_cat" class="form-control-feedback display_none"></small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 m-b-20 mt-2" >
                                                    ...
                                                    <label class="control-label"><strong>Zimmer</strong></label>
                                                    <div id="div_category" class="form-group">
                                                        <select onchange="error_handle_sub('cat')" id="select_room_id" class="form-control custom-select">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_task()" >Speichern</button>
                                        <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Stornieren</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="title_category">Zimmerkategorie hinzufügen</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                                ...
                                                <div class="tab-pane active" id="en" role="tabpanel">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Expressreinigung</strong></label>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Normale Reinigung</strong></label>
                                                            <div id="div_normal" class="form-group mt-2">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            <label class="control-label"><strong>Reinigung Abreise</strong></label>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong> Endreinigung</strong></label>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Reinigungsfrequenz</strong></label>
                                                            <div id="div_cleaning" class="form-group mt-2">
                                                                <select onchange="error_handle_sub('cat')" id="cleaning" class="form-control custom-select">
                                                                    ...
                                                                    <option value="EVERY_SECOUND_DAY">Jeden zweiten Tag</option>
                                                                    <option value="EVERY_THIRD_DAY" >Jeden dritten Tag</option>
                                                                    <option value="EVERY_FOURTH_DAY">Jeden vierten Tag</option>
                                                                    <option value="EVERY_FIFTH_DAY" >Jeden fünften Tag</option>
                                                                    <option value="EVERY_WEEK">Jede Woche</option>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong> Frequenz Wäschewechsel</strong></label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="div_name_it_sub_cat" class="form-group ">
                                                                ...
                                                                <small id="error_msg_name_it_sub_cat" class="form-control-feedback display_none">
                                                                </small>
                                                            </div>
                                                        </div>
                                                    </div> 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="div_name_de_sub_cat" class="form-group ">
                                                                ...
                                                                <small id="error_msg_name_de_sub_cat" class="form-control-feedback display_none"></small>
                                                            </div></div>
                                                    </div> 
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_room_category()">Speichern</button>
                                        <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Stornieren</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                        ...
                        <div id="add-room" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="title_room">Räume hinzufügen</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <ul class=" nav nav-tabs profile-tab" role="tablist">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="en_r" role="tabpanel">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="" class="form-group ">
                                                                <input onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="room_name_en"  placeholder="Raumname" required> 
                                                                <small id="error_msg_name_en_sub_cat" class="form-control-feedback display_none"></small>
                                                            ...
                                                            <div  id="" class="form-group ">
                                                                <input onkeyup="error_handle_sub('id')"  min="1" type="number" class="form-control" id="room_number"  placeholder="Zimmernummer" required> 
                                                                <small id="" class="form-control-feedback display_none"></small>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Zimmerkategorie</strong></label>
                                                            <div id="div_category" class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20" >
                                                            ...
                                                            <label class="control-label"><strong>Etagen</strong></label>
                                                            <div id="" class="form-group">
                                                                <select onchange="error_handle_sub('cat')" id="select_floor_id" class="form-control custom-select">
                                                                    <option value="0">Etage auswählen</option>
                                                                    <?php 
                                                ...
                                                <div class="tab-pane" id="it_r" role="tabpanel">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="" class="form-group ">
                                                                <input   onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="room_name_it"  placeholder="Raumname">
                                                                <small id="" class="form-control-feedback display_none"></small>
                                                            </div>
                                                        </div>
                                                    </div> 
                                                ...
                                                <div class="tab-pane" id="de_r" role="tabpanel">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="" class="form-group ">
                                                                <input  onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="room_name_de"placeholder="Raumname"> 
                                                                <small id="" class="form-control-feedback display_none"></small>
                                                            </div></div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_rooms()">Speichern</button>
                                        <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Stornieren</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                        ...
                        <div id="add-floor" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="title_floor">Etage hinzufügen</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 m-b-20 mt-2">
                                                        <div  id="div_name_en" class="form-group ">
                                                            <input onkeyup="error_handle('name_en')" type="text" class="form-control" id="floor_number" placeholder="Stockwerk Nummer"> 
                                    ...
                                    <div class="modal-footer">
                                        <a type="submit" class="btn btn-info waves-effect"  onclick="add_floor()"  data-toggle="modal"   href="">Speichern</a>
                                        <a class="btn btn-default waves-effect" data-toggle="modal"  data-target="#add-contact" href="" data-dismiss="modal">Stornieren</a>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            </div>
                        ...
                        <div class="col-lg-12  col-md-12">
                            ...
                            <div class='row' >
                                <div class="col-lg-12  col-md-12">
                                    <div class="checkbox checkbox-success mt-2">
                                        ...
                                        <label class="font-weight-title pl-2 mb-2"><b><h4>Alle User-Jobs anzeigen</h4></b></label>
                                    </div>
                                </div>
                            </div>
                            <div class='row' >
                                    ...
                                    <div id="<?php echo "div_floor_".$div_id ?>" onclick='selected_divs(this,<?php echo $floor_id ?>,"floor")' class='divacb div-department-height div-white-background '>
                                        <div class='row pt-4' >
                                            ...
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a data-toggle="modal"  data-target="#add-floor" data-dismiss="modal"  onclick="set_floor('Etage bearbeiten',<?php echo $floor_num; ?>,<?php echo $floor_id ?>)" href="javascript:void(0)"
                            ...
                            <div class='row mt-3' >
                                ...
                                if ($result && $result->num_rows > 0) {
                                    while($row = mysqli_fetch_array($result)) {
                                        ...
                                        $category_name_show = "";
                                        if($category_name_de_s != ""){
                                            $category_name_show = $category_name_de_s; 
                                        }else if($category_name_s != ""){
                                        ...
                                        <div class='row pt-4' >
                                            ...
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a 
                                                   ...
                                                   onclick='set_room_category("Raumkategorie bearbeiten",
                                    ...
                                    <div class='pt-3 pb-3 div-white-background pointer'>
                                        <div class='row ' >
                                            <div class='col-lg-8 col-xlg-8 col-md-8 pl-4 wm-70'>
                                                <h5><?php echo "Zimmernummer : ".$room_num ;?></h5>
                                            </div>
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a   onclick="set_room('Räume bearbeiten',
                                                              '<?php echo $room_num; ?>',
                                                              '<?php echo $room_name; ?>',
                            ...
                            <div class='row mt-3' >
                                <div class='col-lg-12 col-xlg-12 col-md-12'>
                                    <h4><b> Zusatzaufgaben der Reinigungskraft</b></h4>
                                </div>
                                <?php
                                ...
                                <div class='col-lg-3 col-xlg-3 col-md-3 mt-3'>
                                    <div class=' div-white-background '>
                                        <div class='row pt-4' >
                                            ...
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a onclick="set_extra_jobs('Reinigungs-Extra-Jobs bearbeiten',
                                                            '<?php echo $job_title; ?>',
        ...
        <script>
            ...
            function add_extra_job(){
                ...
                if(title == "Zusatzaufgaben der Reinigungskraft anlegen"){
                    var add_or_edit = "Add";
                }else{
                    var add_or_edit = "Edit";
                }
            ...
            function add_room_category(){
                ...
                if(title == "Zimmerkategorie hinzufügen"){
                    var add_or_edit = "Add";
                }else{
                    var add_or_edit = "Edit";
                }
