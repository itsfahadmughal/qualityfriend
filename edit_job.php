...
$bring_array = array();
$sql1="SELECT * FROM `tbl_job_step2_options` WHERE `job_id` =    $crjb_id";
$result1 = $conn->query($sql1);
if ($result1 && $result1->num_rows > 0) {
    while($row2 = mysqli_fetch_array($result1)) {
        array_push($bring_array,$row2['text']);
...
$reach_array = array();
$sql1="SELECT * FROM `tbl_job_step4_options` WHERE `job_id` =    $crjb_id";
$result1 = $conn->query($sql1);
if ($result1 && $result1->num_rows > 0) {
    while($row2 = mysqli_fetch_array($result1)) {
        array_push($reach_array,$row2['text']);
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Edit Job-Ad</p>
            </div>
        </div>
        <!-- ============================================================== -->
...
<h4 class="text-themecolor font-weight-title font-size-title">Edit Job-Ad</h4>
</div>
...
-->
                    ...
                    <div class="row page-titles mb-3 heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Edit Job-Ad</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Recruiting</a></li>
                                    <li class="breadcrumb-item text-success">Edit Job-Ad</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <form id="create_job_form" action="dashboard.php">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="english" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    ...
                                                    <input id="title_id" type="text" value="<?php echo $title; ?>" class="form-control" placeholder="Enter the Title">
                                                    <div class="row pt-4">
                                                    ...
                                                    <h4 class="font-weight-title pt-4">Add Location</h4>
                                                ...
                                                <div class="col-lg-3 col-xlg-3 col-md-3 pt-4"> 
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="card-title">Add pic for job ad</h4>
                                        ...
                                        <div class="tab-pane" id="italian" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    <h4 class="font-weight-title">Job Title</h4>
                                                    <input id="title_it_id" type="text" value="<?php echo $title_it; ?>" class="form-control" placeholder="Enter the Title">
                                        ...
                                        <div class="tab-pane" id="german" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    <h4 class="font-weight-title">Job Title</h4>
                                                    <input id="title_de_id" type="text" value="<?php echo $title_de; ?>" class="form-control" placeholder="Enter the Title">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                            <input type="button" onclick="save_job('DRAFT');" class="btn mt-4 w-20 btn-secondary" value="Save as Draft">
                                            <input type="submit" onclick="save_job('CREATE');" class="btn mt-4 ml-3 w-20 btn-info" value="Save Changes">
                                        </div>
                                    </div>
