                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title inline-div mtm-10 mbm-0">Jobs - Funnel List</h4>
                                    <br>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                    ...
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-xlg-12 col-md-12">
                                                                <input type="text" class="form-control" id="add_funnel" placeholder="Create Name"> 
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button onclick="create_new_funnel()" type="button" class="btn btn-info waves-effect" >Create</button>
                                    ...
                                    <button data-toggle="modal" data-target="#add-contact" type="button" class="btn mt-4 btn-secondary">Create Funnel</button>
