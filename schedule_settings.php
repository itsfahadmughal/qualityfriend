...
<html lang="en">
    ...
    <head>
        ...
        <title>Schedules Settings</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Schedules Settings</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Schedules Settings</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-4 pm-2rem">
                        ...
                        <div class="mt-4">
                            <h3>User Schedule Visible Settings</h3>
                        </div>
                        ...
                        <div class="mt-3">
                            <label class="control-label"><strong>Visible Type</strong></label>
                            <select id="select2" onchange="type_changed();" class="form-control custom-select">
                                <option value="SELF">Only Employee</option>
                                <option value="DEPARTMENT">Employee Department</option>
                                <option value="TEAM">Employee Team</option>
                        ...
                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" id="save_schedule_visible" onclick="save_schedule_visible();" class="btn mt-4 w-20 btn-secondary" value="Save">
                        </div>
                    ...
                    <div class="col-lg-4 pm-2rem">
                        <div class="mt-5 mtm-0">
                            <h3>Schedule Control Buttons Settings</h3>
                        </div>
                        <div class="mt-3">
                            <label class="control-label"><strong>Employees</strong></label>
                        ...
                        <div class="mt-3">
                            ...
                            <select id="2select2" class="form-control custom-select">
                                <option value="VISIBLE_ALL">Visible All Buttons</option>
                                <option value="START_END_BTN_ONLY">Start &amp; End Button Only</option>
                                <option value="COMPLETE_ONLY">Complete Button Only</option>
                                <option value="OFFER_UP_ONLY">Offer Up Button Only</option>
                                <option value="TRADE_ONLY">Trade Button Only</option>
                                <option value="NOT_VISIBLE_ALL">Not Visible All Buttons</option>
                            </select>
                        </div>

                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" id="save_control" onclick="save_control_buttons();" class="btn mt-4 w-20 btn-secondary" value="Save">
                        </div>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
