                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Create Notice</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Notice</a></li>
                                    <li class="breadcrumb-item text-success">Create Notice</li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                            <input type="button" id="create_job_id" onclick="save_notice('CREATE');" class="btn mt-4 w-20 btn-secondary" value="Create">
                                            <input type="button" id="saveasdraft_job_id" onclick="save_notice('DRAFT');"  class="btn wm-38 mt-4 w-20 ml-3  btn-outline-info" value="Save as Draft">
                                            <input type="button"id="template_save_id" onclick="save_notice('TEMPLATE');" class="btn mt-4 wm-38 ml-3 w-20 btn-outline-info btn-template" value="Save as Template">
                                            <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 ml-3 w-20 wm-38 btn-outline-info btn-delete" value="Delete Template">
                                        </div>
