...
<html lang="en">
    ...
    <head>
        ...
        <title>Create Todo/Checklist</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Create Todo/Checklist</p>
            </div>
        </div>
        <!-- ============================================================== -->
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    ...
                                    <div class="row div-daily">
                                        ...
                                        <div class="col-lg-9 col-xlg-9 col-md-9 mt-3">
                                            <h6><b>End</b></h6>
                                        </div>
                                        <div class="col-lg-3 col-xlg-3 col-md-3">
                                            <select  id="duration" class="select2 form-control custom-select">
                                                <option value="1">DAILY</option>
                                                <option selected value="2">WEEKLY</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4 ptm-0"> 
                                            <div class="row pt-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12  text-right">
                                            <button data-toggle="modal" data-target="#add-contact" type="button" class="btn mt-4 btn-secondary"><i class=" ti-menu-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Checklist</button>
                                            <button data-toggle="modal" data-target="#add-tour-contact" type="button" class="btn mt-4 btn-secondary"><i class=" fas fa-share-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Tour</button>
                                            <button data-toggle="modal" data-target="#add-inspection-contact" type="button" class="btn mt-4 btn-secondary"><i class="fa fa-check"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Inspection</button>
                                        </div>
                                    </div> 
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 text-right">
                                            ...
                                            <button type="button" onclick="save_todolist('CREATE')" class="btn mt-4 btn-secondary">Create</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
