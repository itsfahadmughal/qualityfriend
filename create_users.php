    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Manage User</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mbm-0 mobile-container-padding">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Manage User</h4>
                        </div>
                        <div class="col-md-7">
                        </div>
                        <div class="col-md-2">
                                ...
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 wm-28">
                                            <button type="button" class="btn btn-secondary mtm-0 m-t-5 mb-2 float-right green_background_color" data-toggle="modal" data-target="#add-contact">Add User</button>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    ...
                                                                    <div  id="div_first_name_c" class="form-group ">
                                                                        <input onkeyup="error_handle_c('first_name')" type="text" class="form-control" id="first_name" placeholder="First Name*"> 
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div  id="div_last_name_c" class="form-group ">
                                                                        ...
                                                                        <input onkeyup="error_handle_c('last_name')" type="text" class="form-control" id="last_name"  placeholder="Last Name*" > 
                                    ...
                                    <div id="edit-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_first_name_e" class="form-group ">
                                                                        <input onkeyup="error_handle_e('first_name')" type="text" class="form-control" id="first_name_edit" placeholder="First Name">
                                                                        <small id="error_msg_first_name_e" class="form-control-feedback display_none">First name is required</small>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    ...
                                                                    <div  id="div_last_name_e" class="form-group ">
                                                                        <input onkeyup="error_handle_e('last_name')"  type="text" class="form-control" id="last_name_edit"  placeholder="Last Name">
                                                                        <small id="error_msg_last_name_e" class="form-control-feedback display_none">Last name is required</small>
                                                                    </div> 
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div  id="div_email_e" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_email_e" class="form-control-feedback display_none">Email is required</small>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_status_e" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_status_e" class="form-control-feedback display_none">Status is required</small> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_department_e" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_department_e" class="form-control-feedback display_none"> Depaartment is required</small> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_role_e" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_role_e" class="form-control-feedback display_none"> Role is required</small> 
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_timeschedule_e" class="form-group ">
                                                                        <select onchange="error_handle_e('time_schedule')"  name="status_timeschedule" id="status_timeschedule"  class="form-control" >
                                                                            <option value="1">Active For Time Schedule</option>
                                                                            <option value="0">Deactive For Time Schedule</option>
                                                                        </select>
                                                                        <small id="error_msg_timeschedule_e" class="form-control-feedback display_none">Time Schedule Status is required</small> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-info waves-effect"  onclick="edituser()">Save</button>
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-addrow" class="shift_pool_tables wm-22_5rem table table-bordered m-t-30 table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                            <thead>
                                                <tr>
                                                    <th class="black_background white_color" >No</th>
                                                    <th class="black_background white_color" >First Name</th>
                                                    <th class="black_background white_color" >Last Name</th>
                                                    <th class="black_background white_color" >Email</th>
                                                    <th class="black_background white_color" >Role</th>
                                                    ...
                                                    <th class="text-center black_background white_color">Edit</th>
                                                    <th class="text-center black_background white_color">Delete</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
