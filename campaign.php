                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3">
                            <a href="create_campaign.php" class="btn btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Create Campaign
                            </a>                          
                        </div>
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title inline-div mtm-10 mbm-0">Job-Ad Tracking Campaign</h4>
