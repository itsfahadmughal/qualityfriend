    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Edit HandBook</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Edit HandBook</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Handbook</a></li>
                                    <li class="breadcrumb-item text-success">Edit HandBook</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div>
                                        ...
                                        <div class="row pt-4 small-screen-mr-16">
                                            <div class="col-lg-6 col-xlg-6 col-md-6 ">
                                                ...
                                                <div class="div-background mt-4   p-4">
                                                    ...
                                                    <input type="text" id="title_id_en" class="form-control" placeholder="Enter the Title" value="<?php echo $title ?>">
                                                    <div class="row pt-4 ">
                                                        ...
                                                        <div class="col-lg-12 col-xlg-12 col-md-12">
                                                            <div>
                                                                <div class="div-background  p-4">
                                                                    <h4 class="font-weight-title">Title</h4>
                                                                    <input type="text" id="title_id_it" class="form-control" placeholder="Enter the Title" value="<?php echo $title_it; ?>">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-xlg-12 col-md-12">
                                                            <div>
                                                                ...
                                                                <div class="div-background   p-4">
                                                                    <h4 class="font-weight-title">Title</h4>
                                                                    <input type="text" id="title_id_de" class="form-control" placeholder="Enter the Title" value ="<?php echo $title_de; ?>">
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                        <input type="button" id="" onclick="save_handbook('CREATE');" class="btn mt-4 wm-38 w-25 btn-secondary" value="Save Changes">
                                        <input type="button" id="" onclick="save_handbook('DRAFT');"  class="btn mt-4 wm-38 w-20 ml-1  btn-outline-info" value="Save as Draft">
                                        <input type="button" id="" onclick="d(<?php echo $hdb_id; ?>)"  class="btn wm-30 mt-4 w-10 ml-1  btn-outline-info" value="Delete">
                                        <input type="button" id="" onclick="duplicate(<?php echo $hdb_id; ?>)"   class="btn wm-30 mt-4 w-15 ml-1  btn-outline-info" value="Duplicate">

                                        <input type="button" id="" onclick="save_handbook('TEMPLATE');" class="btn mt-4 wm-45 ml-1 w-25 btn-outline-info btn-template" value="Save as Template">

                                        <input type="button" id="" onclick="delete_template()"  class="btn mt-4 ml-1 w-25 wm-38 btn-outline-info btn-delete" value="Delete Template">
                                    </div>
