    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Edit Holiday</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Edit Holiday</h4>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 pm-2rem ptm-0">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-12">
                                ...
                                <select id="select2" class="form-control custom-select">
                                    <option value="FULL" <?php if($holiday_type == "FULL"){echo 'selected';} ?> >Full Day(s)</option>
                                    <option value="PARTIAL" <?php if($holiday_type == "PARTIAL"){echo 'selected';} ?> >Partial Day</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-5">
                                ...
                                <label for="message-text" class="control-label mr-2"><i class="far fa-clock"></i> <span id="hours_from_to"><?php if(trim($hourdiff) != 0 || trim($hourdiff) != ""){ echo $hourdiff;}else{echo '8';} ?></span> Hours</label>
                            </div>
                        ...
                        <div class="mt-3 mb-5 pb-5 mbm-0 pbm-0">
                            <input type="button" onclick="submit_offtime()" class="btn mt-4 w-20 btn-info" value="Save">
                        </div>
