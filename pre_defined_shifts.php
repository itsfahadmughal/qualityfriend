...
<html lang="en">
    ...
    <head>
        ...
        <title>Pre-Defined Shifts</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Pre-Defined Shifts</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Pre-Defined Shifts</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-6 right-border-div pr-5 pl-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <div class="form-group mb-0">
                                    <label class="control-label display-inline w-30 wm-45"><strong>Pre-Define Shift Name</strong></label>
                                </div>
                                ...
                                <div class="form-group mb-0">
                                    <label class="control-label display-inline w-30 wm-38"><strong>Start Time</strong></label>
                                    <i class="fas pl-1-8 pr-3"></i>
                                    <label class="control-label display-inline w-30 wm-38"><strong>End Time</strong></label>
                                </div>
                                <div class="form-group mb-0">
                                    ...
                                    <label class="control-label ml-1 mtm-10">Break <small>(min)</small></label>
                                ...
                                <div class="form-group ml-1 mb-0 mt-1">
                                    <label class="control-label mb-0"><i class="far fa-clock"></i> <span id="hours_from_to"><?php echo round($total_hours+($break_min/60),2); ?></span> Hours</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" onclick="submit_pre_defined_shift();" class="btn mt-4 w-100 btn-info" value="<?php if($id == 0){echo 'Add';}else{echo 'Update';} ?> Pre-Defined Shift">
                        </div>
                    ...
                    <div class="col-lg-6 pr-5 pl-5">
                        ...
                        <div class="table-responsive">
                            <table id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                <thead>
                                    <tr>
                                        <th class="" >Pre-Define Shift Name</th>
                                        <th class="" >Shift Time</th>
                                        <th class="mobile_display_none" >Break (Min)</th>
                                        <th class="mobile_display_none" >Working Hours</th>
                                        <th class="mobile_display_none" >Notes</th>
                                        <th class="mobile_display_none" >Department</th>
                        ...
                        <h5 class="text-center"><b>Shifts Not Found.</b></h5>
                        <?php } ?>
