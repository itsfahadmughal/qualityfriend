    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Wage Data</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Wage Data</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-10">
                    ...
                    <div class="col-md-4 pm-2rem ptm-0">
                        ...
                        <h4 class="font-weight-title">Wage Type *</h4>
                        <select id="1_select2" class="form-control custom-select">
                            <option value="0">Select Type</option>
                            <option value="HOURLY" <?php if($wage_type == 'HOURLY'){echo 'selected';} ?> >HOURLY</option>
                            <option value="DAILY" <?php if($wage_type == 'DAILY'){echo 'selected';} ?> >DAILY</option>
                            <option value="WEEKLY" <?php if($wage_type == 'WEEKLY'){echo 'selected';} ?> >WEEKLY</option>
                            <option value="MONTHLY" <?php if($wage_type == 'MONTHLY'){echo 'selected';} ?> >MONTHLY</option>
                        </select>

                        <h4 class="font-weight-title mt-3">Wage * <small>(per hour)</small></h4>
                        <input type="number" step="0.01" value="<?php if($wage != ""){echo $wage;} ?>" id="wage" class="form-control" placeholder="Wage Rate">

                        <h4 class="font-weight-title mt-3">Job Type</h4>
                        <select id="2_select2" class="form-control custom-select">
                            ...
                            <option value="CONTRACT_FULL" <?php if($job_type == 'CONTRACT_FULL'){echo 'selected';} ?> >CONTRACT FULL</option>
                            <option value="CONTRACT_PART" <?php if($job_type == 'CONTRACT_PART'){echo 'selected';} ?> >CONTRACT PART TIME</option>
                        </select>

                        <h4 class="font-weight-title mt-3">Job Start Date</h4>
                        <input type="date" id="start_date" value="<?php if($job_start_date != ""){echo $job_start_date;} ?>" class="form-control">

                        <h4 class="font-weight-title mt-3">Contract End Date</h4>
                        <input type="date" id="end_date" value="<?php if($contract_end_date != ""){echo $contract_end_date;} ?>" class="form-control">

                        <h4 class="font-weight-title mt-3">Working Hours <small>(per week)</small></h4>
                        <input type="number" id="working_hours" value="<?php if($working_hours != ""){echo $working_hours;} ?>" class="form-control" placeholder="hours">

                        <input type="button" id="submit_wage_data" onclick="save_user_wage_data();" class="btn mt-4 w-100 btn-info" value="<?php if($wage_data_id == 0){echo 'Save';}else{echo 'Update';} ?> Data">
                    </div>
                ...
                if(wage_type == 0 || wage == ""){
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "success"){
                                Swal.fire({
                                    title: 'Wage Data Saved Successfully.',
                                    type: 'success',
