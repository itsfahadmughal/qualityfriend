...
<html lang="en">
    ...
    <head>
        ...
        <title>Edit Todo/Checklist</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Edit Todo/Check List</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Edit Todo/Checklist</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Todo/Checklists</a></li>
                                    <li class="breadcrumb-item text-success">Edit Todo/Checklist</li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <!--                                                    <button type="button" onclick="check_list_saved()" class="btn btn-info waves-effect"   data-dismiss="modal">Save</button>-->
                                    ...
                                    <div id="add-tour-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="row pl-3 pt-4 mm-0 plm-0">
                                                    <div class="col-lg-10 col-xlg-10 col-md-10">
                                                        <input type="text" class="form-control" id="add_tour_list_item" placeholder="Enter text"> 
                                                    </div>
                                                    <div class ="col-lg-2 col-xlg-2 col-md-2 font-size-title"style="text-align: center; display: flex; justify-content: center;align-items: center;" >
                                                ...
                                                <div class="modal-footer">
                                                    <!--                                                    <button type="button" onclick="tour_list_saved()" class="btn btn-info waves-effect"   data-dismiss="modal">Save</button>-->
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                    ...
                                    <div id="add-inspection-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <!--                                                    Add Template Category-->
                                                    <h4 class="modal-title" id="myModalLabel">Add Inpection</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="row pl-3 pt-4 mm-0 plm-0">
                                                    <div class="col-lg-10 col-xlg-10 col-md-10">
                                                        <input type="text" class="form-control" id="add_inpection_list_item" placeholder="Enter text"> 
                                                    </div>
                                                    <div class ="col-lg-2 col-xlg-2 col-md-2 font-size-title"style="text-align: center; display: flex; justify-content: center;align-items: center;" >
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div id="refrash3" class="modal-body">
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="row">
                                                            <div class="col-lg-10 col-xlg-10 col-md-10">
                                                                <input type="text" class="form-control" id="add_comments_list_item" placeholder="Enter text"> 
                                                            </div>
                                                            <div class ="col-lg-2 col-xlg-2 col-md-2 font-size-title"style="text-align: center; display: flex; justify-content: center;align-items: center;" >
                                    ...
                                    <div class="tab-pane active" id="english" role="tabpanel">
                                        ...
                                        <div class="row pl-2 pr-2 mt-3">
                                            <label class="control-label mt-1"><strong>Add other language</strong></label>

                                            <button type="button" onclick="Language_selected('IT');" class="btn btn-info ml-3"><i class="fa fa-plus-circle"></i> Italian</button>
                                            <button type="button" onclick="Language_selected('DE');" class="btn btn-info ml-3"><i class="fa fa-plus-circle"></i> German</button>
                                        </div>


                                        <div class="row pt-4">
                                            <div class="col-lg-8 col-xlg-8 col-md-8"> 
                                                <input type="text"; value="<?php  echo $title ?>" id="title_id" class="form-control" placeholder="Enter Title">
                                            </div>
    ...
    $sql="SELECT * FROM `tbl_todolist` WHERE `hotel_id` = $hotel_id and is_delete = 0 and saved_status = 'TEMPLATE'";
                                        ...
                                        <div class="row pt-4">
                                            ...
                                            <div class="col-lg-3 col-xlg-3 col-md-3"> 
                                                <div class="checkbox checkbox-success">
                                                    ...
                                                    <label class="font-weight-title pl-2 mb-1">Active</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class ="row" >
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                ...
                                                <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="not_public">Non Public</label>
                                                </div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <h4 class="font-weight-title">Choose Recipient</h4>
                                            </div>
                                        </div>
                                        <div class="row ">
                                            ...
                                            <div class="col-lg-3 col-xlg-3 col-md-3 pt-2"> 
                                                <div class="checkbox checkbox-success m-b-10">
                                                    ...
                                                    <label class="font-weight-title pl-2 mb-1">All Recipients</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row pt-4">
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <h4 class="font-weight-title">Assign To</h4>
                                            </div>
                                        </div>
                                        <div class ="row" >
                                            <div class="col-lg-12 col-xlg-12 col-md-12"> 
                                                <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="one_recipient">One Recipient</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="all_recipients">All Recipients</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div b-cancle">
                                                    ...
                                                    <label class="custom-control-label" for="together">Together</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pt-4">
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <h4 class="font-weight-title">Due Date</h4>
                                            </div>
                                        </div>
                                        <div class ="row" >
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <div class="custom-control custom-radio inline-div mr-3">
                                                    ...
                                                    <label class="custom-control-label" for="customRadio10">Select</label>
                                                </div>
                                                <div class="custom-control custom-radio inline-div">
                                                    ...
                                                    <label class="custom-control-label" for="customRadio20">None</label>
                                                </div>
                                            </div>  
                                        </div>
                                        ...
                                        <div class="row   div-daily ">
                                            ...
                                            <div class="col-lg-3 col-xlg-3 col-md-3">
                                                <select  id="duration" class="select2 form-control custom-select">
                                                    <option   value="1" <?php if($repeat_status == 'DAILY'){echo "selected";} ?>>DAILY</option>
                                                    <option   value="2" <?php if($repeat_status == 'WEEKLY'){echo "selected";} ?>>WEEKLY</option>
                                                    <option   value="3" <?php if($repeat_status == 'MONTHLY'){echo "selected";} ?>>MONTHLY</option>
                                                    <option   value="4" <?php if($repeat_status == 'QUARTERLY'){echo "selected";} ?>>QUARTERLY</option>
                                                    <option  value="5" <?php if($repeat_status == 'HALF_YEARLY'){echo "selected";} ?>>HALF YEARLY</option>
                                                    <option   value="6" <?php if($repeat_status == 'YEARLY'){echo "selected";} ?>>YEARLY</option>
                                                </select>
                                            </div>
                                            <div class="col-lg-3 col-xlg-3 col-md-3 mtm-10">
                                                <div class="input-group">
                                        ...
                                        <div class="row pt-4  div-day">
                                            <div class="col-lg-9 col-xlg-9 col-md-9"> 
                                                <h4 class="font-weight-title">Select the Day</h4>
                                            </div>
                                        </div>
                                        ...
                                        <div id="delete_<?php echo $attach_id_array[$i]; ?>">
                                            <a data-toggle="tooltip" data-original-title="Click to view Attachment" href="<?php echo $attach_url_array[$i]; ?>" target="_blank"><?php echo 'Attachment-'.($i+1); ?></a><a style="color:#f62d51;" data-toggle="tooltip" data-original-title="Remove Attachment" href="javascript:void(0);" onclick="delete_attachment(<?php echo $attach_id_array[$i]; 
                                                ?>,<?php echo $tdl_id; ?>);"> Remove</a>
                                        </div>
                                        <?php } ?>
                                    </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col-lg-12 col-xlg-12 col-md-12"> 
                                                            <input type="text" id="title_id_it" class="form-control" placeholder="Enter Title" value="<?php echo $title_it;?>">
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-success waves-effect" onclick="dismiss_modal();" data-dismiss="modal">Add</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-xlg-12 col-md-12"> 
                                                            <input type="text" id="title_id_de" class="form-control" placeholder="Enter Title" value="<?php echo $title_de;?>">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div  class="col-lg-10 col-xlg-10 col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xlg-12 col-md-12  text-right">
                                            <button data-toggle="modal" data-target="#add-contact" type="button" class="btn mt-4 btn-secondary"><i class=" ti-menu-alt"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Checklist's</button>
                                            <button data-toggle="modal" data-target="#add-tour-contact" type="button" class="btn mt-4 btn-secondary"><i class=" fas fa-share-square"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Tour's</button>
                                            <button data-toggle="modal" data-target="#add-inspection-contact" type="button" class="btn mt-4 btn-secondary"><i class="fa fa-check"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Inspection's</button>
                                        </div>
                                    </div> 
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 text-right">
                                            <button data-toggle="modal" data-target="#add-comments-contact"  type="button" class="btn mt-4 btn-info"><i class="mdi mdi-plus-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Comments</button>
                                            <button onclick="save_todolist('DRAFT')" type="button" class="btn mt-4 btn-success">Save As Draft</button>
                                            <button type="button" onclick="d()" class="btn mt-4 btn-delete btn-danger">Delete Template</button>
                                            <button onclick="save_todolist('TEMPLATE')" type="button" class="btn mt-4 btn-warning btn-template">Save as Template</button>
                                            <button onclick="cancel()" type="button" class="btn mt-4 btn-danger">Cancel</button>
                                            <button type="button" onclick="save_todolist('CREATE')" class="btn mt-4 btn-secondary">Save Changes</button>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            function inspection_list_saved() {
                ...
                console.log(inspection_list_arrayy_it);
            }
            ...
            function add_list(id) {
                ...
                if(id =="add_inpection_list_item"){
                    ...
                    console.log("This",inspection_list_array_it);
