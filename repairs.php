    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Repairs</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Repairs</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Repairs</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pl-3 pr-3">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3">
                            ...
                            <a href="repair_create.php" class="btn w-100 wm-48 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Create Repair</a>
                            <?php } ?>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                if($is_completed == 0){
                                                ...
                                                ?>
                                                <tr>    
                                                    <td class="text-center"><b><?php echo $title; ?></b><br><div class="label pl-4 pr-4 label-table btn-info cursor-pointer" onclick="redirect_url('repair_detail.php?id=<?php echo $row[0]; ?>');">Repair</div></td>
                                    ...
                                    if($result_sub2 && $result_sub2->num_rows > 0){
                                        while($row_sub2 = mysqli_fetch_array($result_sub2)) {
                                                    ...
                                                    <td class="text-center"><div class="label p-2 label-table label-success">Repair <?php if($row['status_id'] == 8){echo 'Completed';}else{echo 'In-Pipeline';} ?></div></td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="delete_repair('<?php echo $row[0]; ?>');">Delete</a>
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="duplicate_repair('<?php echo $row[0]; ?>');">Duplicate</a>
                                                                <a class="dropdown-item" href="repair_detail.php?id=<?php echo $row[0]; ?>">View</a>
                                                                <a class="dropdown-item" href="repair_edit.php?id=<?php echo $row[0]; ?>">Edit</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <?php } ?>
