                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Job-ad Tracking Campaign</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Recruiting</a></li>
                                    <li class="breadcrumb-item text-success">Job-ad Tracking Campaign</li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="row pt-4 small-screen-mr-16">
                                            ...
                                            <div class="row ">
                                                <div class="col-lg-7 col-xlg-7 col-md-7 ">
                                                    <div class="div-background  mt-4 p-4">
                                                        ...
                                                        <h4 class="font-weight-title mt-3"> Campaign Source</h4>
                                                        <input  type="text" id="source" class="form-control" placeholder="Campaign Source" required>
                                                        <h4 class="font-weight-title mt-3"> Campaign Name</h4>
                                                        <input  type="text" id="name" class="form-control" placeholder="Campaign Name" required>
                                                        <h4 class="font-weight-title mt-3"> Campaign Team</h4>
                                                        <input  type="text" id="team" class="form-control" placeholder="Campaign Team" required>
                                        ...
                                        <div class="row mbm-20">
                                            <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                                <input type="button" id="" onclick="save_campaign();" class="btn mt-4 btn-secondary" value="Create Campaign">
