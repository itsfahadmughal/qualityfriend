    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Notice Detail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Notice Detail</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Notice</a></li>
                                    <li class="breadcrumb-item text-success">Notice Detail</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            if(sizeof($comments_arr) != 0){
                                for($i=0;$i<sizeof($comments_arr);$i++){    
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php echo $comments_arr[$i]; ?><span class="fs-11">&nbsp; commented by <b><?php echo $comment_user_arr[$i]; ?></b> (<?php echo $entrytime_arr[$i]; ?>)    <?php if($Create_edit_notices == 1 || $usert_id == 1){ ?> <a href="javascript:void(0);" onclick="delete_comment('<?php echo $comments_id_arr[$i]; ?>')"><i class="fas fa-trash-alt red-color text-right"></i></a> <?php } ?> </span></h4>   
                                                <?php
                                }
                            }
                                                ?>
                                                ...
                                                <?php if($Create_edit_notices == 1 || $usert_id == 1){ ?>
                                                <input type="button" id="create_job_id" onclick="change_status('activate','<?php echo $active_status ?>');" class="btn mt-4 mw-40 wm-45 w-20 btn-secondary" value="Mark as <?php if($active_status==1){echo 'Deactive';}else{echo 'Active';} ?>">
                                                <?php } ?>

                                                <button data-toggle="modal" data-target="#add-comments-contact" type="button" class="btn mw-40 ml-3 w-20 wm-70 ml-0 mt-4 btn-warning"><i class="mdi mdi-plus-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Comments</button>
