...
if($result){
    ...
    $last_id = $id;
    $alert_msg = $message." Vacanza aggiornata.";
    ...
    echo '1';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','$message Vacanza aggiornata','$hotel_id','$last_edit_time')";
