    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">I miei turni</p>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left text-dark">Offri il turno</h3>
                        <button type="button" class="close" data-dismiss="modal" onclick="dismiss_modal();" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="form-group mb-3">
                                <span class="text-dark"><b>Offri il turno</b></span>
                                <div class="row">
                                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <span class="text-dark"><b>Messaggio al dipendente (facoltativo)</b></span>
                                <textarea class="form-control" placeholder="Message" id="message-text"></textarea>
                            </div>
                            <div class="form-group">
                                <span>Riceverai una notifica quando un altro collega prende il tuo turno ed è stato approvato da un manager. Fino ad allora, è ancora il tuo turno.</span>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal();" data-dismiss="modal">Annulla</button>
                        <button onclick="offer_shift_save();" type="button" class="btn btn-success waves-effect waves-light">Offrire</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="responsive-modal-trade" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="display-inline text-left text-dark">Cambio di rotta</h3>
                        <button type="button" class="close" data-dismiss="modal" onclick="dismiss_modal_trade();" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
                        <form>
                            <div class="form-group mb-3">
                                <span class="text-dark"><b>Cambio di rotta</b></span>
                                <div class="row">
                                    <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default waves-effect" onclick="dismiss_modal_trade();" data-dismiss="modal">Annulla</button>
                        <button onclick="trade_shift_save();" type="button" class="btn btn-info waves-effect waves-light">Cambio di rotta</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="page-wrapper">
                ...
                <div class="col-lg-12 mt-3 mb-4">
                    ...
                    <table id="schedule-week-view">
                        <thead>
                            <tr>
                                <th class="empty_w"><h4 class="text-dark">Dipendenti</h4></th>
                                <th class="days_w">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="text-left background-shadow-div2">
                                        ...
                                        ?>
                                        <button class="btn btn-success font-0-8 slot-btn-p w-100 mb-2" disabled>Completato</button>
                                        <?php
                                                    }
                                                }else{
                                                    if($button_visibility == "COMPLETE_ONLY" || $button_visibility == "VISIBLE_ALL"){
                                        ?>
                                        <button class="btn btn-dark font-0-8 slot-btn-p w-100 mb-2" onclick="change_status_complete(<?php echo $row_inner['sfs_id']; ?>,'<?php echo $row_inner['title']; ?>');">Contrassegna come completato</button>
                                        <?php 
                                                    }
                                        ...
                                        ?>
                                        <button class="btn btn-secondary font-0-8 slot-btn-p w-100" onclick="take_back('<?php echo $row_inner['sfs_id']; ?>');">Riprenditi</button>
                                        <?php 
                                                        }
                                                    }else{
                                        ...
                                        ?>
                                        <button class="btn btn-primary font-0-8 slot-btn-p w-100" onclick="cancel_trade('<?php echo $row_inner['sfs_id']; ?>');">Annulla scambio</button>
                                        <?php
                                                            }
                                                        }else{
                                                            if($button_visibility == "OFFER_UP_ONLY" || $button_visibility == "VISIBLE_ALL"){
                                        ...
                                        <button class="btn btn-secondary font-0-8 slot-btn-p w-100" onclick="offer_up_shift('<?php echo $row_inner['sfs_id']; ?>');">Offri il turno</button>
                                        <?php }     if($button_visibility == "TRADE_ONLY" || $button_visibility == "VISIBLE_ALL"){ ?>
                                        <button class="btn btn-primary font-0-8 slot-btn-p w-100 mt-2" onclick="trade_shift('<?php echo $row_inner['sfs_id']; ?>');">Commercio</button>
                                        <?php } } } } ?>
        ...
        <script>
            ...
            function offer_shift_save(){
                ...
                Swal.fire({
                    title: 'Sei sicuro?',
                    text: "Vuoi offrire il turno!",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: 'Si fallo!',
                    cancelButtonText: 'Annulla'
                }).then((result) => {
                    if (result.value) {
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if(response == "success"){
                                    ...
                                    Swal.fire({
                                        type: 'warning',
                                        title: 'Oops...',
                                        text: 'Turno già completato, non puoi tornare indietro.',
                                        footer: ''
                                    });
                                }else{
                                    Swal.fire({
                ...
                if(offer_to_shift != ""){
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "success"){
                                Swal.fire({
                                    title: 'Offerta inviata con successo.',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Ok'
                                }).then((result) => {
            ...
            function cancel_trade(id){
                Swal.fire({
                    title: 'Sei sicuro?',
                    text: "Vuoi annullare lo scambio!",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                            ...
                            success:function(response){
                                ...
                                if(response == "success"){
                                    ...
                                    Swal.fire({
                                        type: 'warning',
                                        title: 'Oops...',
                                        text: 'Turno già completato, non puoi annullare.',
                                        footer: ''
                                    });
                                }else{
                                    Swal.fire({
