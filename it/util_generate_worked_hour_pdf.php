...
if ($result_employee && $result_employee->num_rows > 0) {
    while($row_employee = mysqli_fetch_array($result_employee)) {
        ...
        $row_table .= "<tr style='background-color:#c5c6d0;'><td><b>".($nk+1)."</b></td>"."<td><b>".$employe_name."</b></td>"."<td><b>Ore lavorate</b></td>".$worked_hours."<td><b>".$worked_hours_t."</b></td></tr>";

        $row_table .= "<tr><td><b>Dipartimento</b></td>"."<td><b>".$row_employee['department_name']."</b></td>"."<td><b>Vacanze pagate</b></td>".$paid_holiday."<td><b>".$paid_holiday_t."</b></td></tr>";

        $row_table .= "<tr><td><b>Salari Tipo</b></td>"."<td><b>".$row_employee['wage_type']."</b></td>"."<td><b>Ferie non pagate</b></td>".$unpaid_holiday."<td><b>".$unpaid_holiday_t."</b></td></tr>";

        $row_table .= "<tr><td><b>Salari:</b></td>"."<td>".$row_employee['wage']."</td>"."<td><b>Malato<b></td>".$sick."<td><b>".$sick_t."</b></td></tr>";
...
$days = "<th>Nr.</th><th>Nome</th><th></th>".$days."<th>Total</th>";
