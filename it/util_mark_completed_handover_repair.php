...
if($source == "handover"){
    ...
    if(isset($row_sub33['title_it'])){
        if($row_sub33['title_it'] != ""){
            $title =  $row_sub33['title_it'];
        }else if($row_sub33['title'] != ""){
        ...
        if($result_update){
            ...
            if ($result_get_recipent && $result_get_recipent->num_rows > 0) {
                while($row_get_recipent = mysqli_fetch_array($result_get_recipent)) {
                    ...
                    $aleart_msg = $title."Contrassegnato come completato dall amministratore";
            ...
            $title_send = "Handover Completato";
            $body_send =  $title." Completato dall amministratore "; ;
