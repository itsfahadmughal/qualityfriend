    ...
    <body class="skin-default-dark fixed-layout">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_add" class="form-group ">
                                                                        <input onkeyup="error_handle()" type="text" class="form-control" id="user_type_name"  placeholder="Nome" required> 
                                                                        <small id="error_msg_add" class="form-control-feedback display_none">campo obbligatorio</small> </div>
                                                                </div>
                                                            </div> 
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-info waves-effect"  onclick="save_user_type()">Salva</button>
                                ...
                                <div id="edit-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_edit" class="form-group ">
                                                                        <input onkeyup="error_handle_edit()" type="text" class="form-control" id="user_type_name_edit"  placeholder="Nome" required> 
                                                                        <small id="error_msg_edit" class="form-control-feedback display_none">campo obbligatorio</small> </div>
                                                                    <input type="text" hidden class="form-control" id="type_id_edit" required>
                                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-info waves-effect"   onclick="save_edit_user_type()">Salva</button>
                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                                ...
                                                <div class="form-group col-lg-12 col-xlg-12 col-md-12" >
                                                    <div class="row div-background p-4">
                                                        <div class ="col-lg-10 col-xlg-10 col-md-10" id="">
                                                            <label class="control-label"><strong>Creare ruoli</strong></label>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                    <div class="row div-background p-4 pm-1rem">
                                                        <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                            <label class="control-label"><strong>Ruoli</strong></label>
                                                        </div>
                                                        <div class="form-group col-lg-12 col-xlg-12 col-md-12 div-white-background">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare checklists e todo lists</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare manuali</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare riparazioni</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare appunti</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare handovers</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="active_id" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare  e modificare utenti,team e dipartimenti</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Ricevere e mandare messaggi</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare ruoli</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Amministrazione stipendi</h5>
                                                                </div>
                                                        ...
                                                        <div class="form-group col-lg-12 col-xlg-12 col-md-12 div-white-background">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare annunci di lavoro</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="active_id" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare candidati</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="active_id" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare collaboratori</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="active_id" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Creare e modificare orari di lavoro</h5>
                                                                </div>
                                                            </div>
        ...
        <script>
            function type_update(type_id) {
                ...
                var rule15 = document.getElementById("rule16").checked;
                if(rule16 == true){
                    rule16 = 1;
                }else{
                    rule16 = 0;
