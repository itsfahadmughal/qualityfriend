                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Handovers Completato</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Handover Completato</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pl-3 pr-3">
                        ...
                        if($Create_edit_handovers == 1 || $usert_id == 1){
                            $sql="SELECT * FROM `tbl_handover` WHERE `is_delete` = 0 AND `hotel_id` = $hotel_id AND status_id = 8 AND saved_status = 'CREATE' ORDER BY 1 DESC";
                        } else{
