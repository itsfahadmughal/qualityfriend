...
if($slug == 3){
    ...
    $alert_msg = $msg." Commercio accettato dal lavoratore, ma lo annulli.";
    ...
    $alert_msg = $msg." Il tuo turno è stato scambiato dall'amministratore con un nuovo lavoratore.";
