...
if($slug == 3){
    ...
    $alert_msg = $msg." Il turno preso dal lavoratore ti riprende ancora.";
    ...
    echo 'success';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','Turno eseguito dall'utente','$hotel_id','$last_edit_time')";
    $result_log = $conn->query($sql_log);
}else if($slug == 1){
    echo 'unsuccess';
}else if($slug == 2){
    $alert_msg = $msg." Turno assegnato dall'amministratore a te.";
    $alert_msg2 = $msg." Il tuo turno assegnato dall'amministratore al nuovo lavoratore.";
    ...
    echo 'adminsuccess';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','Turno assegnato all'utente','$hotel_id','$last_edit_time')";
    $result_log = $conn->query($sql_log);
}else{
    echo '0';
}
