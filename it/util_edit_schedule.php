...
if($result1){
    ...
    $last_id = $id;
    $alert_msg = $message." Cambio aggiornato.";
    ...
    echo '1';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','$message Cambio aggiornato','$hotel_id','$last_edit_time')";
