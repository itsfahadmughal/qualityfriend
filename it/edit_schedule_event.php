...
$sql = "SELECT * FROM `tbl_shift_events` WHERE svnts_id = $id";
...
<html lang="en">
    ...
    <head>
        ...
        <title>Modifica evento turno</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Modifica evento turno</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Modifica evento turno</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-6 pm-2rem">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <div class="form-group mb-0 mb-3">
                                    <input class="form-control" placeholder="Titolo" value="<?php echo $message; ?>" id="title-event" />
                                </div>
                        ...
                        <div class="mt-3">
                            ...
                            <textarea rows="4" class="form-control" id="message_"><?php echo $description; ?></textarea>
                        </div>

                        <div class="mt-3 mb-5 pb-5">
                            <input type="button" onclick="submit_event()" class="btn mt-4 w-20 btn-info" value="Salva">
                        </div>
        ...
        <script> 
            ...
            function submit_event(){
                ...
                if(date == "" || start_time == "" || end_time == ""){
                    ...
                    $.ajax({
                        url:'util_edit_schedule_event.php',
                        type: 'post',
                        data:fd1,
                        processData: false,
                        contentType: false,
