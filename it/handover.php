    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Handovers</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Handovers</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Handovers attivi</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pl-3 pr-3">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3">
                            ...
                            <a href="handover_create.php" class="btn btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Creare Handovers</a>
                            <?php } ?>
                        </div>
                        ...
                        if($Create_edit_handovers == 1 || $usert_id == 1){
                            $sql="SELECT * FROM `tbl_handover` WHERE `is_delete` = 0 AND `hotel_id` = $hotel_id AND status_id = 6 AND saved_status = 'CREATE' ORDER BY 1 DESC";
                        } else{
                            $sql="SELECT DISTINCT a.* FROM `tbl_handover` as a LEFT OUTER JOIN tbl_handover_recipents as b on a.hdo_id=b.hdo_id LEFT OUTER JOIN tbl_handover_departments as c on a.hdo_id= c.hdo_id WHERE a.`hotel_id` = $hotel_id AND status_id = 6 AND a.is_delete = 0 AND a.is_active=1 AND a.saved_status = 'CREATE' AND (a.`visibility_status` = 'PUBLIC' OR b.user_id = $user_id OR c.depart_id = $depart_id) ORDER BY 1 DESC";
                        }
                        ...
                        <div class="col-12">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-sortable-default-col
                                                        data-tablesaw-priority="3" class="border text-center"><b> Creatore</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border text-center"><b> Coinvolti</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border text-center"><b> Stato</b></th>
                                                    <?php if($Create_edit_handovers == 1 || $usert_id == 1){ ?>
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                $sql_sub1="select b.department_name from tbl_handover_departments as a INNER JOIN tbl_department as b on a.depart_id=b.depart_id where a.hdo_id = $row[0] Limit 1";
                                $result_sub1 = $conn->query($sql_sub1);


                                $sql_sub2="select b.firstname from tbl_handover_recipents as a INNER JOIN tbl_user as b on a.user_id=b.user_id where a.hdo_id = $row[0] Limit 2";
                                ...
                                if($is_completed == 0){
                                                ...
                                                ?>
                                                <tr>    
                                                    <td class="text-center"><b><?php echo $title; ?></b><br><div class="label pl-4 pr-4 label-table btn-info cursor-pointer" onclick="redirect_url('handover_detail.php?id=<?php echo $row[0]; ?>');">Handovers</div></td>
                                    ...
                                    if($result_sub2 && $result_sub2->num_rows > 0){
                                        while($row_sub2 = mysqli_fetch_array($result_sub2)) {
                                                    ...
                                                    <td class="text-center"><div class="label p-2 label-table label-success">Handover <?php if($row['status_id']==6){echo 'In-Pipeline';}else{echo 'Completed';} ?></div></td>
                                                    <?php if($Create_edit_handovers == 1 || $usert_id == 1){ ?>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="delete_handover('<?php echo $row[0]; ?>');">Eliminare</a>
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="duplicate_handover('<?php echo $row[0]; ?>');">Duplicare</a>
                                                                <a class="dropdown-item" href="handover_detail.php?id=<?php echo $row[0]; ?>">Visualizza</a>
                                                                <a class="dropdown-item" href="handover_edit.php?id=<?php echo $row[0]; ?>">Modificare</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <?php } ?>
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                            <h1 class="text-center pt-5 pb-5">Handovers non trovati</h1>
                        </div>
                        <?php
                        }
                        ?>
        ...
        <script>
            ...
            function sort(){
                var sort_val=document.getElementById("sorting").value;
                ...
                $.ajax({
                    url:'util_sort.php',
                    method:'POST',
                    data:{ tablename:"tbl_handover", idname:idn, sort_name:sort_val, query:q},
                    success:function(response){
