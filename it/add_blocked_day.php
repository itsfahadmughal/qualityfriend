...
$date_selected = $from_time = $to_time = $user_selected = "";
...
$hourdiff = round((strtotime($to_time) - strtotime($from_time))/3600, 1);
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Vacanza</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Vacanza</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-6 pm-2rem ptm-0">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                ...
                                <select id="select3" class="form-control custom-select">
                                    <option value="0">Tutti gli impiegati</option>
                                    <?php 
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-12">
                                <label class="control-label"><strong>Tipo di vacanza</strong></label>
                                <select onchange="to_offtime_date();" id="select2" class="form-control custom-select">
                                    <option value="FULL">Giorni interi</option>
                                    <option value="PARTIAL" <?php if(trim($hourdiff) < 8 && trim($hourdiff) != 0){ echo 'selected'; } ?> >Giornata Parziale</option>
                                </select>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-5">
                                ...
                                <label for="message-text" class="control-label mr-2"><i class="far fa-clock"></i> <span id="hours_from_to"><?php if(trim($hourdiff) != 0){ echo $hourdiff;}else{echo '8';} ?></span> Ore</label>
                            </div>
                        ...
                        <div class="mt-3">
                            ...
                            <span class="mt-1">Si prega di fornire un motivo per il giorno/vacanza bloccati.</span>
                        </div>

                        <div class="mt-3 mb-5 pb-5 mbm-0 pbm-0">
                            <input type="button" id="submit_off_time" onclick="submit_offtime()" class="btn mt-4 w-20 btn-info" value="Salva">
                        </div>
        ...
        <script> 
            ...
            function submit_offtime(){
                ...
                var check_flag= '<?php echo $date_selected; ?>';
                ...
                if(from_d == "" || to_d == "" || message == "" || from_t == "" || to_t == ""){
                    alert("Tutti i campi devono essere compilati.");
                }else{
                    $.ajax({
                        url:'util_save_blocked_day.php',
                        type: 'post',
                        data:fd1,
                        processData: false,
                        contentType: false,
