...
<html lang="en">
    <head>
        ...
        <title>Todo/Checklist bozze</title>
        <!-- Footable CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Todo/Checklist bozze</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Todo/Checklist bozze</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Bozze</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title inline-div">Todo/Checklist List</h4>
                                        ...
                                        <table style="display:inline-table;" id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="25">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Titolo</th>
                                                    <th>Descrizione</th>
                                                    <th class="mobile_display_none">Dovuta Data</th>
                                                    <th class="text-center">Modificare</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
                                                $sql="SELECT * FROM `tbl_todolist` WHERE hotel_id = $hotel_id AND `is_delete` = 0 AND `saved_status` = 'DRAFT'";
                                                ...
                                                <tr id="<?php echo $i; ?>">
                                                    ...
                                                    <td class="mobile_display_none"><?php echo $row['due_date']; ?></td>
                                                    <td class="font-size-subheading text-center"><a href="edittodo_check_list.php?id=<?php echo $row['tdl_id']; ?>"><i class="fas fa-pencil-alt"></i></a></td>
                                                </tr>
