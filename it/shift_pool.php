                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-9 text-right">
                            <label class="btn btn-dark">
                                ...
                                <label class="mb-0" for="md_checkbox_22">&nbsp;Abilita pool di turni per gli utenti</label>
                            </label>
                        </div>
                        <?php } ?>
                    </div>
                            ...
                            <div class="card-body pm-0">
                                <div class="vtabs customvtab">
                                    <ul class="nav nav-tabs tabs-vertical" role="tablist">
                                        <?php  if ($Create_view_schedules == 1 || $usert_id == 1) { ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link active" data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-pool"></i></span> <span class="hidden-xs-down">Shift Pool Richiesta</span> </a> </li>
                                        <?php } ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link <?php  if ($Create_view_schedules == 1 || $usert_id == 1) { }else{echo 'active';}?>" data-toggle="tab" href="#profile3" role="tab"><span class="hidden-sm-up"><i class="fas fa-hand-holding"></i></span> <span class="hidden-xs-down">Shifts da prendere</span></a> </li>
                                        <?php  if ($Create_view_schedules == 1 || $usert_id == 1) { ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link" data-toggle="tab" href="#messages3" role="tab"><span class="hidden-sm-up"><i class="fas fa-dollar-sign"></i></span> <span class="hidden-xs-down">Richiesta di scambio shift</span></a> </li>
                                        <?php } ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link" data-toggle="tab" href="#mytrade3" role="tab"><span class="hidden-sm-up"><i class="far fa-money-bill-alt"></i></span> <span class="hidden-xs-down">Mio scambio</span></a> </li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content w-100 pm-1rem">
                                        <div class="tab-pane <?php  if ($Create_view_schedules == 1 || $usert_id == 1) { echo 'active'; }?>" id="home3" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 pm-0">
                                                    <h3><b>Shift Pool Richiesta</b></h3>
                                                    <?php
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="demo-foo-addrow" class="shift_pool_tables wm-100 table table-bordered m-t-30 table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                                            <thead>
                                                                <tr>
                                                                    <th class="" >Turno offerto</th>
                                                                    <th class="" >Offrendo a</th>
                                                                    <th class="" >Tempo</th>
                                                        ...
                                                        while ($row = mysqli_fetch_array($result_up_for)) {
                                                                ...
                                                                <tr class="">
                                                                    ...
                                                                    <td><?php if($row['department_name_it'] != ""){ echo $row['department_name_it']; }else if($row['department_name'] != ""){ echo $row['department_name'];  }else{ echo $row['department_name_de']; } ?></td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                                                        <button <?php if($row['is_approved_by_admin'] == 1){ echo 'disabled'; } ?> onclick="take_shift(<?php echo $row['offer_to']; ?>,'admin',<?php echo $row['shift_offered']; ?>,<?php echo $row['sftou_id']; ?>)" class="btn w-100 btn-success d-lg-block "><?php if($row['is_approved_by_admin'] == 1){ echo 'Accettato'; }else{echo 'Accettare';} ?></button>
                                                                    </td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        while ($row = mysqli_fetch_array($result_up_for)) {
                                                                ...
                                                                <tr class="">
                                                                    ...
                                                                    <td><?php if($row['department_name_it'] != ""){ echo $row['department_name_it']; }else if($row['department_name'] != ""){ echo $row['department_name'];  }else{ echo $row['department_name_de']; } ?></td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                                                        <button <?php if($row['is_approved_by_employee'] == 1){ echo 'disabled'; } ?> onclick="take_shift(<?php echo $row['offer_to']; ?>,'user',<?php echo $row['shift_offered']; ?>,<?php echo $row['sftou_id']; ?>)" class="btn w-100 btn-secondary d-lg-block "><?php if($row['is_approved_by_admin'] == 1){ echo 'Assegnato dall`ammin'; }else if($row['is_approved_by_employee'] == 1){ echo 'Turno preso'; }else{echo 'Prendi il cambio';} ?></button>
                                                                    </td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                        ...
                                        <div class="tab-pane" id="messages3" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 pm-0">
                                                    <h3><b>Richiesta di scambio shift</b></h3>
                                                    <?php
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="demo-foo-addrow" class="shift_pool_tables wm-100 table table-bordered m-t-30 table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                                            <thead>
                                                                <tr>
                                                                    <th class="">Offerta di</th>
                                                                    <th class="">Turno offerto</th>
                                                                    <th class="">Offerto a</th>
                                                                    <th class="">Offerto con</th>
                                                                    <th class="text-center">Azione</th>
                                                                    <th class="text-center ">Eliminare</th>
                                                                </tr>
                                                            </thead>
        ...
        <script>
            ...
            function take_shift(offer_to,slug,shift_id,id){
                ...
                Swal.fire({
                    ...
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
                    confirmButtonText: 'Sì, accetta ora!',
                    cancelButtonText: 'Annulla'
                }).then((result) => {
                    if (result.value) {
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if(response == "success"){
                                    ...
                                    Swal.fire({
                                        title: 'Turno accettato e assegnato.',
                                        type: 'success',
                                        confirmButtonColor: '#3085d6',
                                        confirmButtonText: 'Ok'
                                    }).then((result) => {
