    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Applicazioni</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        ...
                        <div class="col-md-3 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Applicazioni</h5>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Applicazioni</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title">Lista delle Applicazioni</h4>
                                    <!--                                    Add new Applicant-->
                                    <button type="button" class="btn btn-secondary m-t-10 mb-2 float-right" data-toggle="modal" data-target="#add-contact">Aggiungi applicazione</button>
                                    <!-- Add Contact Popup Model -->
                                    <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="myModalLabel">Aggiungi richiedente</h5>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_phane_name" class="form-group ">
                                                                    <input onkeyup="error_handle('phone')"  type="text" class="form-control" name="phone" id="phone" placeholder="Telefono" class="form-control form-control-danger" >
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_job" class="form-group ">
                                                                    ...
                                                                    <small id="error_msg_job" class="form-control-feedback display_none">Il lavoro è richiesto</small> </div>
                                                            </div>
