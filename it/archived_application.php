...
<html lang="en">
    <head>
        ...
        <title>Applicazioni archiviati</title>
        <!-- Footable CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Applicazioni archiviati</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        ...
                        <div class="col-md-3 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Applicazioni archiviati</h5>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Applicazioni archiviati</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title">Lista delle applicazioni
                                    </h4>
                                    <!--                                    Add new Applicant-->
                                        ...
                                        <table id="demo-foo-addrow" class="shift_pool_tables table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="25">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="">
                                                    <td><?php echo $i?></td>
                                                    <td>
                                                        <img src="<?php echo '.'.$row['image_url'] ?>" alt="User" width="40" height="40" class="rounded-circle" onerror="this.src='../assets/images/users/user.png'" />&nbsp;&nbsp;<?php echo $row['name']." ".$row['surname'] ?>
                                                    </td>
                                                    ...
                                                    <td><div class="btn-group">
                                                        <span id="thisstatus<?php echo $i; ?>" class="dropdown-toggle label
                                                                                                      <?php if($status_id == 3){ echo "label-warning";
                                                        ...
                                                        <div class="dropdown-menu animated flipInY">
                                                            <?php 
                                                    $sql2="SELECT * FROM `tbl_util_status` WHERE `status_id` = 6";
                            ...
                            success:function(response){
                                ...
                                if(response == "Updated"){
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            location.replace("archived_application.php");
                                        }
                                    })
                                }
                                else{
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if(response == "Updated"){
                            ...
                            document.getElementById("thisstatus"+i).classList.remove("label-warning");
                            if(status == 6){
                                var thisstatus = "Unarchived";
