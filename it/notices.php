    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Notizie</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Notizie</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Notizie create</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pl-3 pr-3">
                        ...
                        <div class="col-lg-2 wm-48 col-md-3 mt-2 mb-3">
                            ...
                            <a href="notice_create.php" class="btn  w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Creare Notizie</a>
                            <?php } ?>
                        </div>
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                if($row['title_it'] != ""){
                                    ...
                                    $title = "";
                                                ...
                                                ?>
                                                <tr>    
                                                    <td class="text-center"><b><?php echo $title; ?></b><br><div class="label pl-4 pr-4 label-table btn-info cursor-pointer" onclick="redirect_url('notice_detail.php?id=<?php echo $row[0]; ?>');">Notizie</div></td>
                                ...
                                if($result_sub2 && $result_sub2->num_rows > 0){
                                    while($row_sub2 = mysqli_fetch_array($result_sub2)) {
                                                    ...
                                                    <td class="text-center"><div class="label p-2 label-table label-success">Notizie <?php echo $row['saved_status']; ?></div></td>
                                                    <?php if($Create_edit_notices == 1 || $usert_id == 1){ ?>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="delete_notice('<?php echo $row[0]; ?>');">Eliminare</a>
                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="duplicate_notice('<?php echo $row[0]; ?>');">Duplicare</a>
                                                                <a class="dropdown-item" href="notice_detail.php?id=<?php echo $row[0]; ?>">Visualizza</a>
                                                                <a class="dropdown-item" href="notices_edit.php?id=<?php echo $row[0]; ?>">Modificare</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <?php } ?>
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                            <h1 class="text-center pt-5 pb-5">Avvisi non trovati</h1>
                        </div>
                        <?php
                        }
                        ?>
