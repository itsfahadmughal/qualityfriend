                                ...
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 wm-28">
                                            <button type="button" class="btn btn-secondary m-t-5 mb-2 float-right green_background_color" data-toggle="modal" data-target="#add-contact">Aggiungi utente</button>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    ...
                                                                    <div  id="div_first_name_c" class="form-group ">
                                                                        <input onkeyup="error_handle_c('first_name')" type="text" class="form-control" id="first_name" placeholder="Nome di battesimo*"> 
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div  id="div_last_name_c" class="form-group ">
                                                                        <input onkeyup="error_handle_c('last_name')" type="text" class="form-control" id="last_name"  placeholder="Cognome*" > 
                                    ...
                                    <div id="edit-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_first_name_e" class="form-group ">
                                                                        <input  onkeyup="error_handle_e('first_name')" type="text" class="form-control" id="first_name_edit" placeholder="">
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div  id="div_last_name_e" class="form-group ">
                                                                        <input onkeyup="error_handle_e('last_name')" type="text" class="form-control" id="last_name_edit"  placeholder="">
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div  id="div_email_e" class="form-group ">
                                                                        <input onkeyup="error_handle_e('email')"  type="email" class="form-control" id="email_edit"  placeholder="E-mail">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn btn-info waves-effect"  onclick="edituser()">Salva</button>
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        ...
                                        <table id="demo-foo-addrow" class="shift_pool_tables wm-22_5rem table table-bordered m-t-30 table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="black_background white_color" >Nome</th>
                                                    <th class="black_background white_color" >Cognome</th>
                                                    <th class="black_background white_color" >E-mail</th>
                                                    <th class="black_background white_color" >Ruolo</th>
                                                    <th class="black_background white_color">Stato</th>
                                                    <?php  if ($wage_admin == 1 || $usert_id == 1){ ?> <th class="text-center black_background white_color" >Wage Data</th><?php } ?>
                                                    <th class="text-center black_background white_color">Modificare</th>
                                                    <th class="text-center black_background white_color">Cancellare</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
