    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Annunci attivi</p>
            </div>
        </div>
        <!-- ============================================================== -->
                    ...
                    <div class="mobile-container-padding">
                        ...
                        <div class="row page-titles mb-3 heading_style">
                            <div class="col-md-3 align-self-center">
                                <h5 class="text-themecolor font-weight-title font-size-title mb-0">Annunci attivi</h5>
                            </div>
                            ...
                            <div class="col-md-3 align-self-center text-right">
                                <div class="d-flex justify-content-end align-items-center">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item text-success">Annunci attivi</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row pr-4 mobile-container-padding">
                        ...
                        <div class="col-lg-12-custom pr-0">
                            <div  class="list-background icon text-center padding-top-8" onclick="redirect_url('notices.php');">
                                ...
                                <h6 class="text-white pt-2">Appunti</h6>
                            </div>
                        </div>
                        <div class="col-lg-12-custom pr-0">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title inline-div mtm-10 mbm-0">List degli annunci attivi</h4>
                                        ...
                                        <table id="demo-foo-addrow" class="shift_pool_tables table table-bordered m-t-30 table-hover contact-list" data-paging="true">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Dipartimento</th>
                                                    <th>CV richiesto</th>
                                                    <?php if($Create_edit_job_ad == 1 || $usert_id == 1){ ?>  <th>Stato</th>
                                                    <th class="text-center">Modificare</th>
                                                    <?php } ?>
                                                    <th class="text-center">Anteprima</th>
                                                    <th class="text-center">Copiare Job-Link</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php 
                                                ...
                                                <tr id="<?php echo $i; ?>">
                                                    ...
                                                    <td>
                                                        <?php if($row['location_it'] != ""){echo $row['location_it'];}else if($row['location'] != ""){echo $row['location'];}else if($row['location'] != ""){echo $row['location'];} ?>
                                                    </td>
                                                    <td><?php echo $department_name; ?></td>
                                                    <td><?php if($row['is_cv_required']==1){echo 'sì';}else{echo 'No';} ?></td>
                                                    ...
                                                    <td><div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu animated flipInY">
                                                            <a class="dropdown-item" href="javascript:void()" onclick="updatestatus(<?php echo $row['crjb_id']; ?>,<?php echo $i; ?>)">Archiviato</a>
                                                        </div>
                                                        </div></td>
