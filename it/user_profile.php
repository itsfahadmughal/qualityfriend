    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Profilo utente</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" >
                        <div class="col-lg-8 col-xlg-8 col-md-8">
                            <div class="card">
                                ...
                                <ul class="nav nav-tabs profile-tab" role="tablist">
                                    <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Profilo</a> </li>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#settings" role="tab">Impostazioni</a> </li>
                                </ul>
                                <!-- Tab panes -->
                                    ...
                                    <div class="tab-pane active" id="home" role="tabpanel">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-xs-6"> <strong>Tipologia di utente</strong>
                                                    <br>
                                            ...
                                            <hr>
                                            <strong>Dipartimento: </strong><p class="display-inline"><?php
                                        ...
                                        <div class="card-body">
                                            <form class="form-horizontal form-material" onsubmit="event.preventDefault();">
                                                <div class="form-group">
                                                    <label class="col-md-12">Vecchia Password</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Vecchia Password" name="old_password" id="old_password" class="form-control form-control-line">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="example-email" class="col-md-12">Nuova Password</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Nuova Password" class="form-control form-control-line" name="new_password" id="new_password">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="example-email" class="col-md-12">Confermare Nuova Password</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Confermare Nuova Password" class="form-control form-control-line" name="confirm_new_password" id="confirm_new_password">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <div class="col-sm-12">
                                                        <button class="btn btn-success" onclick="update_password();">Aggiornare Parola d'ordine</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="col-lg-4 col-xlg-4 col-md-4">
                            ...
                            <button class="btn btn-success mt-4" onclick="update_profile_pic();">Cambia immagine</button>
                        </div>
                    </div>
                    ...
                    if(confirm_new_pass == new_pass){
                        $.ajax({
                            ...
                            success:function(response){
                                if(response == "1"){
                                    Swal.fire({
                                        title: 'La tua nuova password aggiornata (controlla la posta elettronica per la nuova password).',
                                        type: 'success',
                        ...
                        alert("Nuova password non corrispondente Riprova!");
                    }
                }
            }
                ...
                if(files.length != 0)
                {
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                Swal.fire({
                                    title: 'Immagine del profilo Aggiornata',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Ok'
                                }).then((result) => {
