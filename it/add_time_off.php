...
<html lang="en">
            ...
            <div class="page-wrapper">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-lg-4 pm-2rem ptm-0">
                        <span class="cursor-pointer" onclick="history.back();"><i class="fas fa-chevron-left pr-1"></i> Richieste</span>
                        <div class="mt-4">
                            <label class="control-label"><strong>Categoria</strong></label>
                            <select id="select1" class="form-control custom-select">
                                <option value="PAID">Vacanza</option>
                                <option value="PAID_SICK">Malattia</option>
                                <option value="UNPAID">Vacanza non pagati</option>
                            </select>
                        </div>
        ...
        while($row = mysqli_fetch_array($result)) {
            if($row[0] == $user_selected){
                ...
                echo '<option value='.$row[0].'>'.$row[2].' '.$row[3].'</option>';
                        ...
                        <?php } ?>
                        <div class="mt-3">
                            <label class="control-label"><strong>Durata</strong></label>
                            <select onchange="to_offtime_date();" id="select2" class="form-control custom-select">
                                <option value="FULL" >Giornata intera</option>
                                <option value="PARTIAL" <?php if($hours_selected < 8){echo 'selected';} ?> >Giornata parziale</option>
                            </select>
                        </div>

                        <div class="row mt-3">
                            <div class="col-lg-6">
                                <label class="control-label"><strong>Da</strong></label>
                            ...
                            <div class="col-lg-6">
                                <label class="control-label"><strong>A</strong></label>
                                <div class="input-group">
                        ...
                        <div id="amount" class="mt-3">
                            <label class="control-label"><strong>Quantità</strong></label>
                        ...
                        <div class="mt-3">
                            <label class="control-label"><strong>Commento</strong></label>
                            <textarea rows="4" class="form-control" id="message_"></textarea>
                            <span class="mt-1">Si prega di fornire un motivo con la richiesta di permesso.</span>
                        </div>
                    ...
                    <div class="col-lg-4 p-5 ptm-0">
                        ...
                        <div class="border-timeoff p-4">
                            <span><i class="far fa-clock mr-2 f-timeoff"></i> <strong> Permesso non retribuito</strong></span><br><br>
                            <span class="ml-4"><?php
    ...
    }?> ore approvate(YTD)</span><br><br>
                            <span><i class="mdi mdi-cash mr-2 f-timeoff"></i> <strong> Permesso retribuito</strong></span><br><br>
                            <span class="ml-4"><?php
    ...
    if ($result_paid && $result_paid->num_rows > 0) {
        while($row = mysqli_fetch_array($result_paid)) {
            if($row['th'] == null){echo '0';}else{echo $row['th'];}
                            ...
                            <span><i class="fas fa-notes-medical mr-2 f-timeoff"></i> <strong> Congedo per malattia retribuito</strong></span><br><br>
                            <span class="ml-4"><?php
            ...
            function to_offtime_date(){
                ...
                if(to_d >= from_d){
                    ...
                    while (date <= myDate_to) {
                        ...
                        var temp = "<div class='p-2'><span><i class='icon-calender'></i> <span class='mr-5 pr-5' id='amount_date_"+(n_global_amount+1)+"'>"+dates[n_global_amount]+"</span> <input type='number' value='1' min='1' id='hours_"+(n_global_amount+1)+"' class='w-10' /> ore</span></div>";
                    ...
                    alert("Ad oggi sii sempre più grande.");
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                alert("Tempo libero già richiesto, prova date diverse!");
                            }else{
