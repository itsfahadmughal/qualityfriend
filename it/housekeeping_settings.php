                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Impostazionie</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pl-3 pr-3">
                        <div class="col-lg-2 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a  onclick="set_floor('Aggiungi piano','<?php echo ""; ?>','<?php echo "" ?>')" data-toggle="modal"  data-target="#add-floor" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp; Aggiungi piano</a>
                        </div>

                        <div class="col-lg-2 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a  onclick="set_room_category('Agg. categorie di camere','','','','','0','0','0','0','NONE','','NONE','')" data-toggle="modal"  data-target="#add-category" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp;Agg. categorie di camere</a>
                        </div>



                        <div class="col-lg-2 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a onclick="set_room('Aggiungi stanze','','','','','0','0','','','')"  data-toggle="modal"  data-target="#add-room" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp;Aggiungi stanze</a>
                        </div>

                        <div class="col-lg-3 col-md-3 mt-2 mb-3 prm-0px plm-0">
                            <a onclick="set_extra_jobs('Crea lavori extra del housekeeping','','0','')" data-toggle="modal"  data-target="#add-extra" data-dismiss="modal" href="JavaScript:void(0)" class="btn w-100 btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> &nbsp;&nbsp;&nbsp;&nbsp;Crea lavori extra del housekeeping</a>
                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="title_extra_jobs">Crea lavori extra del housekeeping</h4>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 m-b-20 mt-2">
                                                    <div  id="" class="form-group ">
                                                        ...
                                                        <small id="error_msg_name_en_sub_cat" class="form-control-feedback display_none">Il nome è obbligatorio</small>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 m-b-20 mt-2" >
                                                    <label class="control-label"><strong>È ora di pulire</strong></label>
                                                    <div id="div_exta" class="form-group mt-2">
                                                        <select onchange="error_handle_sub('cat')" id="clean_extra" class="form-control custom-select">
                                                            <option value="0">Seleziona Ora</option>
                                                            <?php 
    $sql="SELECT * FROM `tb_time_interval`";
                               ...
                               if ($result && $result->num_rows > 0) {
                                   while($row = mysqli_fetch_array($result)) {
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_extra_job()">Salva</button>
                        ...
                        <div id="add-task" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Aggiungi attività</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <div class="modal-body">
                                        <from class="form-horizontal" onsubmit="event.preventDefault();">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 m-b-20 mt-2">
                                                    <div  id="" class="form-group ">
                                                        <input onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="task"  placeholder="Task" required> 
                                                        <small id="error_msg_name_en_sub_cat" class="form-control-feedback display_none">Il nome è obbligatorio</small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12 m-b-20 mt-2" >
                                                    ...
                                                    <label class="control-label"><strong>Camera</strong></label>
                                                    <div id="div_category" class="form-group">
                                                        <select onchange="error_handle_sub('cat')" id="select_room_id" class="form-control custom-select">
                                                            <option value="0">Seleziona Stanza</option>
                                                            <?php 
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_task()" >Salva</button>
                                        <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title" id="title_category">Agg. categorie di camere
                                        </h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="div_name_en_sub_cat" class="form-group ">
                                                                <input onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="cat_name_en"  placeholder="Nome" required> 
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Pulizia express</strong></label>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Pulizia normale</strong></label>
                                                            <div id="div_normal" class="form-group mt-2">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            <label class="control-label"><strong> Pulizia parenza</strong></label>
                                                            <div id="div_departure" class="form-group mt-2">
                                                                <select onchange="error_handle_sub('cat')" id="time_to_cd" class="form-control custom-select">
                                                                    <option value="0">Selezionare l'ora</option>
                                                                    <?php 
                                                                    $sql="SELECT * FROM `tb_time_interval`";
                                                                    $result = $conn->query($sql);
                                                                    if ($result && $result->num_rows > 0) {
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Pulizia finale</strong></label>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>
                                                                Frequenza della pulizia</strong></label>
                                                            <div id="div_cleaning" class="form-group mt-2">
                                                                <select onchange="error_handle_sub('cat')" id="cleaning" class="form-control custom-select">
                                                                    ...
                                                                    <option value="EVERY_SECOUND_DAY">Ogni secondo giorno</option>
                                                                    <option value="EVERY_THIRD_DAY" >Ogni terzo giorno</option>
                                                                    <option value="EVERY_FOURTH_DAY">Ogni quarto giorno</option>
                                                                    <option value="EVERY_FIFTH_DAY" >Ogni quinto giorno</option>
                                                                    <option value="EVERY_WEEK">Ogni settimana</option>
                                                                    <option value="SPECIFIC_DAY">Giorno specifico</option> 
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Frequenza cambio biancheria</strong></label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="div_name_it_sub_cat" class="form-group ">
                                                                <input   onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="cat_name_it"  placeholder="Nome">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="div_name_de_sub_cat" class="form-group ">
                                                                <input  onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="cat_name_de" placeholder="Nome"> 
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_room_category()">Salva</button>
                                        <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                        ...
                        <div id="add-room" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="title_room">Aggiungi stanza</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <ul class=" nav nav-tabs profile-tab" role="tablist">
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="en_r" role="tabpanel">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="" class="form-group ">
                                                                <input onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="room_name_en"  placeholder="Nome della stanza" required> 
                                                            ...
                                                            <div  id="" class="form-group ">
                                                                <input onkeyup="error_handle_sub('id')"  min="1" type="number" class="form-control" id="room_number"  placeholder="Numero di Camera" required> 
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2" >
                                                            ...
                                                            <label class="control-label"><strong>Categoria di camera</strong></label>
                                                            <div id="div_category" class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20" >
                                                            ...
                                                            <label class="control-label"><strong>Pavimento</strong></label>
                                                            <div id="" class="form-group">
                                                                <select onchange="error_handle_sub('cat')" id="select_floor_id" class="form-control custom-select">
                                                                    <option value="0">Seleziona Piano</option>
                                                                    <?php 
                                                ...
                                                <div class="tab-pane" id="de_r" role="tabpanel">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12 m-b-20 mt-2">
                                                            <div  id="" class="form-group ">
                                                                <input  onkeyup="error_handle_sub('name')"  type="text" class="form-control" id="room_name_de"placeholder="Nome della stanza"> 
                                                                <small id="" class="form-control-feedback display_none">Category Name is required</small>
                                                            </div></div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="add_rooms()">Salva</button>
                                        <button type="submit" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                        ...
                        <div id="add-floor" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="title_floor">
                                            Aggiungi piano</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12 m-b-20 mt-2">
                                                        <div  id="div_name_en" class="form-group ">
                                                            <input onkeyup="error_handle('name_en')" type="text" class="form-control" id="floor_number" placeholder="Numero piano"> 
                                    ...
                                    <div class="modal-footer">
                                        <a type="submit" class="btn btn-info waves-effect"  onclick="add_floor()"  data-toggle="modal"   href="">Salva</a>
                        ...
                        <div class="col-lg-12  col-md-12">
                            ...
                            <div class='row' >
                                <div class="col-lg-12  col-md-12">
                                    <div class="checkbox checkbox-success mt-2">
                                        ...
                                        <label class="font-weight-title pl-2 mb-2"><b><h4>Mostra lavori di tutti user</h4></b></label>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="<?php echo "div_floor_".$div_id ?>" onclick='selected_divs(this,<?php echo $floor_id ?>,"floor")' class='divacb div-department-height div-white-background '>
                                        <div class='row pt-4' >
                                            ...
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a data-toggle="modal"  data-target="#add-floor" data-dismiss="modal"  onclick="set_floor('Modifica piano',<?php echo $floor_num; ?>,<?php echo $floor_id ?>)" href="javascript:void(0)"
                                        ...
                                        <div class='row pt-4' >
                                            ...
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a 
                                                   ...
                                                   onclick='set_room_category("Modifica la categoria della camera",
                                    ...
                                    <div class='pt-3 pb-3 div-white-background pointer'>
                                        <div class='row ' >
                                            <div class='col-lg-8 col-xlg-8 col-md-8 pl-4 wm-70'>
                                                <h5><?php echo "Numero di Camera : ".$room_num ;?></h5>
                                            </div>
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a   onclick="set_room('Modifica stanze',
                                                              '<?php echo $room_num; ?>',
                                                              '<?php echo $room_name; ?>',
                            ...
                            <div class='row mt-3' >
                                <div class='col-lg-12 col-xlg-12 col-md-12'>
                                    <h4><b>Lavori extra del housekeeping creati</b></h4>
                                </div>
                                <?php
                                ...
                                <div class='col-lg-3 col-xlg-3 col-md-3 mt-3'>
                                    <div class=' div-white-background '>
                                        <div class='row pt-4' >
                                            ...
                                            <div class='col-lg-2 col-xlg-2 col-md-2 wm-15'>
                                                <a onclick="set_extra_jobs('Modifica lavori extra di pulizia',
                                                            '<?php echo $job_title; ?>',
        ...
        <script>
            ...
            function add_extra_job(){
                ...
                if(title == "Crea lavori extra del housekeeping"){
                    var add_or_edit = "Add";
                }else{
                    var add_or_edit = "Edit";
                }
            ...
            function add_room_category(){
                ...
                if(title == "Agg. categorie di camere"){
                    var add_or_edit = "Add";
                }else{
                    var add_or_edit = "Edit";
                }
