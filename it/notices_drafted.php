    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Notizie Bozze</p>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div id="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <!-- Container fluid  -->
                <!-- ============================================================== -->
                <div class="container-fluid mobile-container-padding heading_style">
                    <!-- ============================================================== -->
                    <!-- Bread crumb and right sidebar toggle -->
                    <!-- ============================================================== -->
                    <div class="row page-titles">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Notizie Bozze</h4>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0">
                                    <h4 class="card-title inline-div mm-0">Lista delle notizie</h4>
                                        ...
                                        <table style="display:inline-table;" id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="25">
                                            ...
                                            <tbody>
                                                ...
                                                <tr id="<?php echo $i; ?>">
                                                    ...
                                                    <td class="font-size-subheading text-center"><a href="notices_edit.php?id=<?php echo $row['nte_id']; ?>"><i class="fas fa-pencil-alt"></i></a></td>
                                                </tr>
