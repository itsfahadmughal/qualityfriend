                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3">
                            ...
                            <a href="create_handbook.php" class="btn btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Creare manuali</a>
                            <?php } ?>
                        </div>
                        <?php
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                if($row['title_it'] != ""){
                                    ...
                                    $title = "";
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="text-center"><b><?php echo $title; ?></b><br><div onclick="go(<?php echo $hdb_id; ?>)" class="label pl-4 pr-4 label-table btn-info cursor-pointer ">Manuali</div></td>
                                                    ...
                                                    <td class="text-center" >
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" onclick="d(<?php echo $hdb_id; ?>)" href="javascript:void(0)">Delete</a>
                                                                <a class="dropdown-item" onclick="duplicate(<?php echo $hdb_id; ?>)" href="javascript:void(0)">Duplicate</a>
                                                                <a class="dropdown-item" href="handbook_detail.php?id=<?php echo $row['hdb_id']; ?>">Visualizza</a>
                                                                <a class="dropdown-item" href="edit_handbook.php?id=<?php echo $row['hdb_id']; ?>">Modificare</a>
