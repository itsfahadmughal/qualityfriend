...
<html lang="en">
    ...
    <head>
        ...
        <title>Manage Teams/Dipartimenti</title>
        <!-- page CSS -->
                ...
                <div class="container-fluid mobile-container-pl-75 pr-0" id="mcontainer">
                    ...
                    <div class="row page-titles pb-0">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Creare Teams &amp; Dipartimenti</h4>
                        </div>
                        <div class="col-md-7">
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-md-12 m-b-20 mt-2">
                                                                        ...
                                                                        <div  id="div_team_add" class="form-group ">
                                                                            ...
                                                                            <input onkeyup="error_handle_add_team()" type="text" class="form-control" id="team_name"  placeholder="Nome" required> 

                                                                            <small id="error_msg_team_add" class="form-control-feedback display_none">campo obbligatorio</small> 
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-info waves-effect"  onclick="save_team()">Salva</button>
                                    ...
                                    <div id="edit-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-md-12 m-b-20 mt-2">
                                                                        ...
                                                                        <div  id="div_team_edit" class="form-group ">
                                                                            <input onkeyup="error_handle_team_edit()"  type="text" class="form-control" id="team_name_edit"  placeholder="Nome" required>

                                                                            <small id="error_msg_team_edit" class="form-control-feedback display_none">campo obbligatorio</small> </div>     
                                                                        <input type="text" hidden class="form-control" id="team_id_edit"   required>
                                                                    </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-info waves-effect"  onclick="save_edit_team()">Salva</button>
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                    ...
                                    <div id="edit-department" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <!--Add Team-->
                                                    <h4 class="modal-title" id="myModalLabel">Modificare Dipartiment</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="modal-body">
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-md-12 m-b-20 mt-2">
                                                                        <div  id="div_department_edit" class="form-group ">
                                                                            <input onkeyup="error_handle_department_edit()" type="text" class="form-control" id="department_name_edit"  placeholder="Nome" required> 
                                                                            <small id="error_msg_department_edit" class="form-control-feedback display_none">campo obbligatorio</small> </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-info waves-effect"  onclick="edit_departments()" >Salva</button>
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                    ...
                                    <div id="add-contact1" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel">Aggiungere Dipartiment</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="modal-body">
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="col-md-12 m-b-20 mt-2">
                                                                        <div  id="div_department_add" class="form-group ">
                                                                            <input onkeyup="error_handle_add_department()"  type="text" class="form-control" id="department_name" placeholder="Nome"> 

                                                                            <small id="error_msg_department_add" class="form-control-feedback display_none">campo obbligatorio</small> </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a class="btn btn-default waves-effect" data-toggle="modal"  data-target="" href="" data-dismiss="modal">Annulla</a>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                        <div class="row div-background p-4">
                                                            ...
                                                            <div class ="col-lg-10 col-xlg-10 col-md-10" id="refrash">
                                                                <label class="control-label mt-4"><strong>Dipartimenti</strong></label>
                                                            </div>
                                                            <div class ="col-lg-2 col-xlg-2 col-md-2 font-size-title fsm-2rem" style="text-align: center; display: flex; justify-content: center;align-items: center;" >
                                            ...
                                            <div id="employe" class="col-lg-6 col-xlg-6 col-md-6 pl-5 wm-96 plm-10px">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                        <div class="row div-background p-4">
                                                            <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                                <label class="control-label"><strong>Collaboratori</strong></label>
                                                            </div>
