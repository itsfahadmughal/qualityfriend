                        ...
                        <div class="col-lg-2 col-md-4 align-self-center mtm-5px">
                            <div  class="list-background-second">
                                <select class="select2 form-control custom-select" onchange="change_data();" id="users_list">
                                    ...
                                    <option value="<?php echo $user_id; ?>">Registro personale</option>
                                    <?php 
                                    ...
                                    <div class="table-responsive">
                                        <table style="display:inline-table;" class=" tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="stack"
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="persist" class="border text-center" ><b>Registri Titolo &amp; Tipa</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border text-center" ><b> Utente</b></th>
