...
<html lang="en">
    ...
    <head>
        ...
        <title>Creare riparazione</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Creare riparazione</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Creare riparazione</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Riparazioni</a></li>
                                    <li class="breadcrumb-item text-success">Creare riparazione</li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                            <input type="button" id="create_job_id" onclick="save_repair('CREATE');" class="btn mt-4 wm-30 mw-25 w-10 btn-secondary" value="Creare">
                                            <input type="button" id="saveasdraft_job_id" onclick="save_repair('DRAFT');"  class="btn wm-45 mt-4 w-20 ml-1  btn-outline-info" value="Salva come bozza">

                                            <input type="button"id="template_save_id" onclick="save_repair('TEMPLATE');" class="btn wm-48 mt-4 ml-1 w-25 btn-info btn-template" value="Salva come predefinito">
                                            <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 ml-1 wm-45 w-20 btn-info btn-delete" value="Elimina predefinito">

                                            <input type="button" id="saveastemplate_job_id" onclick="save_repair('CREATE');"  class="btn wm-80 mw-40 mt-4 w-25 ml-1  btn-danger" value="Salva come riparazione non completa">

                                            <input type="button" id="saveastemplate_job_id" onclick="save_repair('COMPLETED');"  class="btn mw-25 mt-4 w-15 ml-1 wm-48  btn-success" value="Riparazione completata">
                                        </div>
