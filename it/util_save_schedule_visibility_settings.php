...
if($result){
    echo 'success';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','Schedule Admin Modificate le impostazioni di visibilità','$hotel_id','$last_edit_time')";
