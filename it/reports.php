                            ...
                            <div class="card-body pm-0">
                                <div class="vtabs customvtab">
                                    <ul class="nav nav-tabs tabs-vertical" role="tablist">
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link active" data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-pool"></i></span> <span class="hidden-xs-down">Ore lavorate</span> </a> </li>
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab" href="#profile3" role="tab"><span class="hidden-sm-up"><i class="fas fa-hand-holding"></i></span> <span class="hidden-xs-down">Scheda attività dei dipendenti</span></a> </li>
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab" href="#messages13" role="tab"><span class="hidden-sm-up"><i class="fas fa-hand-holding"></i></span> <span class="hidden-xs-down">Vacanze</span></a> </li>
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab" href="#messages3" role="tab"><span class="hidden-sm-up"><i class="fas fa-dollar-sign"></i></span> <span class="hidden-xs-down">Pool di turni</span></a> </li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content w-100">
                                        <div class="tab-pane active" id="home3" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    <h3>Ore lavorate &amp; Salari</h3>
                                                    <span>Una visualizzazione dettagliata delle ore lavorate da un dipendente</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Intervallo di date</strong></label>
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <select id="1_select2" class="form-control custom-select">
                                                                <option value="0" disabled selected>Seleziona Dipartimento</option>
                                                                <?php
    ...
    if ($result && $result->num_rows > 0) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo '<option value=' . $row[0] . '>' . $title . '</option>';
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label class="control-label"><strong>Ruolo</strong></label>
                                                            <select id="1_select3" class="form-control custom-select">
                                                                <option value="0" disabled selected>Seleziona Ruolo</option>
                                                                <?php
    ...
    if ($result && $result->num_rows > 0) {
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo '<option value=' . $row[0] . '>' . $title . '</option>';
                                                        ...
                                                        <?php } ?>
                                                        <div class="col-lg-4">
                                                            <label class="control-label"><strong>Dipendente</strong></label>
                                                            <select id="1_select1" class="form-control custom-select">
                                                                <option value="0" disabled selected>Seleziona un dipendente</option>
                                                                <?php 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 mt-3">
                                                            <label class="control-label"><strong>Tipo di esportazione</strong></label>
                                                            <select id="1_select4" class="form-control custom-select">
                                                                <option value="CSV">CSV</option>
                                                                <option value="TXT">TXT</option>
                                                                <option value="WEB">RAGNATELA</option>
                                                        ...
                                                        <div class="col-lg-4 mt-3">
                                                            <input type="button" onclick="get_report_workedHours();" class="btn mt-4 w-100 btn-info" value="Ottieni rapporto">
                                                        </div>
                                        ...
                                        <div class="tab-pane" id="profile3" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    <h3>Scheda attività dei dipendenti</h3>
                                                    <span>Una visualizzazione dettagliata delle ore di turno di un dipendente</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Intervallo di date</strong></label>
                                                    <div class="input-group">
                                                    ...
                                                    <label class="control-label mt-3"><strong>Dipendente</strong></label>
                                                    ...
                                                    <label class="control-label mt-3"><strong>Tipo di esportazione</strong></label>
                                                    ...
                                                    <input type="button" onclick="get_report_emp_timesheet();" class="btn mt-5 w-30 btn-info" value="Ottieni rapporto">
                                        ...
                                        <div class="tab-pane" id="messages13" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    <h3>Tempo scaduto</h3>
                                                    <span>Una visualizzazione dettagliata dei giorni liberi approvati per dipendente, incluso chi ha approvato la richiesta</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Intervallo di date</strong></label>
                                                    <div class="input-group">
                                                    ...
                                                    <select id="3_select1" class="form-control custom-select">
                                                        ...
                                                        if ($wage_admin == 1 || $usert_id == 1) {
                                                            ...
                                                            $sql="SELECT * FROM `tbl_user` WHERE `hotel_id` = $hotel_id and is_delete = 0 and is_active = 1 and user_id = $user_id";
                                                            echo '<option value="0" disabled selected>Select an Employee</option>';
                                                        }
                                                        $result = $conn->query($sql);
                                                        if ($result && $result->num_rows > 0) {
                                                            while($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    <input type="button" onclick="get_report_timeoff();" class="btn mt-5 w-30 btn-info" value="Ottieni rapporto">
                                        ...
                                        <div class="tab-pane" id="messages3" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    <h3>Pool di turni</h3>
                                                    <span>Guarda chi sta raccogliendo o offrendo turni</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Intervallo di date</strong></label>
                                                    <div class="input-group">
                                                    ...
                                                    <label class="control-label mt-3"><strong>Turno offerto dal dipendente</strong></label>
                                                    ...
                                                    <label class="control-label mt-3"><strong>Turno offerto al dipendente</strong></label>
                                                    ...
                                                    <input type="button" onclick="get_report_shiftpool();" class="btn mt-5 w-30 btn-info" value="Ottieni rapporto">
        ...
        <script>
            ...
            function get_report_workedHours(){
                ...
                if(date_range == ""){
                    alert("Seleziona Intervallo di date.");
                }else{
