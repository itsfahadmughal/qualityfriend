                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Todo/Checklists</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Todo/Checklists create</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3">
                            ...
                            <a href="create_todo_checklist.php" class="btn btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i>Aggiungere Todo/Checklist</a>
                            <?php } ?>
                        </div>
                        <?php  
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                if($is_completed == 0){
                                    ...
                                    echo $status_id;?></div></td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <span id="thisstatus" class="dropdown-toggle label label-table label-danger pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Azioni</span>

                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" onclick="d(<?php echo $tdl_id; ?>)" href="javascript:void(0)">Eliminare</a>
                                                                <a class="dropdown-item" onclick="duplicate(<?php echo $tdl_id; ?>)" href="javascript:void(0)">Duplicare</a>
                                                                <a class="dropdown-item" href="todo_check_list_detail.php?id=<?php echo $row['tdl_id']; ?>">Visualizza</a>
                                                                <a class="dropdown-item" href="edittodo_check_list.php?id=<?php echo $row['tdl_id']; ?>">Modificare</a>
