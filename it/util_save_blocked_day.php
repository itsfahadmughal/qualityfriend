...
if($result){
    ...
    $alert_msg = $message." Festività aggiunta.";
    ...
    echo '1';
    $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','$message Vacanza','$hotel_id','$entry_time')";
