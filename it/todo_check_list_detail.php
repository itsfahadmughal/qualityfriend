...
<html lang="en">
    ...
    <head>
        ...
        <title>Todo/Checklist Dettaglio</title>
        <!-- page CSS -->
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Todo/Checklist Dettaglio</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Todo/Checklist Dettaglio</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Todo/Checklists</a></li>
                                    <li class="breadcrumb-item text-success">Todo/Checklist Dettaglio</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="">
                        ...
                        <div id="add-tour-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annulla
                                        </button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                        ...
                        <div id="add-inspection-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Ispezione</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                        <div class="row div-white-background pt-3 pl-4 pb-3 pr-4" >
                                            <div class="col-lg-12 col-xlg-12 col-md-12">
                                                ...
                                                ?>
                                                <small class="text-muted p-t-30 db">Visibility Stato</small>
                                                <h4 class="text-show"><?php if($visibility_status !=""){ echo $visibility_status;} else{ echo "N/A";} ?></h4>
                                                <small class="text-muted p-t-30 db">Data d'inizio</small>
                                                ...
                                                <small class="text-muted p-t-30 db">Data di fine</small>
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php echo $comment_array[$x]; ?> <span class="fs-11"> commentato da <b><?php echo $username; ?></b> (<?php echo $entrytime; ?>)</span>
                                                </h4>
                            ...
                            if(sizeof($comments_arr) != 0){
                                for($i=0;$i<sizeof($comments_arr);$i++){    
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php echo $comments_arr[$i]; ?><span class="fs-11">&nbsp; commentato da <b><?php echo $comment_user_arr[$i]; ?></b> (<?php echo $entrytime_arr[$i]; ?>)    <?php if($Create_edit_todo_checklist == 1 || $usert_id == 1){ ?> <a href="javascript:void(0);" onclick="delete_comment('<?php echo $comments_id_arr[$i]; ?>')"><i class="fas fa-trash-alt red-color text-right"></i></a> <?php } ?> </span></h4>   
                                                <?php
                                }
                            }
                                                ?>
                                                ...
                                                <h4 class="text-show"><?php    for ($x = 0; $x < sizeof($attach_url_array); $x++) { ?>
                                                    <a data-toggle="tooltip" data-original-title="Fare clic per visualizzare l'allegato" href="<?php echo $attach_url_array[$x]; ?>" target="_blank"><?php if($x!=sizeof($attach_url_array)-1){echo "Allegati-".($x+1).", ";}else{echo "Allegati-".($x+1) ;} ?> </a> <?php } ?></h4>
                                                <?php
                                                                                         }
                                                ?>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xlg-12 col-md-12">
                                                ...
                                                <button id="rc" data-toggle="modal" onclick="tour_model()"  type="button" class="btn mt-4 btn-secondary"><i class=" fas fa-share-square"></i> <span id="mtour">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;Tour's
                                                    </span></button>
                                                ...
                                                ?> "><?php if($status_id==6){echo 'Segna come completato';}else{echo '<i class="fa fa-check"></i> &nbsp; Fatto';}?>
                                                ...
                                                <button <?php if($is_complete==1){echo 'disabled';} ?>  
                                                        ...
                                                        && $status_id==6
                                                        ){echo 'Segna come completato';}else{echo '<i class="fa fa-check"></i>&nbsp; Fatto';}?>
                                                </button>
                                                ...
                                                ?>
                                                <button disabled
                                                        onclick="" type="button" class="btn mt-4 <?php if($status_id==6){echo 'btn-info';}else{echo 'btn-success';} ?>"><?php if($status_id==6){echo 'Non completato';}else{echo '<i class="fa fa-check"></i>&nbsp; Fatto';}?>
                                                </button>               

                                                <?php }?>

                                                <button data-toggle="modal" data-target="#add-comments-contact" type="button" class="btn mw-40 w-20 mt-4 wm-70 btn-warning"><i class="mdi mdi-plus-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;Aggiungi commenti</button>
        ...
        <script>
            ...
            function rbc() {
                ...
                if(size == 0  ){
                    ...
                    element.innerText = "Nessuna lista di controllo trovata";
                }else {
                    var checked =  $('input[name=lineup2]:checked').length;
                    var total=  $('input[name=lineup2]').length;
                    var diff = total - checked ;
                    ...
                    if(diff == 0 ){                        
                        ...
                        element.innerText = "Lista di controllo completataa";
                        element.disabled = true;
                        element.style.display = "none";

                        var element1 = document.getElementById("mchecklist");
                        element1.innerText = "    Checklist's Completato";
                        ...
                        element.innerText = "Segna tutto l'elenco di controllo completato";
            ...
            function rcc() {
                ...
                if(size == 0  ){
                    ...
                    if(diff == 0 ){
                        ...
                        element1.innerText = "    Tour's Completato";
            ...
            function rdc() {
                ...
                if(size == 0  ){
                    ...
                    if(diff == 0 ){
                        ...
                        element1.innerText = "    Ispezione Completato";
                        var element2 = document.getElementById("rd");
                        element2.classList.add("btn-success");
                        element2.classList.remove("btn-secondary");
                    }else{ 
                        var element1 = document.getElementById("minspection");
                        element1.innerText = "  Ispezione";
                        var element2 = document.getElementById("rd");
                        element2.classList.add("btn-secondary");
                        element2.classList.remove("btn-success");
                    }
            ...
            function inpection_model() {
                ...
                if(size == 0 ){
                    Swal.fire({
                        title: 'Nessuna ispezione trovata per questa lista di cose da fare/di controllo',
                        type: 'basic',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'Ok'
                    });
            ...
            function todo_model() {
                ...
                if(size == 0  ){
                    Swal.fire({
                        title: 'Nessuna lista di controllo trovata per questa lista di cose da fare/di controllo',
                        type: 'basic',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'Ok'
                    });
            ...
            function tour_model() {
                ...
                if(size == 0 ){
                    Swal.fire({
                        title: 'Nessun tour trovato per questa lista di cose da fare/di controllo',
                        type: 'basic',
                        confirmButtonColor: '#3085d6',
                        confirmButtonText: 'Ok'
                    });
            ...
            function d() {
                Swal.fire({
                    title: 'Sei sicuro?',
                    text: "sNon sarai in grado di ripristinarlo!",
                    type: 'warning',
