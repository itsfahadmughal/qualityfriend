    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Crea un manuale</p>
            </div>
        </div>
        <!-- ============================================================== -->
...
<h4 class="text-themecolor font-weight-title font-size-title">Crea un manuale</h4>
</div>
<div class="col-md-7">    
</div>
<div class="col-md-2">
...
-->
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Crea un manuale</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Manuali</a></li>
                                    <li class="breadcrumb-item text-success">Crea un manuale</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    <div class="row pt-4 small-screen-mr-16">
                                        <div class="col-lg-6 col-xlg-6 col-md-6 ">
                                            ...
                                            <div class="div-background  mt-4 p-4">
                                                ...
                                                <input  type="text" id="title_id" class="form-control" placeholder="Scrivere Titolo" required>
                                            ...
                                            <h4 class="mt-4"><i class="ti-link"></i> Allegato</h4>
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                            <input type="button" id="" onclick="save_handbook('CREATE');" class="btn mt-4 w-20 wm-30 btn-secondary" value="Creare">
                                            <input type="button" id="" onclick="save_handbook('DRAFT');"  class="btn mt-4 w-20 ml-3 wm-45  btn-outline-info" value="Salva come bozza">
                                            <input type="button" id="" onclick="save_handbook('TEMPLATE');" class="btn mt-4 ml-3 w-20 wm-45 btn-outline-info btn-template" value="Salva come modello">
                                            <input type="button" id="" onclick="d()" class="btn mt-4 ml-3 w-20 btn-outline-info wm-38 btn-delete" value="Elimina modello">
                                        </div>
                                    </div>
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                Swal.fire({
                                    title: 'Modello di manuale creato',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Ok'
                                }).then((result) => {
