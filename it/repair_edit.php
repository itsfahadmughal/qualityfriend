    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Modifica riparazione</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Modifica riparazione</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Riparazioni</a></li>
                                    <li class="breadcrumb-item text-success">Modifica riparazione</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div>
                                            ...
                                            <div class="col-lg-6 col-xlg-6 col-md-6">
                                                ...
                                                <div class="row pl-2 pr-2">
                                                    <select id="template" class="select2 form-control custom-select">
                                                        <option value="0">Seleziona Riparazione predefinita</option>
                                                        <?php 
                                                ...
                                                <div class="div-background mt-4 p-4">
                                                    ...
                                                    <div id="delete_<?php echo $attach_id_array[$i]; ?>">
                                                        <a data-toggle="tooltip" data-original-title="Click to view Attachment" href="<?php echo $attach_url_array[$i]; ?>" target="_blank"><?php echo 'Attachment-'.($i+1); ?></a><a style="color:#f62d51;" data-toggle="tooltip" data-original-title="Rimuovi allegato" href="javascript:void(0);" onclick="delete_attachment(<?php echo $attach_id_array[$i]; ?>,<?php echo $rpr_id; ?>);"> Rimuovere</a>
                                                    </div>
                                                    <?php } ?>
                                            ...
                                            <div class="col-lg-6 col-xlg-6 col-md-6 pl-5 plm-10px mtm-10">
                                                ...
                                                <div class="row mm-0">
                                                    ...
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 p-0">
                                                        <div class="mt-4"></div>
                                                        <div class="div-background p-4">
                                                            <label class="control-label"><strong>Aggiungere Etichetta</strong></label>
                                                            <div class="tags-default" >
                                                                <input type="text" name="tags" id="tags_id" class="form-control" data-role="tagsinput" placeholder="Etichetta" value="<?php echo $tags; ?>"> 
                                                            </div>
                                                        </div>                                                        
                                                    </div>
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                        <input type="button" id="create_job_id" onclick="save_repair('CREATE');" class="btn mt-4 wm-45 mw-25 w-20 btn-secondary" value="Salvare le modifiche">

                                        <input type="button" id="saveastemplate_job_id" onclick="delete_repair('<?php echo $rpr_id; ?>');"  class="btn mt-4 w-10 mw-25 ml-1 btn-warning wm-30" value="Eliminare">

                                        <input type="button"id="template_save_id" onclick="save_repair('TEMPLATE');" class="btn mt-4 ml-1 mw-25 w-15 btn-info btn-template wm-48" value="Salva come predefinito">
                                        <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 wm-43 ml-1 w-20 mw-25 btn-info btn-delete" value="Elimina predefinito">

                                        <input type="button" id="saveastemplate_job_id" onclick="save_repair('CREATE');"  class="btn wm-80 mt-4 mw-40 w-30 ml-1  btn-danger" value="Salva come riparazione non completa">

                                        <input type="button" id="saveastemplate_job_id" onclick="save_repair('COMPLETED');"  class="btn wm-48 mt-4 mw-25 w-20 ml-1  btn-success" value="Riparazione completata">
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                Swal.fire({
                                    title: 'Riparazione salvata come predefinita.',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Ok'
                                }).then((result) => {
