    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Modifica turni</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Modifica spostamento</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-6 pm-2rem">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <div class="form-group mb-0">
                                    <label class="control-label display-inline w-30"><strong>Ora di inizio</strong></label>
                                    <i class="fas pl-1-8 pr-3"></i>
                                    <label class="control-label display-inline w-30"><strong>Tempo scaduto</strong></label>
                                </div>
                                <div class="form-group mb-0">
                                    ...
                                    <label for="message-text" class="control-label ml-1">Pausa <small>(min)</small></label>
                                ...
                                <div class="form-group ml-1 mb-0 mt-1">
                                    <label for="message-text" class="control-label mb-0"><i class="far fa-clock"></i> <span id="hours_from_to">8</span> Ore</label>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-12">
                                <div>
                                    <select class="form-control" id="edit_shift_select" onchange="hide_show_until_date_edit();">
                                        <option value="1">Modifica solo questo turno</option>
                                        <option value="2">Modifica tutti i turni negli stessi giorni della settimana successivi</option>
                                        <option value="3">Modifica tutti i turni fino a una certa data</option>
                                    </select>
                                </div>
                                <div class="mt-3" id="edit_shift_date_form" style="display:none;">
                                    <label for="message-text" class="control-label ml-1"><b>Modifica fino a</b></label>
                        ...
                        <div class="mt-3 mb-5 pb-5">
                            <input type="button" onclick="submit_shift()" class="btn mt-4 w-20 btn-info" value="Salva">
                        </div>
