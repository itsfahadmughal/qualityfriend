    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Impostazioni</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                <div class="row   setting_title mobile-container-pl-75 pr-0">
                    <div class="col-md-2 p-3 ml-2 mt-2">
                        <h4 class="text-white font-size-title">Impostazioni</h4>
                    </div>
                </div>
                <!-- ============================================================== -->
                <!-- Container fluid  -->
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myModalLabel"><i class="fa fa-language"></i> Cambia lingua</h4>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info waves-effect"  onclick="update_language()">Salva</button>
                                ...
                                <div id="welcome_note" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"  >
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title black_color" id="myModalLabel"><i class="fa fa-sticky-note"></i> Crea il testo di benvenuto<br><small>Lunghezza massima ccnsigliata del testo 300 caratteri</small></h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                    ...
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="welcome_en" role="tabpanel">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <h6 class="font-weight-title black_color mb-1">Lunedi <small>(Predefinito se gli altri giorni sono vuoti.)</small></h6>
                                                                        <input type="text" value="<?php if(trim($mon_text) == ""){echo "I wish you a nice day.";}else{echo $mon_text;} ?>" id="mon_note_id" class="form-control mb-2" placeholder="Inserisci Nota" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Martedì</h6>
                                                                        <input type="text" value="<?php echo $tue_text; ?>" id="tue_note_id" class="form-control mb-2" placeholder="Inserisci Nota" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Mercoledì</h6>
                                                                        <input type="text" id="wed_note_id" value="<?php echo $wed_text; ?>" class="form-control mb-2" placeholder="Inserisci Nota" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Giovedì</h6>
                                                                        <input type="text" id="thu_note_id" value="<?php echo $thu_text; ?>" class="form-control mb-2" placeholder="Inserisci Nota" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Venerdì</h6>
                                                                        <input type="text" id="fri_note_id" value="<?php echo $fri_text; ?>" class="form-control mb-2" placeholder="Inserisci Nota" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Sabato</h6>
                                                                        <input type="text" id="sat_note_id" value="<?php echo $sat_text; ?>" class="form-control mb-2" placeholder="Inserisci Nota" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Domenica</h6>
                                                                        <input type="text" id="sun_note_id" value="<?php echo $sun_text; ?>" class="form-control mb-2" placeholder="Inserisci Nota" maxlength="300">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane" id="welcome_it" role="tabpanel">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <h6 class="font-weight-title black_color mb-1">Lunedi <small>(Predefinito se gli altri giorni sono vuoti.)</small></h6>
                                                                        <input type="text" id="mon_note_id_it" value="<?php if(trim($mon_text_it) == ""){echo "Ti auguro una buona giornata.";}else{echo $mon_text_it;} ?>" class="form-control mb-2" placeholder="Inserisci Nota in italiano" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Martedì</h6>
                                                                        <input type="text" id="tue_note_id_it" value="<?php echo $tue_text_it; ?>" class="form-control mb-2" placeholder="Inserisci Nota in italiano" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Mercoledì</h6>
                                                                        <input type="text" id="wed_note_id_it" value="<?php echo $wed_text_it; ?>" class="form-control mb-2" placeholder="Inserisci Nota in italiano" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Giovedì</h6>
                                                                        <input type="text" id="thu_note_id_it" value="<?php echo $thu_text_it; ?>" class="form-control mb-2" placeholder="Inserisci Nota in italiano" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Venerdì</h6>
                                                                        <input type="text" id="fri_note_id_it" value="<?php echo $fri_text_it; ?>" class="form-control mb-2" placeholder="Inserisci Nota in italiano" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Sabato</h6>
                                                                        <input type="text" id="sat_note_id_it" value="<?php echo $sat_text_it; ?>" class="form-control mb-2" placeholder="Inserisci Nota in italiano" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Domenica</h6>
                                                                        <input type="text" id="sun_note_id_it" value="<?php echo $sun_text_it; ?>" class="form-control mb-2" placeholder="Inserisci Nota in italiano" maxlength="300">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="tab-pane" id="welcome_de" role="tabpanel">
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <h6 class="font-weight-title black_color mb-1">Lunedi <small>(Predefinito se gli altri giorni sono vuoti.)</small></h6>
                                                                        <input type="text" id="mon_note_id_de" value="<?php if(trim($mon_text_de) == ""){echo "ich wünsche Dir einen schönen Tag.";}else{echo $mon_text_de;} ?>" class="form-control mb-2" placeholder="Inserisci la nota in tedesco" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Martedì</h6>
                                                                        <input type="text" id="tue_note_id_de" value="<?php echo $tue_text_de; ?>" class="form-control mb-2" placeholder="Inserisci la nota in tedesco" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Mercoledì</h6>
                                                                        <input type="text" id="wed_note_id_de" value="<?php echo $wed_text_de; ?>" class="form-control mb-2" placeholder="Inserisci la nota in tedesco" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Giovedì</h6>
                                                                        <input type="text" id="thu_note_id_de" value="<?php echo $thu_text_de; ?>" class="form-control mb-2" placeholder="Inserisci la nota in tedesco" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Venerdì</h6>
                                                                        <input type="text" id="fri_note_id_de" value="<?php echo $fri_text_de; ?>" class="form-control mb-2" placeholder="Inserisci la nota in tedesco" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Sabato</h6>
                                                                        <input type="text" id="sat_note_id_de" value="<?php echo $sat_text_de; ?>" class="form-control mb-2" placeholder="Inserisci la nota in tedesco" maxlength="300">
                                                                        <h6 class="font-weight-title black_color mb-1">Domenica</h6>
                                                                        <input type="text" id="sun_note_id_de" value="<?php echo $sun_text_de; ?>" class="form-control mb-2" placeholder="Inserisci la nota in tedesco" maxlength="300">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-info waves-effect"  onclick="update_welcome_note()">Salva</button>
                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                ...
                                <div class="tab-pane active" role="tabpanel" id="list">
                                    <div class="row pt-4 ml-4 mm-0 wm-96">
                                        ...
                                        <div class="col-lg-5 col-xlg-5 col-md-5 div-white-background p-4">
                                            <div class="row">
                                                <div  class="col-lg-12 col-xlg-12 col-md-12 mr-2 black_color">
                                                    <h3 class="font-weight-title">Utenti &amp; teams</h3>
                                                </div>
                                                ...
                                                <div  class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer" onclick="setting('user')">
                                                    <div class="row"> 
                                                        ...
                                                        <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                            <h4 class="pt-3 black_color" >Gestisci gli utenti</h4>
                                                            <h6>Crea, modifica ed elimina utenti</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div  class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                    ...
                                                    <div class="row"> 
                                                        ...
                                                        <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                            <h4 class="pt-3 black_color" >Gestisci team/dipartimenti</h4>
                                                            <h6>Crea, modifica ed elimina team/dipartimento</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div  class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                    ...
                                                    <div class="row"> 
                                                        ...
                                                        <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                            <h4 class="pt-3 black_color" >Gestisci le regole</h4>
                                                            <h6>Crea, modifica ed elimina le regole dell'utente</h6>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-5 col-xlg-5 col-md-5 div-white-background p-4 ml-3 mm-0 mtbm-20">
                                            <div  class="col-lg-12 col-xlg-12 col-md-12 mr-2">
                                                <h3 class="font-weight-title black_color">Generale</h3>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                ...
                                                <div class="row"> 
                                                    ...
                                                    <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                        <h4 class="pt-3 black_color" >Nota di benvenuto</h4>
                                                        <h6>Imposta la nota di benvenuto dell'utente</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div  class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                ...
                                                <div class="row"> 
                                                    <div  class="col-lg-2 col-xl-2 col-md-3 color_icon">
                                                        <i class="pt-3 fa fa-language font-size-big "></i>
                                                    </div>
                                                    <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                        <h4 class="pt-3 black_color" >Cambia lingua</h4>
                                                        <h6>Cambia la lingua dell'hotel</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                ...
                                                <div class="row"> 
                                                    ...
                                                    <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                        <h4 class="pt-3 black_color" >Cestino</h4>
                                                        <h6>Recuperare file eliminati</h6>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php } ?>
                                            ...
                                            <div  class="col-lg-12 col-xlg-12 col-md-12 setting_div pointer"
                                                ...
                                                <div class="row"> 
                                                    ...
                                                    <div  class="col-lg-10 col-xlg-10 col-md-9">
                                                        <h4 class="pt-3 black_color" >Registro utente</h4>
                                                        <h6>Vedi l'attività del registro utente</h6>
                                                    </div>
                                                </div>
                                            </div>
            ...
            function update_welcome_note(){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        if(response == "1"){
                            Swal.fire({
                                title: 'Benarrivato Nota`s Aggiornato',
                                type: 'success',
