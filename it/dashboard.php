                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-sm-12 plm-3 pl-0 mt-1 pr-3">
                            <select class="form-control" style="background-color:#00BCEB;color:white;" onchange="change_data();" id="modules_list">
                                <option value="0" disabled selected>--Selezionare--</option>
                                ...
                                <?php  if($handbook_flag == 1){ ?><option value="tbl_handbook">Manuali</option><?php } ?>
                                <?php  if($checklist_flag == 1){ ?><option value="tbl_todolist">Todo/Checklist</option><?php } ?>
                                <?php  if($notices_flag == 1){ ?><option value="tbl_note">Appunti</option><?php } ?>
                                <?php  if($repairs_flag == 1){ ?><option value="tbl_repair">Riparazioni</option><?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-1 pr-0">
                            <button id="del_btn" hidden onclick="delete_all()" type="button" class="btn mt-2 btn-danger mb-3 pl-3 pr-3">Eliminare</button>
                        </div>
                    </div>
                                        ...
                                        <table class=" tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="stack"
                                            ...
                                            <thead class="text-center">
                                                <tr>
                                                    ...
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border mobile_display_none text-center" ><b> Creatore</b></th>
                                                    <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="2" class="border mobile_display_none text-center" ><b> Coinvolti</b></th>
                                ...
                                $result_sub4 = $conn->query($sql_sub4);
                                                ...
                                                <tr id="alert_<?php echo $row[0];?>" class="<?php echo "$check_complate"; ?>" >
                                                    <td class="text-center" onclick="add_del('<?php echo $row[0]; ?>')"><b><?php echo $row['alert_message']; ?></b><br><div class="label pl-4 pr-4 label-table btn-info cursor-pointer" onclick="redirect_url('<?php if($row['id_table_name'] == "tbl_handover"){ echo 'handover_detail.php?id='.$row[2];}else if($row['id_table_name'] == "tbl_repair"){ echo 'repair_detail.php?id='.$row[2];}else if($row['id_table_name'] == "tbl_note"){ echo 'notice_detail.php?id='.$row[2];}else if($row['id_table_name'] == "tbl_handbook"){ echo 'handbook_detail.php?id='.$row[2]; }else if($row['id_table_name'] == "tbl_todolist"){ echo 'todo_check_list_detail.php?id='.$row[2]; }else if($row['id_table_name'] == "tbl_applicants_employee"){ echo 'application_detail.php?id='.$row[2]; }else if($row['id_table_name'] == "tbl_create_job"){echo 'jobs.php'; }else if($row['id_table_name'] == "tbl_shifts" || $row['id_table_name'] == "tbl_shift_events"){echo 'my_schedules.php'; }else if($row['id_table_name'] == "tbl_time_off"){echo 'off_time.php?slug=flag'; }else if($row['id_table_name'] == "tbl_shift_offer"){echo 'shift_pool.php'; }else if($row['id_table_name'] == "tbl_shift_trade"){echo 'shift_pool.php'; } ?>');">
                                                        ...
                                                        <?php if($row['id_table_name'] == "tbl_handover"){ echo 'Handover';}else if($row['id_table_name'] == "tbl_repair"){ echo 'Riparazioni';}else if($row['id_table_name'] == "tbl_note"){ echo 'Notizie';}else if($row['id_table_name'] == "tbl_handbook"){ echo 'Manuali'; }else if($row['id_table_name'] == "tbl_todolist"){ echo 'Todolist'; }else if($row['id_table_name'] == "tbl_applicants_employee"){ echo 'Recruiting'; }else if($row['id_table_name'] == "tbl_create_job"){echo 'Recruiting'; }else if($row['id_table_name'] == "tbl_shifts"){echo 'Orari'; }else if($row['id_table_name'] == "tbl_time_off"){echo 'Tempo libero'; }else if($row['id_table_name'] == "tbl_shift_events"){echo 'Eventi'; }else if($row['id_table_name'] == "tbl_shift_offer"){echo 'Turno offerto'; }else if($row['id_table_name'] == "tbl_shift_trade"){echo 'Commercio a turni'; } ?></div></td>
                                                    ...
                                                    <td class="text-center dashboard_action_border">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                <a class="dropdown-item" href="javascript:void(0);" onclick="delete_alert('<?php echo $row[0]; ?>')">Elimina</a>

                                                                <?php if($row['id_table_name'] == "tbl_handover"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_handover','status_id','<?php if($status == "Completed"){echo "6";}else{echo "8";} ?>','hdo_id')"><?php if($status == "Completed"){echo "Fatto";}else{echo "Segna come completato";} ?></a> <?php }else 

                                                            if($row['id_table_name'] == "tbl_repair"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_repair','status_id','<?php if($status == "Completed"){echo "6";}else{echo "8";} ?>','rpr_id')"><?php if($status == "Completed"){echo "Fatto";}else{echo "Segna come completato";} ?></a> <?php }else

                                                                if($row['id_table_name'] == "tbl_todolist"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_todolist','status_id','<?php if($status == "Completed"){echo "6";}else{echo "8";} ?>','tdl_id')"><?php if($status == "Completed"){echo "Fatto";}else{echo "Segna come completato";} ?></a> <?php }else

                                                                    if($row['id_table_name'] == "tbl_shifts"){ ?> <a class="dropdown-item" href="javascript:void(0);" onclick="change_status_completed('<?php echo $row[2]; ?>','tbl_shifts','is_completed','<?php if($status == "Completato"){echo "0";}else{echo "1";} ?>','sfs_id')"><?php if($status == "Completato"){echo "Fatto";}else{echo "Segna come completato";} ?></a> <?php } ?>
