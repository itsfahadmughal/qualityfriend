                                ...
                                <div class="chat-main-box">
                                        ...
                                        <div class="card-body border-top">
                                            <div class="row">
                                                <div class="col-12 text-center mt-5 pt-5">
                                                    ...
                                                    <p>Invia e ricevi messaggi su web e app mobile.</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="chat-right-aside"  id="Ok">
                                        <div class="chat-main-header">
                                            <div class="p-3 b-b">
                                                <h4 class="box-title">Messaggio di chat</h4>
                                            </div>
                                        </div>
                                        <div class="chat-rbox">
                                        ...
                                        <div class="card-body border-top">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 wm-58 text-left">
                                                    <textarea onkeyup="EnableDisable(this)"  id="msg" placeholder="Messaggio" class="form-control border-0"></textarea>
                                                </div>
