    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Manuali Dettaglio</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Manuali Dettaglio</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Manuali</a></li>
                                    <li class="breadcrumb-item text-success">Manuali Dettaglio</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div id="print_div">
                        ...
                        <div class="row">
                            ...
                            for ($x = 0; $x < sizeof($dep_array); $x++) {
                                    ...
                                    <div class="col-lg-12 col-xlg-12 col-md-12">
                                        <?php if($is_active == 1){ ?>
                                        <button  onclick="changeStatus('0')" type="button" class="btn mt-4 btn-secondary">Contrassegna come disattivato</button>
                                        <?php } else {?>
                                        <button onclick="changeStatus('1')" type="button" class="btn mt-4 btn-secondary">Contrassegna come attivo</button>
                                        <?php }?>
                                    </div>
                                    <?php } ?>
                                </div>
