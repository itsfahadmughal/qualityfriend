    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Collaboratori</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        ...
                        <div class="col-md-3 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Collaboratori</h5>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Collaboratori</li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                    <h4 class="card-title">Lista dei Collaboratori</h4>
                                    <h6 class="card-subtitle"></h6>
                                    <button type="button" class="btn btn-secondary m-t-10 mb-2 float-right" data-toggle="modal" data-target="#add-contact">Aggiungere Collaboratori</button>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    ...
                                                                    <input type="text" disabled hidden class="form-control" id="m_employee_id" placeholder="">
                                                                ...
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    ...
                                                                    <div  id="div_first_name_c" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_first_name_c" class="form-control-feedback display_none">Il nome è obbligatorio</small>
                                                                    </div>

                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    <div  id="div_last_name_c" class="form-group ">
                                                                        <input onkeyup="error_handle_c('last_name')" type="text" class="form-control" id="last_name_m"  placeholder="Cognome*" >
                                                                        <small id="error_msg_last_name_c" class="form-control-feedback display_none">Il cognome è obbligatorio</small>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">

                                                                    <div  id="div_email_c" class="form-group ">
                                                                        <input  onkeyup="error_handle_c('email')" type="email" class="form-control" id="email_m"  placeholder="E-mail*">
                                                                        <small id="error_msg_email_c" class="form-control-feedback display_none">L'e-mail è richiesta</small>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_department_c" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_department_c" class="form-control-feedback display_none"> 
                                                                            Dipartimento è richiesto</small> 
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 m-b-20">
                                                                    <div id="div_role_c" class="form-group ">
                                                                        ...
                                                                        <small id="error_msg_role_c" class="form-control-feedback display_none"> Il ruolo è richiesto</small> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div id="add-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="myModalLabel">Aggiungere Collaboratori</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                </div>
                                                <div class="modal-body">
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="form-group">
                                                            <h4 class="display-inline">Seleziona Titolo: </h4>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    ...
                                                                    <div  id="div_first_name" class="form-group ">
                                                                        <input onkeyup="error_handle('first_name')" type="text" class="form-control form-control-danger" id="first_name" placeholder="Nome di battesimo">
                                                                        <small id="error_msg_first_name" class="form-control-feedback display_none">Il nome è obbligatorio</small> </div>

                                                                </div>
                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_last_name" class="form-group ">
                                                                    <input onkeyup="error_handle('last_name')" type="text" class="form-control form-control-danger" id="last_name"  placeholder="Cognome*"> 
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_email" class="form-group ">
                                                                    ...
                                                                    <input onkeyup="error_handle('email')" type="text" class="form-control" id="email"  placeholder="E-mail" class="form-control form-control-danger" > 

                                                                    <small id="error_msg_email" class="form-control-feedback display_none">L'e-mail è richiesta</small></div>
                                                            ...
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <div id="div_phane_name" class="form-group ">
                                                                    ...
                                                                    <input onkeyup="error_handle('phone')" type="text" id="phone" class="form-control form-control-danger" placeholder="Telefono"> 

                                                                    <small id="error_msg_phone" class="form-control-feedback display_none">Il telefono è richiesto</small> </div>
                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div id="div_department" class="form-group ">
                                                                    ...
                                                                    <small id="error_msg_department" class="form-control-feedback display_none"> Dipartimento è richiesto</small> </div>
                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                ...
                                                                <div  id="div_date_of_birth" class="form-group ">
                                                                    ...
                                                                    <input onchange="error_handle('dob')" onkeyup="error_handle()" id="dob" type="date" class="form-control form-control-danger" placeholder="Date of Birth"> 

                                                                    <small id="error_msg_date_of_birth" class="form-control-feedback display_none">È richiesto il D.O.B</small> </div>

                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div  id="div_place_of_birth" class="form-group ">

                                                                    <input onkeyup="error_handle('pob')" type="text" id="dob_place" class="form-control form-control-danger" placeholder="Luogo di nascita"> 

                                                                    <small id="error_msg_place_of_birth" class="form-control-feedback display_none">È richiesto il luogo di nascita</small> </div>
                                                            </div>


                                                            <div class="col-md-12 m-b-20">
                                                                <div  id="div_tax" class="form-group ">
                                                                    <input onkeyup="error_handle('tax')" type="text" class="form-control form-control-danger" id="tax_number" placeholder="Codice Fiscale"> 
                                                                    <small id="error_msg_tax" class="form-control-feedback display_none">Il codice fiscale è obbligatorio</small> </div>


                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <div  id="div_date_of_joining" class="form-group ">
                                                                    <small  class="text-muted">Data di adesione</small>
                                                                    <input onchange="error_handle('doj')" type="date" id="start_working_time" class="form-control" placeholder="Date of joining"> 
                                                                    <small id="error_date_of_joining" class="form-control-feedback display_none">La data di adesione è obbligatoria</small> </div>

                                                            </div>
                                                            <div class="col-md-12 m-b-20">
                                                                <h5>Carica l'immagine</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-info waves-effect"  onclick="addapplicant()">Salva</button>
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Annulla</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        ...
                                        <table id="demo-foo-addrow" class="shift_pool_tables table table-bordered m-t-30 table-hover contact-list" data-paging="true" data-paging-size="25">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Telefono</th>
                                                    <th>Dipartimento</th>
                                                    <th>Stato <small class="text-muted">(as an user)</small></th>
                                                    <th>Stato <small class="text-muted">(come collaboratore)</small></th>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td><div class="btn-group">
                                                        <span id="thisstatus<?php echo $i; ?>" class="dropdown-toggle label
                                                            ...
                                                            <?php   echo "Attualmente funzionante"; ?>
