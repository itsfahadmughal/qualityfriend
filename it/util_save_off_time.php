...
if ($result_check && $result_check->num_rows > 0) {
    ...
    if($result){
        ...
        if ($Create_view_schedules == 1 || $usert_id == 1) { 
            $alert_msg = "Malattia Caranovic aggiunta (";
        }else{
            $alert_msg = $message." Tempo di riposo richiesto da (";
        }
        ...
        echo '1';
        $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','Tempo libero Aggiunto','$hotel_id','$entry_time')";
