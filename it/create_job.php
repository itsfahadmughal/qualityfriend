...
<html lang="en">
    ...
    <head>
        ...
        <title>Creare annuncio di lavoro</title>
    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Creare annuncio di lavoro</p>
            </div>
        </div>
        <!-- ============================================================== -->
...
<h4 class="text-themecolor font-weight-title font-size-title">Creare annuncio di lavoro</h4>
</div>
...
-->
                    ...
                    <div class="mobile-container-padding">
                        <div class="row page-titles mb-3 heading_style">
                            <div class="col-md-5 align-self-center">
                                <h5 class="text-themecolor font-weight-title font-size-title mb-0">Creare annuncio di lavoro</h5>
                            </div>
                            <div class="col-md-7 align-self-center text-right">
                                <div class="d-flex justify-content-end align-items-center">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Recruiting</a></li>
                                        <li class="breadcrumb-item text-success">Creare annuncio di lavoro</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="tab-pane active" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-9 col-xlg-9 col-md-9 pt-4"> 
                                                    ...
                                                    <input type="text" id="title_id" class="form-control" placeholder="Titolo">
                                                    <div class="row pt-4">
                                                        <div class="col-lg-6 col-xlg-6 col-md-6">
                                                            <h4 class="font-weight-title">Selezionare Dipartimento*</h4>
                                                    ...
                                                    <input type="button" id="saveasdraft_job_id" onclick="save_job('DRAFT');" class="btn mt-4 w-20 btn-secondary" value="Salva come bozza">
                                                    <input type="submit" id="create_job_id" onclick="save_job('CREATE');" class="btn mt-4 ml-3 w-20 btn-info" value="Creare">
                                                ...
                                                <div class="col-lg-3 col-xlg-3 col-md-3 pt-4"> 
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="card-title">Aggiungi foto per annuncio di lavoro <small>(Altezza:400-500 pixel, Larghezza:1200-1500 pixel)</small></h4>
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == '1' || response == '3' ){
                                Swal.fire({ 
                                    title: 'Lavoro creato con successo',
                                    type: 'success',
