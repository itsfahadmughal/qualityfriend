                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body pm-0 small-screen-pr-0 mobile-container-pl-60">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="myModalLabel">Crea una nuova canalizzazione</h4>
                                                    ...
                                                    <from class="form-horizontal" onsubmit="event.preventDefault();">
                                                        <div class="row">
                                                            <div class="col-lg-12 col-xlg-12 col-md-12">
                                                                <input type="text" class="form-control" id="add_funnel" placeholder="Crea nome"> 
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button onclick="create_new_funnel()" type="button" class="btn btn-info waves-effect" >Creare</button>
                                                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancella</button>
                                                </div>
                                            </div>
                                            <!-- /.modal-content -->
                                        </div>
                                    ...
                                    <button data-toggle="modal" data-target="#add-contact" type="button" class="btn mt-4 btn-secondary">Creae un funnel</button>
