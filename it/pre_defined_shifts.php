    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Turni predifiniti</p>
            </div>
        </div>
        <!-- ============================================================== -->
            ...
            <div class="page-wrapper">
                ...
                <div class="container-fluid pb-0 mobile-container-padding">
                    ...
                    <div class="row page-titles heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Turni predifiniti</h4>
                        </div>
                    </div>
                ...
                <div class="row mt-5 mtm-0">
                    ...
                    <div class="col-lg-6 right-border-div pr-5 pl-5">
                        <span class="cursor-pointer" onclick="history.back();"><i class="fas fa-chevron-left pr-1"></i> Orari</span>

                        <div class="mt-4">
                            <h3>Aggiungere turno predifinito</h3>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-12">
                                <div class="form-group mb-0">
                                    <label class="control-label display-inline w-30"><strong>Nome</strong></label>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <select class="form-control" id="depart_select" data-style="form-control btn-secondary mt-1">
                                        <option value="0">Selezionare Dipartimento</option>
                                        <?php
                                ...
                                <div class="form-group mb-0">
                                    <label class="control-label display-inline w-30 wm-38"><strong>Ora di inizio</strong></label>
                                    <i class="fas pl-1-8 pr-3"></i>
                                    <label class="control-label display-inline w-30 wm-38"><strong>Tempo scaduto</strong></label>
                                </div>
                                <div class="form-group mb-0">
                                    ...
                                    <label class="control-label ml-1 mtm-10">Pausa <small>(min)</small></label>
                                ...
                                <div class="form-group ml-1 mb-0 mt-1">
                                    <label class="control-label mb-0"><i class="far fa-clock"></i> <span id="hours_from_to"><?php echo round($total_hours+($break_min/60),2); ?></span> Ore</label>
                                </div>
                            </div>
                        </div>

                        <div class="mt-3">
                            <label class="control-label"><strong>Note di spostamento</strong></label>
                            <textarea rows="4" class="form-control" id="message_"><?php echo $message; ?></textarea>
                        </div>

                        <div class="mt-3 mb-5 pb-5 pbm-0 mbm-0">
                            <input type="button" onclick="submit_pre_defined_shift();" class="btn mt-4 w-100 btn-info" value="Salvas">
                        </div>
                    ...
                    <div class="col-lg-6 pr-5 pl-5">
                        ...
                        <div class="table-responsive">
                            <table id="demo-foo-addrow" class="table table-bordered m-t-30 table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                <thead>
                                    <tr>
                                        <th class="" >Predefinire il nome del turno</th>
                                        <th class="" >Tempo di spostamento</th>
                                        <th class="mobile_display_none" >Rottura (Min)</th>
                                        <th class="mobile_display_none" >Ore lavorative</th>
                                        <th class="mobile_display_none" >Appunti</th>
                                        <th class="mobile_display_none" >Dipartimento</th>
                        ...
                        <h5 class="text-center"><b>Turni non trovati.</b></h5>
                        <?php } ?>
        ...
        <script>
            ...
            function set_time(){
                ...
                if(from_time < to_time){
                    ...
                    alert("Seleziona Ora di fine maggiore.");
            ...
            function submit_pre_defined_shift(){
                ...
                if(shift_name = "" || start_time == "" || end_time == "" || depart_id_ == 0){
                    alert("Tutti i campi devono essere compilati tranne le note di turno.");
                }else{
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                Swal.fire({
                                    title: 'Turno predefinito salvato.',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Salvato'
                                }).then((result) => {
                                    if (result.value) {
