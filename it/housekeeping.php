                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Housekeeping
                    ...
                    <div class="row">
                        ...
                        <div id="open_model" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <!--Add Team-->
                                        <h4 class="modal-title" id="myModalLabel">Elenco delle attività</h4>
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active"  role="tabpanel">
                                                    <div class="form-group">
                                                        <div class="col-md-12 m-b-20 mt-2"  id="inner_task" >
                                            ...
                                            <div class="row mt-5 pt-5 mtm-0">
                                                ...
                                                <div  id="" class="col-lg-4  col-md-4 wm-50 mt-3">
                                                    <div class="row">
                                                        ...
                                                        <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                            <span><b>Pulizia in corso</b></span>
                                                ...
                                                <div  id="" class="col-lg-4  col-md-4 wm-50 mt-3">
                                                    <div class="row">
                                                        ...
                                                        <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                            <span><b>Ispezione in corso</b></span>
                                                ...
                                                <div  id="" class="col-lg-4  col-md-4 wm-50 mt-3">
                                                    <div class="row">
                                                        ...
                                                        <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                            <span><b>Nessuna pulizia desiderata</b></span>
                    ...
                    <div class="row pl-3 pr-3 heading_style pt-3 pb-3 mbm-20">
                        ...
                        <div class="col-lg-12  col-md-12">
                            <h3 class="mt-3">Oggi Lavoro Extra</h3> 
                            <div class="row" >
                                <?php
