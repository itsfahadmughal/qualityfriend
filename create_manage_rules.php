    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Manage Rules</p>
            </div>
        </div>
                ...
                <div class="container-fluid mobile-container-pl-75 pr-0" id="mcontainer">
                    ...
                    <div class="row page-titles pb-0">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Manage Rules</h4>
                        </div>
                        <div class="col-md-7">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_add" class="form-group ">
                                                                        <input onkeyup="error_handle()" type="text" class="form-control" id="user_type_name"  placeholder="Enter User Type" required> 

                                                                        <small id="error_msg_add" class="form-control-feedback display_none">Required Field</small> </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-info waves-effect"  onclick="save_user_type()">Save</button>
                                ...
                                <div id="edit-contact" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-12 m-b-20 mt-2">
                                                                    <div  id="div_edit" class="form-group ">
                                                                        <input onkeyup="error_handle_edit()" type="text" class="form-control" id="user_type_name_edit"  placeholder="Enter User Type" required> 
                                                                        <small id="error_msg_edit" class="form-control-feedback display_none">Required Field</small> </div>
                                                                    <input type="text" hidden class="form-control" id="type_id_edit"  placeholder="Enter Team Name" required>
                                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-info waves-effect"  onclick="save_edit_user_type()">Save</button>
                                                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                                ...
                                                <div class="form-group col-lg-12 col-xlg-12 col-md-12" >
                                                    <div class="row div-background p-4">
                                                        <div class ="col-lg-10 col-xlg-10 col-md-10" id="">
                                                            <label class="control-label"><strong>User Types</strong></label>
                                                        </div>
                                                                            ...
                                                                            <div class='col-lg-1 col-xlg-1 col-md-2 pt-3 wm-15'>
                                                                                <a  data-toggle="modal" data-target="#edit-contact" href=""
                                                                                   onclick='edit_usertype("<?php echo $user_type_array[$x]; ?>","<?php echo $usert_id_array[$x]; ?>")' >
                                                                                    <img class="mw-40p" src="./assets/images/edit.png" alt="Girl in a jacket">
                                                                                </a>
                                                                            </div> 
                                                                            <div class='col-lg-1 col-xlg-1 col-md-2 pt-3 wm-15 plm-5px'>
                                                                                <img class="mw-40p" id='$x' onclick='del("<?php echo $usert_id_array[$x]; ?>")' type='button' class='' data-dismiss='modal' aria-hidden='true' src="./assets/images/cross.png" alt="">
                                                                            </div> 
                                                                            <?php }?>
                                                                        </div>
                                                                        <?php if($usert_id_array[$x] != 1){?>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                    <div class="row div-background p-4 pm-1rem">
                                                        <div class="form-group col-lg-12 col-xlg-12 col-md-12">
                                                            <label class="control-label"><strong>Rules</strong></label>
                                                        </div>
                                                        <div class="form-group col-lg-12 col-xlg-12 col-md-12 div-white-background">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Create and edit todo/checklist</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Create and edit handbooks</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Create and edit handovers</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="active_id" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Edit users, teams and departments</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Send and Receive messages</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="" type="checkbox" 
                                                        ...
                                                        <div class="form-group col-lg-12 col-xlg-12 col-md-12 div-white-background">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Create,view and edit applications</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="active_id" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Create,view and edit employees</h5>
                                                                </div>
                                                                <div class="col-lg-1 col-xlg-1 col-md-1 pl-3 pb-3 wm-10">
                                                                    <div class="checkbox checkbox-success">
                                                                        <input  id="active_id" type="checkbox" 
                                                                ...
                                                                <div class="col-lg-11 col-xlg-11 col-md-11  pb-3 wm-90">
                                                                    <h5>Create and edit working time</h5>
                                                                </div>
                                                            </div>
