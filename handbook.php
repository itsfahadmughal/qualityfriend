    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Handbook</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Handbook</h4>
                        </div>
                        ...
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Handbook</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-2 col-md-3 mt-2 mb-3">
                            ...
                            <a href="create_handbook.php" class="btn btn-secondary d-lg-block "><i class="fa fa-plus-circle"></i> Create Handbook</a>
                            <?php } ?>
                        </div>
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                if($row['title'] != ""){
                                    ...
                                    $title = "";
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="text-center"><b><?php echo $title; ?></b><br><div onclick="go(<?php echo $hdb_id; ?>)" class="label pl-4 pr-4 label-table btn-info cursor-pointer ">Handbook</div></td>
                                ...
                                echo $is_active;?></div></td>
                                                    ...
                                                    <td class="text-center" >
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu animated flipInY">
                                                                ...
                                                                <a class="dropdown-item" href="handbook_detail.php?id=<?php echo $row['hdb_id']; ?>">View</a>
                                                                <a class="dropdown-item" href="edit_handbook.php?id=<?php echo $row['hdb_id']; ?>">Edit</a>
                                                ...
                                                <div class="col-lg-12 col-xlg-12 col-md-12 mt-5">
                                                    <h1 class="text-center pt-5 pb-5">Handbooks Not Found</h1>
                                                </div>
                                                <?php
                        }
                                                ?>
