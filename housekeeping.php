...
<html lang="en">
    ...
    <body class="skin-default-dark fixed-layout">
                ...
                <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 ">
                                            <div class="row mt-5 pt-5 mtm-0">
                                                ...
                                                <div  id="" class="col-lg-4  col-md-4 mtm-20 wm-50">
                                                    <div class="row">
                                                        <div  id="" class="col-lg-2  col-md-2 center_div1 wm-20">
                                                ...
                                                <div  id="" class="col-lg-4  col-md-4 mt-3 wm-50">
                                                    <div class="row">
                                                        <div  id="" class="col-lg-2  col-md-2 center_div1 wm-20">
                                                            <div class="box_cleaning_in_progress"></div>
                                                        </div>
                                                        <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                            <span><b>Cleaning in progress</b></span>
                                                ...
                                                <div  id="" class="col-lg-4  col-md-4 mt-3 wm-50">
                                                    <div class="row">
                                                        ...
                                                        <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                            <span><b>Inspection in progress</b></span>
                                                ...
                                                <div  id="" class="col-lg-4  col-md-4 mt-3 wm-50">
                                                    <div class="row">
                                                        ...
                                                        <div  id="" class="col-lg-10  col-md-10 wm-80">
                                                            <span><b>No cleaning desired</b></span>
                    ...
                    <div class="row pl-3 pr-3 heading_style pt-3 pb-3 mbm-20">
                        ...
                        <div class="col-lg-12  col-md-12">
                            <h3 class="mt-3">My Today Extra Jobs</h3> 
                            <div class="row" >
                                <?php
        ...
        <script>
            ...
            //            var inner_checks = document.getElementById("room_checks");
            //            inner_checks.innerHTML = "";
            //            for (let i = 0; i < checks_array.length; i++) {
            //                inner_checks.innerHTML += "<h5><b>"+checks_array[i]+"</b></h5>";
            //            }
        </script>
        <script>
