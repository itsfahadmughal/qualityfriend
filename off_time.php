...
<html lang="en">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-9 text-right">
                            <label class="btn btn-dark">
                                ...
                                <label class="mb-0" for="md_checkbox_22">&nbsp;Enable Off Time For Users</label>
                            </label>
                        </div>
                        <?php } ?>
                    </div>
                            ...
                            <div class="card-body pm-0">
                                <div class="vtabs customvtab">
                                    <ul class="nav nav-tabs tabs-vertical" role="tablist">
                                        <li class="nav-item w-150-custom"> <a class="nav-link active" data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-pool"></i></span> <span class="hidden-xs-down">Requests</span> </a> </li>
                                        <li class="nav-item w-150-custom" onclick="showCalendar();"> <a class="nav-link" data-toggle="tab" href="#profile3" role="tab"><span class="hidden-sm-up"><i class="fas fa-hand-holding"></i></span> <span class="hidden-xs-down">Calendar</span></a> </li><?php   if ($Create_view_schedules == 1 || $usert_id == 1) { ?>
                                        <li class="nav-item w-150-custom"> <a class="nav-link" data-toggle="tab" href="#messages3" role="tab"><span class="hidden-sm-up"><i class="fas fa-dollar-sign"></i></span> <span class="hidden-xs-down">Holidays</span></a> </li> <?php } ?>
                                    </ul>
                                    <!-- Tab panes -->
                                        ...
                                        <div class="tab-pane active" id="home3" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 pm-0">
                                                    <h3 class="mb-5 mbm-20"><b>Requests</b><button type="button" onclick="location.href = 'add_time_off.php';" class="btn btn-success f-right"><i class="fas fa-plus"></i> <?php   if ($Create_view_schedules == 1 || $usert_id == 1) {echo 'Add';}else{echo 'Request';} ?> time off</button></h3>

                                                    <?php   if ($Create_view_schedules == 1 || $usert_id == 1) { }else{?>
                                                    <div class="row mb-3 p-3 border-timeoff">
                                                        <div class="col-lg-4 text-center">
                                                            <h3>Unpaid Time Off</h3>
    ...
    }?></h2> <h5 class="display-inline">hours</h5>
                                                            <p class="mb-0">Approved (YTD)</p>
                                                        </div>
                                                        <div class="col-lg-4 text-center">
                                                            <h3>Paid Time Off</h3>
                                                            <h2 class="display-inline"><?php
                ...
                $username = $row[2];
                                                        ...
                                                        <div class="col-lg-6 mtm-10">
                                                            <select id="select3" onchange="apply_filter('status');" class="form-control custom-select wm-250px">
                                                                ...
                                                                <option value='APPROVED' <?php if($sts == 'APPROVED'){echo 'selected';}else{echo '';} ?> >Approved</option>
                                                                <option value='DECLINE' <?php if($sts == 'DECLINE'){echo 'selected';}else{echo '';} ?>>Decline</option>
                                                                <option value='PENDING' <?php if($sts == 'PENDING'){echo 'selected';}else{echo '';} ?>>Pending</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <table id="demo-foo-addrow" class="shift_pool_tables wm-100 table table-bordered table-hover contact-list table-striped" data-paging="true" data-paging-size="25">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th class="">Time off requested</th>
                                                        ...
                                                        while ($row = mysqli_fetch_array($result)) {
                                                            ...
                                                            $nn++;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $row['category']; ?><br>
                                                                        <small><?php echo $row['total_hours']; ?> hours approved(YTD)</small></td>
                                                                    <td><?php echo date("F d, Y", strtotime($row['date'])); ?></td>
                                                                    <td class="font-size-subheading  text-center black_color">
                                                                        <?php   if ($Create_view_schedules == 1 || $usert_id == 1) { ?>
                                                                        <div class="btn-group">
                                                                            <span id="offtime_status_<?php echo $row['tmeo_id'];  ?>" class="dropdown-toggle label label-table label-<?php if($row['status'] == "APPROVED"){echo 'success';}else if($row['status'] == "DECLINE"){echo 'danger';}else{ echo 'warning';} ?> pointer" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $row['status']; ?></span>
                                                                            <div class="dropdown-menu animated flipInY">
                                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="update_status('APPROVED',<?php echo $row['tmeo_id'];  ?>,'<?php echo $row['status'];  ?>');">Approved</a>
                                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="update_status('DECLINE',<?php echo $row['tmeo_id'];  ?>,'<?php echo $row['status'];  ?>');">Decline</a>
                                                                                <a class="dropdown-item" href="javascript:void(0)" onclick="update_status('PENDING',<?php echo $row['tmeo_id'];  ?>,'<?php echo $row['status'];  ?>');">Pending</a>
                                                                            </div>
                                                                        </div>
                                                                        <?php }else{ ?>
                                                                        <span class="btn w-100 btn-<?php if($row['status'] == "APPROVED"){echo 'success';}else if($row['status'] == "DECLINE"){echo 'danger';}else{ echo 'secondary';} ?> d-lg-block "><?php echo $row['status']; ?></span>
                                                                        <?php } ?>
                                                                    </td>
                                        ...
                                        <div class="tab-pane" id="profile3" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-10 pm-0">
                                                    <h3 class="mb-5"><button type="button" onclick="location.href = 'add_time_off.php';" class="btn btn-success f-right"><i class="fas fa-plus"></i> <?php   if ($Create_view_schedules == 1 || $usert_id == 1) {echo 'Add';}else{echo 'Request';} ?> time off</button></h3>
                                                    <?php if($calend==1){ ?>
                                                    <div class="m-t-30">
                                                        <div id="calendar">
                                        ...
                                        <div class="tab-pane" id="messages3" role="tabpanel">
                                            <div class="row">
                                                ...
                                                ?>
                                                <div class="col-lg-10 pm-0">
                                                    <h3><b>Holidays</b><button onclick="location.href = 'add_blocked_day.php';" type="button" class="btn btn-info f-right"><i class="fas fa-plus"></i> Add Holiday</button></h3>
                                                    <?php  
                                                    $result = $conn->query($sql_block);
                                                    if ($result && $result->num_rows > 0) {
                                                    ?>
                                                    <div class="table-responsive">
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        if(response == "Updated"){
                            ...
                            x.className = "show";
                            x.innerHTML="Your Status Successfully Updated.";
