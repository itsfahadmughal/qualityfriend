    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Repair Detail</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Repair Detail</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Repair</a></li>
                                    <li class="breadcrumb-item text-success">Repair Detail</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="row" >
                                            <div class="col-lg-12 col-xlg-12 col-md-12 div-white-background pt-3 pl-4 pb-3 pr-4">
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php if($comment !=""){ echo $comment; ?><span class="fs-11">&nbsp; commented by <b><?php echo $username; ?></b> (<?php echo $entrytime; ?>)</span> <?php }else{ echo "N/A";} ?></h4>
                            ...
                            if(sizeof($comments_arr) != 0){
                                for($i=0;$i<sizeof($comments_arr);$i++){    
                                                ...
                                                <h4 class="text-show comments_background">
                                                    ...
                                                    <?php echo $comments_arr[$i]; ?><span class="fs-11">&nbsp; commented by <b><?php echo $comment_user_arr[$i]; ?></b> (<?php echo $entrytime_arr[$i]; ?>)    <?php if($Create_edit_repairs == 1 || $usert_id == 1){ ?> <a href="javascript:void(0);" onclick="delete_comment('<?php echo $comments_id_arr[$i]; ?>')"><i class="fas fa-trash-alt red-color text-right"></i></a> <?php } ?> </span></h4>   
                                                <?php
                                }
                            }
                                                ?>
                                                ...
                                                <input type="button" id="create_job_id" onclick="change_status('activate','<?php echo $active_status ?>');" class="btn wm-45 mt-4 w-30 mw-40 btn-secondary" value="Mark as <?php if($active_status==1){echo 'Deactive';}else{echo 'Active';} ?>">

                                                <button id="saveasdraft_job_id" onclick="change_status_new('repair','<?php echo $rpr_id; ?>');"  class="btn mt-4 wm-70 w-25 ml-0 ml-3  btn-outline-<?php if($completed_status == 6){echo 'info';}else{ echo 'success';} ?>" <?php if($completed_status != 6){echo 'disabled';} ?> ><?php if($completed_status == 6){echo 'Mark As Completed';}else{echo '<i class="fa fa-check"></i> Marked As Completed';} ?></button>

                                                <?php }else  if($flag  == 1 || $flag_department == 1 ) { ?>

                                                <button id="saveasdraft_job_id" onclick="change_status_new('repair','<?php echo $rpr_id; ?>');"  class="btn mt-4 wm-70 ml-0 w-25 btn-outline-<?php if($is_completed == 0 && $completed_status == 6){echo 'info';}else{ echo 'success';} ?>" <?php if($is_completed == 0 && $completed_status == 6){echo '';}else{echo 'disabled';} ?> ><?php if($is_completed == 0 && $completed_status == 6){echo 'Mark As Completed';}else{echo '<i class="fa fa-check"></i>Marked As Completed';} ?></button>

                                                <?php }else{} ?>

                                                <button data-toggle="modal" data-target="#add-comments-contact" type="button" class="btn ml-3 w-25 wm-70 ml-0 mt-4 btn-warning"><i class="mdi mdi-plus-circle"></i>&nbsp;&nbsp;&nbsp;&nbsp;Add Comments</button>
