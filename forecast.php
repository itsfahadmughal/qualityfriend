                                ...
                                <div class="col-lg-12 forecast_green">
                                    <div class="row">
                                        <div class="col-lg-8 p-3">
                                            ...
                                            <h3 class="text-center">Pickup Last Year</h3>
                                ...
                                <div class="col-lg-12 forecast_red">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 p-3">
                                            ...
                                            <h3 class="text-center">Occupancy rate last year (OCC)</h3>
                                ...
                                <div class="col-lg-12 forecast_yellow">
                                    <div class="row">
                                        <div class="col-lg-8 p-3">
                                            ...
                                            <h3 class="text-center">Average daily rate per person Last year (ADR)</h3>
                                ...
                                <div class="col-lg-12 forecast_grey">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 p-3">
                                            ...
                                            <h3 class="text-center">Yesterday pickup last year</h3>
                                ...
                                <div class="col-lg-12 forecast_blue">
                                    <div class="row">
                                        <div class="col-lg-8 p-3">
                                            ...
                                            <h3 class="text-center">On the books (pickup last year)</h3>
                                                    ...
                                                    while ($row = mysqli_fetch_array($result_goods_data)) {
                                                        ...
                                                        if($month == date('m', strtotime($row['date']))){
                                                            ...
                                                            $cost_per_month += $row['cost'];
                                                                ?>
                                                                <tr class="forecast_light_gray_color">
                                                                    <td>Total WES per person/month</td>
                                                        ...
                                                        $mn++; }
                                                                ...
                                                                <tr class="forecast_main_color">
                                                                    <td class="text-bold"><?php echo 'Total WES per person/year'; ?></td>
