    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Edit Handover</p>
            </div>
        </div>
                ...
                <div class="container-fluid mobile-container-pl-75">
                    ...
                    <div class="row page-titles heading_style">
                        ...
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Edit Handover</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Handover</a></li>
                                    <li class="breadcrumb-item text-success">Edit Handover</li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div id="add-search_en" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row pt-2">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" id="search_en" class="form-control" placeholder="Search" value="" >
                                            </div>
                            ...
                            <div>
                                                ...
                                                <div class ="row mm-0">
                                                    ...
                                                    <div class="col-lg-12 col-xlg-12 col-md-12 pb-3"> 
                                                        ...
                                                        <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                                            ...
                                                            <label class="custom-control-label" for="non_public">Non Public</label>
                                                        </div>
                                                        <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                ...
                                <div class="row mbm-20">
                                    <div class="col-lg-12 col-xlg-12 col-md-12 pt-4"> 
                                        <input type="button" id="create_job_id" onclick="save_handover('CREATE');" class="btn mt-4 w-15 btn-secondary wm-38" value="Save Changes">
                                        <input type="button" id="saveasdraft_job_id" onclick="save_handover('DRAFT');"  class="btn mt-4 w-15 ml-3  btn-outline-info wm-30" value="Save as Draft">
                                        <input type="button" id="delete_handover_id" onclick="delete_handover('<?php echo $hdo_id; ?>');"  class="btn mt-4 w-15 ml-3  btn-outline-info wm-30" value="Delete">
                                        <input type="button" id="save_duplicate_id" onclick="duplicate_handover('<?php echo $hdo_id; ?>');"  class="btn mt-4 w-15 ml-3  btn-outline-info wm-30" value="Duplicate" >
                                        <input type="button" id="saveastemplate_job_id" onclick="save_handover('TEMPLATE');"  class="btn mt-4 w-20 ml-3  btn-outline-info wm-38" value="Save as Template">
                                        <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 ml-3 w-15 btn-outline-info btn-delete wm-38" value="Delete Template">
                                    </div>
        ...
        <script>
            ...
            function search() {
                var textareaValue = $('#description_id').summernote('code');
                var input =  document.getElementById("input").value;

                if (input !==""){
                    let regEXg = new RegExp(input,"gi");


                    $('#description_id').summernote('code', (textareaValue.textContent).replace(regEXg,"<mark>$&</mark>"));
                    //                    p.innerHTML = (p.textContent).replace(regEXg,"<mark>$&</mark>");
                }
            }
