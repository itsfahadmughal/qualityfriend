    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Create Handover</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid mobile-container-pl-75 ">
                    ...
                    <div class="row page-titles   heading_style">
                        <div class="col-md-5 align-self-center">
                            <h5 class="text-themecolor font-weight-title font-size-title mb-0">Create Handover</h5>
                        </div>
                        <div class="col-md-7 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Handover</a></li>
                                    <li class="breadcrumb-item text-success">Create Handover</li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <div class="tab-pane active" role="tabpanel">
                                    <div class="row pt-4 small-screen-mr-16">
                                        <div class="col-lg-6 col-xlg-6 col-md-6">
                                            ...
                                            <div class="div-background mt-4 p-4">
                                                ...
                                                <input type="text" id="title_id" required class="form-control" placeholder="Enter Title">
                                    ...
                                    <div class="row mbm-20">
                                        <div class="col-lg-12 col-xlg-12 col-md-12 pt-4">
                                            <input type="button" id="create_job_id" onclick="save_handover('CREATE');" class="btn mt-4 w-20 btn-secondary" value="Create">
                                            <input type="button" id="saveasdraft_job_id" onclick="save_handover('DRAFT');"  class="btn mt-4 w-20 ml-3  btn-outline-info wm-30" value="Save as Draft">
                                            <input type="button" id="template_save_id" onclick="save_handover('TEMPLATE');" class="btn mt-4 ml-3 w-20 btn-outline-info btn-template wm-38" value="Save as Template">
                                            <input type="button" id="delete_id" onclick="delete_temp()" class="btn mt-4 ml-3 wm-38 w-20 btn-outline-info btn-delete" value="Delete Template">
                                        </div>
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            if(response == "1"){
                                ...
                                Swal.fire({
                                    title: 'Handover Template Created',
                                    type: 'success',
                                    confirmButtonColor: '#3085d6',
                                    confirmButtonText: 'Ok'
                                }).then((result) => {
