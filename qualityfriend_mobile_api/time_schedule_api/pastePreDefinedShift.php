...
if(file_exists("../util_config.php") && is_readable("../util_config.php") && include("../util_config.php")) 
{
    ...
    if(isset($_POST['copied_pre_shift_id'])){
        $shift_id = $_POST['copied_pre_shift_id'];
    }
...
WHERE sfspd_id='$shift_id' and hotel_id = $hotel_id";
        ...
        if($result){
            ...
            $temp1['flag'] = 1;
            $temp1['message'] = "Pre-Defined Shift Pasted Successful.";
            ...
            $temp1['flag'] = 0;
            $temp1['message'] = "Pre-Defined Shift Not Pasted Successful.";
        }
