...
if(file_exists("../util_config.php") && is_readable("../util_config.php") && include("../util_config.php")) 
{
    ...
    if($hotel_id == "" || $hotel_id == 0 || $user_id == "" || $user_id == 0 || $from_d == "" || $to_d == "" || $message == ""|| $from_t == "" || $to_t == ""|| $holiday_type == "" || $hours_diff == ""){
        $temp1['flag'] = 0;
        $temp1['message'] = "Hotel Id, User Id, Message, From Date and To Date is Required.";
        ...
        if($result){
            ...
            $alert_msg = $message." Holiday Added.";
            ...
            $sql_log="INSERT INTO `tbl_log`(`user_id`, `log_text`, `hotel_id`, `entrytime`) VALUES ('$user_id','$message Holiday','$hotel_id','$entry_time')";
            $result_log = $conn->query($sql_log);
        }else{
            $temp1['flag'] = 0;
            $temp1['message'] = "Blocked Day Not Added!!!";
        }
