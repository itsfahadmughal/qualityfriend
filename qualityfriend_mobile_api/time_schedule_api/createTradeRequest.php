...
if(file_exists("../util_config.php") && is_readable("../util_config.php") && include("../util_config.php")) 
{
    ...
    if(isset($_POST['shift_exchange_with'])){
        $shift_to = $_POST['shift_exchange_with'];
    }
    ...
    if($hotel_id == "" || $hotel_id == 0 || $user_id == 0 || $user_id == "" || $shift_id == 0 || $shift_id == "" || $offer_to == 0 || $offer_to == "" || $shift_to == 0 || $shift_to == ""){
        $temp1['flag'] = 0;
        $temp1['message'] = "Hotel id, User id, Offer to, Shift exchange with id and Shift id is Required.";
        ...
        if($result){
            ...
            $alert_msg = $message." (Shift Trade With You)";
            ...
            $temp1['flag'] = 1;
            $temp1['message'] = "Shift Trade Request Submitted.";
            ...
            $temp1['flag'] = 0;
            $temp1['message'] = "Shift Trade Request Not Submitted!";
        }
