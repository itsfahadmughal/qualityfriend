...
if(file_exists("util_config.php") && is_readable("util_config.php") && include("util_config.php")) 
{
    ...
    //Working
    if($hotel_id != 0){
        if($completed_by != "user_completed" ){ 
            if($checklist_id == 0){

                if($Create_edit_todo_checklist  == 1 || $usert_id == 1){

                    if($last_id != 0 ){
                        $sql="SELECT a.* FROM `tbl_todolist` AS a  WHERE a.`hotel_id` = $hotel_id  AND (status_id = 8 OR status_id = 9) AND a.is_delete = 0 and a.saved_status = '$saved_status' AND tdl_id < $last_id  ORDER BY a.`entrytime` DESC  "; 
                    }else{
                        $sql="SELECT a.* FROM `tbl_todolist` AS a  WHERE a.`hotel_id` = $hotel_id AND 
                    (status_id = 8 OR status_id = 9) AND
                    a.is_delete = 0 and a.saved_status = '$saved_status' ORDER BY a.`entrytime` DESC  ";   
                    }


                }else{
                    if($last_id != 0 ){
                        $sql="SELECT DISTINCT a.* FROM `tbl_todolist` as a LEFT OUTER JOIN tbl_todolist_recipents as b on a.tdl_id=b.tdl_id  WHERE  a.`hotel_id` = $hotel_id  AND a.is_delete = 0 AND a.is_active=1 AND a.saved_status = 'CREATE' AND (a.`visibility_status` = 'PUBLIC' OR b.user_id = $user_id) AND tdl_id < $last_id ORDER BY a.`entrytime` DESC  ";
                    }else {
            ...
            if ($result && $result->num_rows > 0) {
                ...
                while($row = mysqli_fetch_array($result)) {
                    ...
                    $temp = $temp2 = $temp3 = $temp4 = $temp5 = $temp6 = $temp7 = $temp8 = $temp9 = array();
                    ...
                    if($is_completed == 1 || $status_id_org == 8 || $status_id_org == 9 ){
                        ...
                        $temp['creater_image'] = $creater_image;
                        ...
                        if ($result2 && $result2->num_rows > 0) {
                            while($row2 = mysqli_fetch_array($result2)) {
                                ...
                                $temp3 = array();
                                $sql3="SELECT a.*,b.* FROM `tbl_todolist_checklist_user_map` as a INNER JOIN tbl_user as b on a.user_id = b.user_id WHERE a.tdlclt_id = $tdlclt_id and a.user_id = $user_id";
                                ...
                                $temp2['checklist_recipients'] = $temp3;
                        ...
                        if ($result2 && $result2->num_rows > 0) {
                            while($row2 = mysqli_fetch_array($result2)) {
                                ...
                                $sql3="SELECT a.*,b.* FROM `tbl_todolist_inspection_user_map` as a INNER JOIN tbl_user as b on a.user_id = b.user_id WHERE a.tdlin_id = $tdlin_id and a.user_id = $user_id";
                                $result3 = $conn->query($sql3);
                                if ($result3 && $result3->num_rows > 0) {
                                    while($row3 = mysqli_fetch_array($result3)) {
                                        $flag_inspection = '1';
                                ...
                                $temp7['inspection_recipients'] = $temp4;
            ...
            if($last_id != 0 ){
                $sql="SELECT a.*,b.* FROM `tbl_todolist_recipents` as a INNER JOIN tbl_todolist as b ON a.`tdl_id` =  b.tdl_id WHERE a.`is_completed` = 1 AND  b.hotel_id =  $hotel_id and  b.tdl_id > $last_id LIMIT 20"; 
            }else {
                $sql="SELECT a.*,b.* FROM `tbl_todolist_recipents` as a INNER JOIN tbl_todolist as b ON a.`tdl_id` =  b.tdl_id WHERE a.`is_completed` = 1 AND  b.hotel_id =  $hotel_id LIMIT 20"; 
            }
            ...
            if ($result && $result->num_rows > 0) {
                ...
                while($row = mysqli_fetch_array($result)) {
                    ...
                    $temp['completed_user_name'] = $completed_user_name;
