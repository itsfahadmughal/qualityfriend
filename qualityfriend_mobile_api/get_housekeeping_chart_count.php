...
if(file_exists("util_config.php") && is_readable("util_config.php") && include("util_config.php")) 
{
    ...
    if($floor_array_lenth != 0){
        for ($x = 0; $x < $floor_array_lenth; $x++) {
            ...
            $temp['total_assign_room'] =   $total_assign_room;
            $temp['total_dirty_room'] =   $total_dirty_room;
            $temp['total_clean_room'] =   $total_clean_room;
            $temp['total_cleaning_in_progress_room'] =   $total_cleaning_in_progress_room;
            $temp['total_inspection_in_progress_room'] =   $total_inspection_in_progress_room;
            $temp['total_inspected_room'] =   $total_inspected_room;
            $temp['total_no_cleaning_desired_room'] =   $total_no_cleaning_desired_room;


            $temp['total_nce_express'] =   $total_dirty_room_not_required_to_clean;
