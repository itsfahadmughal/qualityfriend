...
if(isset($_POST['create_edit_permission'])){
    $create_edit_permission = $_POST['create_edit_permission'];
}
...
if($source == "handover"){
    ...
    if($create_edit_permission == 1 || $usert_id == 1){
        ...
        if($result_update){
            ...
            $temp1['flag'] = 1;
            $temp1['message'] = "Success";
        }else{
            $temp1['flag'] = 0;
            $temp1['message'] = "Not Success";
        }
    }else{
