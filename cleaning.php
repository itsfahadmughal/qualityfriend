    ...
    <body class="skin-default-dark fixed-layout">
        ...
        <div class="preloader">
            <div class="loader">
                ...
                <p class="loader__label">Cleaning</p>
            </div>
        </div>
        <!-- ============================================================== -->
                ...
                <div class="container-fluid" id="mcontainer">
                    ...
                    <div class="row page-titles mobile-container-padding heading_style">
                        <div class="col-md-3 align-self-center">
                            <h4 class="text-themecolor font-weight-title font-size-title">Daily Plans</h4>
                        </div>
                        <div class="col-md-6">
                        </div>
                        <div class="col-md-3 align-self-center text-right">
                            <div class="d-flex justify-content-end align-items-center">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item text-success">Daily Plans</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pl-3 pr-3  pt-3 pb-3">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Assign Date</h4>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="extrajob_add()" data-dismiss="modal">Save</button>
                        ...
                        <div id="add_timer" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Assign Cleaning Type</h4>
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    </div>
                                    <div class="modal-body">
                                        <from class="form-horizontal" onsubmit="event.preventDefault();">
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <div class="col-md-12 m-b-20 mt-2">
                                                        <div  id="" class="form-group ">
                                                            <select  onchange="" id="times" class="form-control custom-select" style="width: 100%">
                                                                <option value="NC" >Clean Normal</option>
                                                                <option value="EC"  >Express Cleaning</option>
                                                                <option value="DC">Clean Departure</option>
                                                                <option value="FC" >Final Clean</option>
                                                    ...
                                                    <div class="col-md-12 m-b-20 mt-2">
                                                        <div hidden id="" class="form-group ">
                                                            <input  type="text" class="form-control" id="ht_cleaner_id" placeholder=""> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 m-b-20 mt-2">
                                                        <div hidden id="" class="form-group ">
                                                            <input   type="text" class="form-control" id="ht_id" placeholder=""> 
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 m-b-20 mt-2">
                                                        <div hidden id="" class="form-group ">
                                                            <input   type="text" class="form-control" id="ht_div_id" placeholder=""> 
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect"  onclick="type_add()" data-dismiss="modal">Save</button>
                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Cancel</button>
                                    </div>
                                </div>
                                <!-- /.modal-content -->
                        ...
                        <div  id="permanently_div" class="col-lg-12  col-md-12  display_none">
                            <div class="row div-white-background p-3 mb-3" >
                                <div  id="" class="col-lg-4  col-md-4  pt-2">
                                    <h4>Do you want assign room to cleaner permanently?</h4>
                                </div>
                                <div id="" class="col-lg-3  col-md-3  pt-2">
                                    ...
                                    <div class="custom-control custom-radio inline-div mr-3 b-cancle">
                                        ...
                                        <label class="custom-control-label" for="for_toay">Only For Today</label>
                                    </div>
                                </div>
                                            ...
                                            if ($result2 && $result2->num_rows > 0) {
                                                while($row2 = mysqli_fetch_array($result2)) {
                                                    ...
                                                    if($arrival != ""){
                                                        ...
                                                        //                                                    }else if($time_type == "EC"){
                                                        //
                                                        //                                                        $sql_time="SELECT * FROM `tb_time_interval`  WHERE `ti_id` = $time_to_EC";
                                                        //                                                        $result_time = $conn->query($sql_time);
                                                        //                                                        if ($result_time && $result_time->num_rows > 0) {
                                                        //                                                            while($row_time = mysqli_fetch_array($result_time)) {
                                                        //                                                                $time_to_CN_value = $row_time['time'];
                                                        ...
                                                        //
                                                        //
                                                        //                                                    }else if($time_type == "DC"){
                                                        //
                                                        //
                                                        //                                                        $sql_time="SELECT * FROM `tb_time_interval`  WHERE `ti_id` = $time_to_CD";
                                                        //                                                        $result_time = $conn->query($sql_time);
                                                        //                                                        if ($result_time && $result_time->num_rows > 0) {
                                                        //                                                            while($row_time = mysqli_fetch_array($result_time)) {
                                                        //                                                                $time_to_CN_value = $row_time['time'];
                                                        ...
                                                        //                                                        }
                                                        //
                                                        //                                                    }else if($time_type == "FC"){
                                                        //
                                                        //
                                                        //                                                        $sql_time="SELECT * FROM `tb_time_interval`  WHERE `ti_id` = $time_to_FC";
                                                        //                                                        $result_time = $conn->query($sql_time);
                                                        //                                                        if ($result_time && $result_time->num_rows > 0) {
                                                        //                                                            while($row_time = mysqli_fetch_array($result_time)) {
                                                        //                                                                $time_to_CN_value = $row_time['time'];
        ...
        <script>
            ...
            //            function room_assign_update(div_id,room_number,cleaner_id,is_assigned) {
            //                var id = $(div_id).attr("id");
            //                document.getElementById("ht_div_id").value = id ;
            //                document.getElementById("ht_id").value = room_number ;
            //                document.getElementById("ht_cleaner_id").value = cleaner_id;
            //                document.getElementById("is_assigned").value = is_assigned;
            //                $('#add_timer').modal('show');
            //
            //
            //                if(is_assigned == 0){
            //                    $('#add_timer').modal('show');
            ...
            //            function  type_add(){
            //
            //                var type =  document.getElementById("times").value ;
            //                var id =  document.getElementById("ht_div_id").value ;
            //                var room_number =  document.getElementById("ht_id").value;
            //                var cleaner_id =  document.getElementById("ht_cleaner_id").value;
            //                var is_assigned =  document.getElementById("is_assigned").value;
            //
            //                room_assign_update2(id,room_number,cleaner_id,type);
            //
            //            }
