                            ...
                            <div class="card-body pm-0">
                                <div class="vtabs customvtab">
                                    <ul class="nav nav-tabs tabs-vertical" role="tablist">
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link active" data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-pool"></i></span> <span class="hidden-xs-down">Worked Hours</span> </a> </li>
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab" href="#profile3" role="tab"><span class="hidden-sm-up"><i class="fas fa-hand-holding"></i></span> <span class="hidden-xs-down">Employee Timesheet</span></a> </li>
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab" href="#messages13" role="tab"><span class="hidden-sm-up"><i class="fas fa-hand-holding"></i></span> <span class="hidden-xs-down">Time Off</span></a> </li>
                                        <li class="nav-item w-180-custom wm-50px"> <a class="nav-link" data-toggle="tab" href="#messages3" role="tab"><span class="hidden-sm-up"><i class="fas fa-dollar-sign"></i></span> <span class="hidden-xs-down">Shift Pool</span></a> </li>
                                    </ul>
                                    <!-- Tab panes -->
                                    <div class="tab-content w-100">
                                        <div class="tab-pane active" id="home3" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    <h3>Worked Hours &amp; Wages</h3>
                                                    <span>A detailed view of hours worked by an employee</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Date range</strong></label>
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            echo '<option value=' . $row[0] . '>' . $title . '</option>';
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mt-3">
                                                            <input type="button" onclick="get_report_workedHours();" class="btn mt-4 w-100 btn-info" value="Get Report">
                                                        </div>
                                        ...
                                        <div class="tab-pane" id="profile3" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    ...
                                                    <span>A detailed view of shift hours by an employee</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Date range</strong></label>
                                                    <div class="input-group">
                                                    ...
                                                    <label class="control-label mt-3"><strong>Employee</strong></label>
                                                    ...
                                                    <input type="button" onclick="get_report_emp_timesheet();" class="btn mt-5 w-30 btn-info" value="Get Report">
                                        ...
                                        <div class="tab-pane" id="messages13" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    <h3>Time Off</h3>
                                                    <span>A detailed view of approved days off per employee including who approved the request</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Date range</strong></label>
                                                    <div class="input-group">
                                                    ...
                                                    <input type="button" onclick="get_report_timeoff();" class="btn mt-5 w-30 btn-info" value="Get Report">
                                        ...
                                        <div class="tab-pane" id="messages3" role="tabpanel">
                                            <div class="row pl-1">
                                                <div class="col-lg-4">
                                                    <h3>Shift Pool</h3>
                                                    <span>See who is picking up or offering up shifts</span>
                                                    <br>
                                                    <label class="control-label mt-4"><strong>Date range</strong></label>
                                                    <div class="input-group">
                                                    ...
                                                    <label class="control-label mt-3"><strong>Shift Offered By Employee</strong></label>
                                                    ...
                                                    <label class="control-label mt-3"><strong>Shift Offered To Employee</strong></label>
                                                    ...
                                                    <input type="button" onclick="get_report_shiftpool();" class="btn mt-5 w-30 btn-info" value="Get Report">
